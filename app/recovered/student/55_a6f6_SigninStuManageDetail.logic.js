...
a6f6: function(e, t, i) {
  ...
  var s = function() {
      ...
      return i("q-layout", {
      ...
      }), e.menuInfo ? i("q-toolbar-title", [e._v(e._s(e.menuInfo.title) + "详情")]) : e._e(), i("q-btn", {
        attrs: {
          flat: "",
          round: "",
          dense: "",
        ...
        scopedSlots: e._u([{
          ...
          fn: function() {
            ...
            }, [e._v(e._s(e.record.title))]), i("q-item-label", {
              attrs: {
                caption: ""
              }
            }, [e._v(e._s(e.record.label))])], 1), i("q-item-section", {
              attrs: {
                side: ""
              }
            }, [i("q-btn", {
      ...
      }, [e._v(e._s(e.record.confirm_ratio) + "%")])]) : e._e(), i("q-item-label", {
        attrs: {
          caption: ""
        }
      }, [i("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [e._v(e._s(e.menuInfo.title) + "方式")]), e._v(e._s("L" === e.record.signin_method ? "定位" : "DQR" === e.record.signin_method ? "动态二维码" : "静态二维码") + "\n            ")]), null !== e.record.dep_name ? i("q-item-label", {
        attrs: {
          caption: ""
        }
      }, [i("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [e._v("发布单位")]), e._v(e._s(e.record.dep_name) + "\n            ")]) : e._e()], 1)], 1)], 1)], 1), i("q-separator", {
        staticStyle: {
          height: "0.1rem"
        },
        attrs: {
      ...
      }, [e._v("导出")])], 1)], 1)], 1)], 1), i("q-page-container", [i("q-page", {
        ...
        return i("q-card", {
          ...
          style: "未签到" == t.signin_status ? "border-left:0.25rem solid #c10015;" : "已请假" == t.signin_status ? "border-left:0.25rem solid #027be3;" : "border-left:0.25rem solid #21ba45;",
          attrs: {
            flat: ""
          }
        ...
        }, [e._v("(" + e._s(t.student_no) + ")")])], 1), i("q-item-label", {
          directives: [{
            name: "show",
            rawName: "v-show",
            value: t.location_status && "L" == e.record.signin_method,
        ...
        }, [e._v("签到" + e._s(t.location_status))])]), i("q-item-label", {
          directives: [{
            name: "show",
            rawName: "v-show",
            value: t.picture_evidence && "L" == e.record.signin_method && 1 == e.record.picture_evidence,
        ...
        }, [e._v(e._s(t.picture_evidence))])]), i("q-item-label", {
          directives: [{
            name: "show",
            rawName: "v-show",
            value: t.qrcode_source && ("SQR" == e.record.signin_method || "DQR" == e.record.signin_method),
          ...
          staticClass: "neu-css-after-colon"
        }, [e._v("二维码来源")]), e._v(e._s(t.qrcode_source) + "\n                ")])], 1), i("q-item-section", {
          attrs: {
            side: "",
            top: ""
          }
        }, [i("q-item-label", [i("div", {
          class: "未签到" == t.signin_status ? "text-red" : "已请假" == t.signin_status ? "text-primary" : "text-positive"
        }, [e._v("\n                    " + e._s(t.signin_status)), i("q-icon", {
          directives: [{
            name: "show",
            rawName: "v-show",
      ...
      }, [i("span", [e._v("签到结果")])]), i("q-item-section", [i("div", {
        ...
        return i("q-btn", {
          ...
          attrs: {
            outline: "",
            color: t.value == e.queryModel.signin_status ? "primary" : "grey"
          },
          on: {
            click: function(i) {
          ...
          directives: [{
            name: "show",
            rawName: "v-show",
            value: e.queryModel.signin_status == t.value,
      ...
      }, [i("span", [e._v("位置状态")])]), i("q-item-section", [i("div", {
        staticClass: "row justify-evenly"
      }, e._l([{
        label: "位置正常",
        value: "1"
        ...
        return i("q-btn", {
          ...
          attrs: {
            outline: "",
            color: t.value == e.queryModel.location_status ? "primary" : "grey"
          },
          on: {
            click: function(i) {
          ...
          directives: [{
            name: "show",
            rawName: "v-show",
            value: e.queryModel.location_status == t.value,
      ...
      }, [e._v("可以查询学号、姓名、性别、手机号")])], 1)], 1)], 1)], 1)], 1)], 1)], 1), i("neu-export-data", {
        attrs: {
    ...
    c = {
      ...
      mounted() {
        window.localStorage.getItem("menu") && (this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((e => "signin" === e.id))), this.$axiosAction("/api/student/signin/signin.api", {
          action: "querySigninListSimpleDetail",
          id: this.id
        }).then((e => {
          0 === e.data.code && (this.record = e.data.result, this.getTimeSlot()), this.record && this.record.id || (this.$showErrorNotify("该条信息不存在或您权限不足！"), this.goBack())
        })).catch((e => {
          this.record = {}
      ...
      methods: {
        ...
        loadList(e) {
          e && (this.paging.pageNum = 0, this.list = []), this.paging.pageNum += 1, this.isLoading = !0, this.id && this.$axiosAction("/api/student/signin/signin.api", n()(n()({
            action: "querySigninResultListStu"
          }, this.queryModel), {}, {
            ...
            if (0 === t.data.code) {
              ...
              if (this.paging = {
                ...
                for (let t = 0; t < this.record.info_config.length; t++)
                  for (const e of this.list) e.info_result && (e["info" + t] = Object(l["c"])(this.record.info_config[t], e.info_result[t]))
        ...
        exportList() {
          this.exportCompConfig = ["/api/student/signin/signin.api", "querySigninResultListStu", n()(n()({}, this.queryModel), {}, {
            signin_id: this.$route.query.id,
            batch_no: this.batchNo
          }), {
            ...
            const i = {
              "签到结果": "未签到" === t.signin_status ? "未签到" : "已请假" === t.signin_status ? "已请假" : "已签到",
              "签到时间": t.signin_time
            };
            return "L" === this.record.signin_method ? (i.学号 = t.student_no, i.姓名 = t.name, i.性别 = t.sex_name, i.位置状态 = t.location_status, i.一级行政区 = t.province, i.二级行政区 = t.city, i.详细地址 = t.address, i.手机号 = t.mob) : (i.二维码来源 = t.qrcode_source, i.学号 = t.student_no, i.姓名 = t.name, i.性别 = t.sex_name, i.手机号 = t.mob), e.concat(i)
          }), []), 1e3, 5e3]
        },
        refresh(e) {
          this.loadList(e)
        ...
        getTimeSlot() {
          ...
          this.timeSlot = e === t ? this.record.begin_time + "~" + i : this.record.begin_time + "~" + this.record.end_time
        }
      }
    },
    d = c,
