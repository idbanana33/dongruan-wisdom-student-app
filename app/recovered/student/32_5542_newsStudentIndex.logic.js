 ...
 * Source: assets/www/js/32.js -> module "5542"
 * Route: /student/news/index
 * Component guess: newsStudentIndex
  ...
  var s = function() {
    ...
    l = {
      ...
      methods: {
        ...
        loadList(e) {
          e && (this.paging.pageNum = 0, this.list = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/news/news.api", n()(n()({
            action: "getNewsList"
          }, this.queryModel), {}, {
        ...
        goDetail(e, t) {
          t ? (this.$axiosAction("/api/teacher/news/news.api", {
            action: "insertNewsLog",
            id: e,
            roleId: this.roleId,
            role_type: this.role_type
          }).then((e => {
            0 === e.data.code || 2001 === e.data.code && this.refresh((() => {}))
          })).catch((e => {
            this.$showErrorNotify("系统错误")
          })), cordova.InAppBrowser.open(t, "_system")) : this.$router.push("/student/news/detail?id=" + e)
        },
        moveFab(e) {
    ...
    D = a("eebe"),
    O = a.n(D),
    j = Object(c["a"])(d, s, i, !1, null, null, null);
  t["default"] = j.exports;
  O()(j, "components", {
    QLayout: u["a"],
    QHeader: g["a"],
