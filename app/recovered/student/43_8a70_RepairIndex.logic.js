...
"8a70": function(t, e, a) {
  ...
  var i = function() {
      ...
      return a("q-layout", {
      ...
      }), a("q-toolbar-title", [t._v("报修")])], 1)], 1), a("q-page-container", [a("q-page", {
        ...
        }, [t._v("\n                  " + t._s(e.statusinfo) + "\n                ")])], 1), a("q-item-label", [t._v("\n                报修单号：" + t._s(e.order) + "\n              ")]), a("q-item-label", [t._v("\n                期望上门时间：" + t._s(e.visit_time) + "\n              ")]), "0" == e.status ? a("q-item-label", [t._v("\n                接单人：————\n              ")]) : t._e(), "1" == e.status ? a("q-item-label", [t._v("\n                已分配：" + t._s(e.maintainer_name) + "\n              ")]) : t._e(), "0" != e.status && "1" != e.status && 6 != e.status ? a("q-item-label", [t._v("\n                接单人：" + t._s(e.maintainer_name) + "\n              ")]) : t._e(), "0" != e.status && "1" != e.status && 6 != e.status ? a("q-item-label", [t._v("\n                接单时间：" + t._s(e.order_receiving_time) + "\n              ")]) : t._e(), "0" != e.status && "1" != e.status && 6 != e.status ? a("q-item-label", [t._v("\n                维修完成时间：" + t._s(e.completion_time) + "\n              ")]) : t._e(), a("q-item-label", [a("q-btn", {
    ...
    o = {
      ...
      mounted() {
        this.getRepairStatusList(), this.loadRepairList((() => {})), window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1))
      },
      methods: {
        refresh(t) {
        ...
        loadRepairList(t) {
          t && (this.paging.pageNum = 0, this.repair = []), this.paging.pageNum += 1, this.isLoading = !0;
    ...
    Q = a("eebe"),
    R = a.n(Q),
    z = Object(p["a"])(l, i, s, !1, null, null, null);
  e["default"] = z.exports;
  R()(z, "components", {
    QLayout: c["a"],
    QHeader: u["a"],
