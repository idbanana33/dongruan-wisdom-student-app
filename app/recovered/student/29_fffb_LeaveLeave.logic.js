...
fffb: function(e, t, a) {
  ...
  var s = function() {
      ...
      }), a("q-toolbar-title", [e._v("我要请假")])], 1)], 1), a("q-page-container", [a("q-page", {
      ...
      }, [e._v("图片格式支持：.jpg、.png、.jpeg")]), a("q-uploader", {
        staticClass: "full-width",
        attrs: {
          multiple: "",
          "max-files": "4",
        ...
        scopedSlots: e._u([{
          ...
          fn: function(t) {
            return [a("div", {
              ...
              staticClass: "col"
            }, [e._v("图片上传(每张5M以内)")]), t.canAddFiles ? a("q-btn", {
              attrs: {
                type: "a",
                icon: "add_box",
                round: "",
    ...
    n = {
      ...
      computed: {},
      mounted() {
        window.localStorage.getItem("menu") && (this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((e => "leave" === e.id))), this.getLeaveType()
      },
      watch: {
        city_out(e) {
          return "1" === e ? (this.location_share = "1", this.location_share) : "0" === e ? (this.province_out = "0", this.province_out) : void 0
        },
        province_out(e) {
      ...
      methods: {
        ...
        locationCompleted(e) {
          this.location = e, this.locationStatus && (this.locationStatus = !1, this.saveSunmit(1))
        },
        goBackLeave() {
        ...
        afterUploaded(e) {
          ...
          t.error ? this.$showErrorNotify(t.error) : this.attachment ? this.attachment.push(t) : this.attachment = [t], this.addUrl()
        },
        afterRemoved(e) {
          for (const t of e) {
        ...
        addUrl() {
          for (let e = 0; e < this.attachment.length; e++) this.showPicList.push({
        ...
        onSubmit() {
          return "1" === this.city_out && "0" === this.location_share ? this.$showErrorNotify("需要出市则需要离校必选") : "1" === this.province_out && "0" === this.city_out ? this.$showErrorNotify("需要出省则需要出市必选") : "1" === this.province_out && "0" === this.location_share ? this.$showErrorNotify("需要出省则需要离校必选") : (this.locationStatus = !0, void(this.research = this.research + 1))
        },
        locationError(e) {
          this.locationStatus && (this.locationStatus = !1, this.saveSunmit(2))
        },
        saveSunmit(e) {
          this.$q.loading.show(), this.user = JSON.parse(localStorage.getItem("userinfo")), this.$axiosAction("/api/student/leave/leave.api", {
            ...
            if (2001 !== t.data.code) {
              ...
              let t = {};
              t = 1 === e ? JSON.stringify(this.location) : "", this.$axiosAction("/api/student/leave/leave.api", {
                action: "insertLeave",
                ...
                0 === e.data.code ? (this.atta = "", this.$q.loading.hide(), this.$router.push("/student/leave/index")) : this.$q.loading.hide()
              }))
