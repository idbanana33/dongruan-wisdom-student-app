 ...
 * Source: assets/www/js/52.js -> module "1a43"
 * Route: /student/signin/signinSuccess
 * Component guess: 52_1a43
...
"1a43": function(t, s, e) {
  ...
  var a = function() {
      ...
      return e("q-layout", {
      ...
      }), e("q-toolbar-title", [t._v("我的签到")])], 1)], 1), e("q-page-container", [t.record ? e("q-page", {
        ...
        staticClass: "full-width row justify-center bg-primary text-white",
        staticStyle: {
          height: "4rem",
          "font-size": "1.5rem"
        }
      ...
      }, [t._v(t._s(t.record.title))])]), e("div", {
      ...
      }, [t._v("发起人")]), e("span", [t._v(t._s(t.record.tea_name))])]), e("div", {
        staticClass: "row q-mt-xs"
      }, [e("span", {
        staticClass: "neu-css-after-colon text-grey",
        staticStyle: {
      ...
      }, [t._v("签到时间段")]), e("span", [t._v(t._s(t.timeSlot))])]), e("div", {
        staticClass: "row q-mt-xs"
      }, [e("span", {
        staticClass: "neu-css-after-colon text-grey",
        staticStyle: {
      ...
      }, [e("q-card-section", [e("neu-qa-list", {
        attrs: {
          taskMenuId: "signin",
          taskId: t.id + ""
        }
      })], 1)], 1)], 1) : t._e()], 1), e("q-dialog", {
        model: {
      ...
      })], 1), e("q-separator"), e("q-card-section", {
    ...
    c = {
      ...
      mounted() {
        this.$axiosAction("/api/student/signin/signin.api", {
          ...
          0 === t.data.code ? (this.record = t.data.result, this.record.begin_time_befor === this.record.end_time_befor ? this.timeSlot = this.record.begin_time + " 至 " + this.record.end_time_after : this.timeSlot = this.record.begin_time + " 至 " + this.record.end_time) : this.goBack()
      ...
      methods: {
        showQrCode() {
          this.qrShowingDialog = !0, this.showEncryptionQrCode(), this.setInter = setInterval((() => {
        ...
        goBack() {
          this.tabs = this.$route.query.tab, this.$router.push({
