...
"4f38": function(e, t, a) {
  ...
  var r = function() {
      ...
      return a("q-layout", {
      ...
      }), a("q-toolbar-title", [e._v("通知详情")])], 1)], 1), a("q-page-container", [a("q-page", {
        ...
        staticClass: "text-h6"
      }, [e._v(e._s(e.record.title))]), null !== e.record.dep_name ? a("div", {
        ...
        staticClass: "neu-css-after-colon text-grey"
      }, [e._v("查阅学生")]), a("span", [e._v(e._s(e.userInfo.name) + "(" + e._s(e.userInfo.login_name) + ")")])]), a("q-separator", {
        staticClass: "q-mt-sm q-mb-md"
      }), a("div", {
        ...
        directives: [{
          name: "show",
          rawName: "v-show",
          value: 1 == e.record.confirm_flag && null == e.record.confirm_time && 2 == e.record.jude,
          expression: "record.confirm_flag == 1 && record.confirm_time == null && record.jude == 2"
        }],
        staticClass: "q-mt-md q-mb-md"
      }), a("div", {
        directives: [{
        ...
        on: {
          click: e.update_confirm_flag
        }
      }, [e._v("确认已读")])], 1)], 1), a("q-card", {
        directives: [{
          name: "show",
          rawName: "v-show",
          value: "qa" == e.tab,
    ...
    l = {
      ...
      mounted() {
        this.$axiosAction("/api/student/notice/notice.api", {
          ...
          0 === e.data.code ? this.record = e.data.result : 2002 === e.data.code && this.$router.push("/student/notice/index")
      ...
      methods: {
        update_confirm_flag() {
          if (1 === this.record.confirm_flag && null === this.record.confirm_time && 2 === this.record.jude && void 0 === this.info_result[0]) return this.$showErrorNotify("请签名");
          this.$q.loading.show();
          const e = this.info_result && this.info_result.length > 0 && void 0 !== this.info_result[0] ? JSON.stringify(this.info_result) : null;
          this.$axiosAction("/api/student/notice/notice.api", {
        ...
        generateEsign() {
          this.$refs.esign.generate().then((e => {
            ...
            null === this.modelValue ? this.$showErrorNotify("请签名") : (this.modelValue = null, this.dialog = !1)
          }))
        },
        resetEsign() {
