...
df96: function(t, e, i) {
  ...
  var s, a, o = function() {
      ...
      return i("q-layout", {
      ...
      }), i("q-toolbar-title", [t._v("签到详情")])], 1)], 1), i("q-page-container", [i("q-page", {
      ...
      }, [t._v(t._s(t.record.title))]), i("span", {
        staticClass: "neu-css-after-colon text-grey"
      }, [t._v("发起人")]), t._v(t._s(t.record.name) + "\n        ")]), i("div", {
        staticClass: "q-ml-sm row"
      }, [i("span", {
        staticClass: "neu-css-after-colon text-grey"
      }, [t._v("签到时间段")]), t._v(t._s(t.record.begin_time) + " 至 " + t._s(t.record.end_time) + "\n        ")]), null !== t.record.dep_name ? i("div", {
        staticClass: "q-ml-sm row"
      }, [i("span", {
        staticClass: "neu-css-after-colon text-grey"
        ...
        staticClass: "row q-mb-sm q-mt-sm"
      }, [i("span", {
        staticStyle: {
          "font-size": "15px"
        }
      }, [t._v("签到任务还未开始，请稍后再来！")])])])]), i("q-card-section", {
        directives: [{
          name: "show",
          rawName: "v-show",
        ...
        staticClass: "q-mb-sm text-center"
      }, [i("span", [t._v("当前为签到时间，请注意及时签到！")])]), "已请假" == t.record.leaved ? i("div", {
        staticClass: "q-mb-sm text-center text-positive"
      }, [i("span", [t._v("本次签到任务您已请假，可自行选择是否签到！")])]) : t._e(), i("div", {
        staticClass: "text-center"
      }, [i("q-btn", {
        directives: [{
          name: "show",
          rawName: "v-show",
          value: "L" == t.record.signin_method && "0" == t.record.picture_evidence,
          expression: "record.signin_method == 'L' && record.picture_evidence == '0'"
        }],
        attrs: {
          round: "",
          size: "3rem",
        ...
        directives: [{
          name: "show",
          rawName: "v-show",
          value: "L" == t.record.signin_method && "1" == t.record.picture_evidence,
          expression: "record.signin_method == 'L' && record.picture_evidence == '1'"
        }],
        attrs: {
          round: "",
          size: "3rem",
        ...
        directives: [{
          name: "show",
          rawName: "v-show",
          value: "DQR" == t.record.signin_method || "SQR" == t.record.signin_method,
          expression: "record.signin_method == 'DQR' || record.signin_method == 'SQR'"
        }],
        attrs: {
          round: "",
          size: "3rem",
        ...
        on: {
          click: function(e) {
            return t.informationDetail(t.record.id, t.record.signin_method, t.batch_no)
          }
        }
      }, [i("q-icon", {
        staticStyle: {
      ...
      }, [t._v("\n            当前所在位置：" + t._s(t.location.address) + "\n            "), i("neu-geo-location", {
        attrs: {
          needAddr: !0,
          location: t.research
        },
      ...
      }, [i("q-card-section", [i("neu-qa-list", {
        attrs: {
          taskMenuId: "signin",
          taskId: t.id + ""
        }
        ...
        staticClass: "text-center q-mb-md"
      }, [t._v("\n        当前为签到范围外，是否进行拍照？\n      ")]), i("q-separator"), i("q-card-actions", {
        attrs: {
          align: "around"
        }
      }, [i("q-btn", {
  ...
  var d = {
      ...
      mounted() {
        this.$axiosAction("/api/student/signin/signin.api", {
          ...
          "已结束" !== this.record.signin_status && "已打卡" !== this.record.signin_status || this.$router.push({
        ...
        locationCompleted(t) {
          if (this.location = t, this.locationStatus) {
            ...
            this.$axiosAction("/api/student/signin/signin.api", {
              ...
              1 === this.locals.allow_outside && 1 === this.locals.picture_evidence ? this.takePhotos() : 1 === this.locals.allow_outside && 0 === this.locals.picture_evidence ? this.$axiosAction("/api/student/signin/signin.api", {
              ...
              })) : 0 === this.locals.allow_outside && 1 === this.locals.picture_evidence ? !0 === this.locals.range ? this.takePhotos() : this.$q.dialog({
                title: "签到",
                message: "当前为签到范围外，无法进行签到打卡。"
              }).onOk((() => {
                this.$router.back()
              })) : !0 === this.locals.range ? this.$axiosAction("/api/student/signin/signin.api", {
                action: "updateLocationSignin",
                id: s,
                batch_no: this.record.batch_no,
                signin_location: JSON.stringify(t),
