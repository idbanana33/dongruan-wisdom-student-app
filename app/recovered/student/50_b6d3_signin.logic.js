...
b6d3: function(t, e, a) {
  ...
  var s = function() {
      ...
      return a("q-layout", {
      ...
      }), a("q-toolbar-title", [t._v(t._s(t.title))])], 1)], 1), a("q-page-container", [a("q-page", {
        ...
        staticClass: "neu-css-after-colon text-grey"
      }, [t._v("二维码负责人")]), t._v(t._s(t.stuName) + " (" + t._s(t.loginName) + ")\n        ")])]), a("q-card", {
        directives: [{
          name: "show",
          rawName: "v-show",
          value: "scan" == t.tab,
    ...
    r = {
      ...
      mounted() {
        this.onload(), window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1))
      },
      methods: {
        onload() {
          this.$axiosAction("/api/student/signin/signin.api", {
            ...
            0 === t.data.code ? (this.record = t.data.result, "SQR" === this.record.signin_method ? (this.getSqrCode(), this.setInter = setInterval((() => {
              this.getSqrCode()
            }), 31536e7)) : (this.getQrCode(), this.setInter = setInterval((() => {
              this.getQrCode()
            }), 6e4))) : this.goBack()
          }))
        },
        ...
        getQrCode() {
          this.$q.loading.show(), this.$axiosAction("/api/student/signin/signin.api", {
            action: "stuEncrytedQrCode",
            signin_method: this.record.signin_method,
            id: this.$route.params.id,
            batch_no: this.$route.params.batch_no,
