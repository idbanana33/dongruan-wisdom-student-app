...
d2bb0: function(t, e, a) {
  ...
  var i = function() {
      ...
      return a("q-layout", {
      ...
      }), a("q-toolbar-title", [t._v(t._s(t.menuInfo.title))]), a("span", {
        directives: [{
          name: "show",
          rawName: "v-show",
        ...
        return a("q-card", {
          ...
          attrs: {
            square: "",
            color: "N" == e.notice_priority || "E" == e.notice_priority || "I" == e.notice_priority ? e.notice_priority_color : "gray",
            "text-color": "white",
            icon: "email",
            size: "sm"
          }
        ...
        }, [t._v("\n              " + t._s(e.days > 1 ? e.published_date : 1 == e.days ? e.days + "天前" : 0 != e.hours ? e.hours + "小时前" : 0 != e.mins ? e.mins + "分钟前" : "刚刚") + "\n            ")])], 1)], 1)
      })), a("div", {
        directives: [{
          name: "show",
          rawName: "v-show",
    ...
    r = {
      ...
      computed: {
        menuInfo() {
          return window.localStorage.getItem("menu") ? JSON.parse(window.localStorage.getItem("menu")).find((t => "notice" === t.id)) : {}
        }
      },
      destroyed() {
      ...
      mounted() {
        window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.loadList((() => {})), this.getbadgeCount()
      },
      methods: {
        loadList(t) {
