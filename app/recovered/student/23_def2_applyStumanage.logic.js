 ...
 * Component guess: applyStumanage
...
def2: function(t, e, a) {
  ...
  var s = function() {
      ...
      return a("q-layout", {
        ...
        return a("q-card", {
        ...
        }, [t._v("可" + t._s(t.menuInfo.title) + "人数")]), t._v(t._s(e.applytotal) + "\n                  ")]), a("q-item-label", {
          attrs: {
            caption: "",
            lines: "2"
          }
          ...
          staticClass: "neu-css-after-colon"
        }, [t._v("已" + t._s(t.menuInfo.title) + "人数")]), t._v(t._s(e.applyed) + "\n                      "), a("span", {
          staticClass: "neu-css-after-colon q-ml-lg"
        }, [t._v("未" + t._s(t.menuInfo.title) + "人数")]), a("span", {
          class: e.noapply > 0 ? "text-red" : ""
        }, [t._v(t._s(e.noapply))])])], 1), a("q-item-section", {
          attrs: {
            side: ""
          }
    ...
    l = {
      ...
      mounted() {
        window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.applyType = this.$route.query.apply_type, this.menuColor = Object(p["d"])(this.applyType), this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((t => t.id === this.applyType)), this.loadList((() => {}))
      },
      methods: {
        loadList(t) {
        ...
        checkDetail(t, e) {
          this.$router.push(`/student/apply/StuManageDetail?id=${t}&batch_no=${e}&apply_type=${this.applyType}&type=${this.$route.query.type}`)
        },
        refresh(t) {
          this.loadList(t)
        }
