...
f3a7: function(e, t, s) {
  ...
  var a = function() {
      ...
      return s("q-layout", {
      ...
      }), s("q-toolbar-title", [e._v("选择" + e._s(e.menuInfo.title))]), s("q-btn", {
        attrs: {
          flat: "",
          round: "",
          dense: "",
        ...
        return s("q-card", {
        ...
        }, [e._v(e._s(0 == t.into_campus && 0 == t.out_campus ? "不需要核验" : 1 == t.into_campus && 1 == t.out_campus ? "需要入校、离校核验" : 1 == t.into_campus ? "需要入校核验" : "需要离校核验") + " ")])]), s("q-item-label", {
          staticStyle: {
            "min-width": "250px"
          },
          attrs: {
          ...
          staticClass: "neu-css-after-colon "
        }, [e._v("入校申请开始时间")]), e._v(e._s(t.into_campus_apply_begin) + "\n                  ")]) : e._e(), 1 == t.into_campus ? s("q-item-label", {
          staticStyle: {
            "min-width": "250px"
          },
          attrs: {
          ...
          staticClass: "neu-css-after-colon "
        }, [e._v("入校申请结束时间")]), e._v(e._s(t.into_campus_apply_end) + "\n                  ")]) : e._e(), 1 == t.out_campus ? s("q-item-label", {
          staticStyle: {
            "min-width": "250px"
          },
          attrs: {
          ...
          staticClass: "neu-css-after-colon "
        }, [e._v("离校申请开始时间")]), e._v(e._s(t.out_campus_apply_begin) + "\n                  ")]) : e._e(), 1 == t.out_campus ? s("q-item-label", {
          staticStyle: {
            "min-width": "250px"
          },
          attrs: {
          ...
          staticClass: "neu-css-after-colon "
        }, [e._v("离校申请结束时间")]), e._v(e._s(t.out_campus_apply_end) + "\n                  ")]) : e._e()], 1), s("q-item-section", {
          attrs: {
            side: ""
          }
    ...
    l = {
      ...
      methods: {
        ...
        goDetail(e) {
          this.$router.push("/student/process/NewProcess?id=" + e + "&service_flag=" + this.service_flag)
        }
      }
    },
    c = l,
