...
"048f": function(t, e, a) {
  ...
  var s = function() {
      ...
      return a("q-layout", {
      ...
      }), a("q-toolbar-title", [t._v("我负责的签到")])], 1)], 1), a("q-page-container", [a("q-page", {
        ...
        }, [t._v(t._s(e.signin_type_name))])], 1), a("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
    ...
    r = {
      ...
      mounted() {
        window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.getQrPersonList((() => {}))
      },
      methods: {
        getQrPersonList(t) {
        ...
        goDetail(t, e, a) {
          this.$axiosAction("/api/student/signin/signin.api", {
            ...
            0 === s.data.code && this.$router.push({
