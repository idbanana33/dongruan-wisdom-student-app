...
"03ca": function(e, t, a) {
  ...
  var i = function() {
      ...
      return i("q-layout", {
      ...
      }), t.menuInfo ? i("q-toolbar-title", [t._v(t._s(t.menuInfo.title) + "详情")]) : t._e(), i("q-btn", {
        directives: [{
          name: "show",
          rawName: "v-show",
      ...
      }, [t._v(t._s(t.condCount))])], 1)], 1), i("q-expansion-item", {
        ...
        scopedSlots: t._u([{
          ...
          fn: function() {
            ...
            }, [t._v(t._s(t.record.notice_priority_name) + ", " + t._s(t.record.status_name))])], 1), i("q-item-section", {
              attrs: {
                side: ""
              }
            }, [i("q-btn", {
      ...
      }, [i("q-card", [i("q-item", [i("q-item-section", [i("q-item-label", {
        attrs: {
          caption: ""
        }
      }, [i("span", {
      ...
      }, [t._v("阅读率")]), t._v(t._s(t.record.feedback_total) + "/" + t._s(t.record.total) + " \n              "), i("span", {
        class: t.record.feedback_ratio >= 85 ? "text-positive" : t.record.feedback_ratio >= 60 ? "text-warning" : "text-red"
      }, [t._v(t._s(t.record.feedback_ratio) + "%")])]), i("q-item-label", {
        attrs: {
          caption: ""
        }
      }, [i("span", {
        staticClass: "neu-css-after-colon"
      }, [t._v("通知时间")]), t._v(t._s(t.record.push_time) + "\n            ")]), 1 == t.record.confirm_flag ? i("q-item-label", {
        attrs: {
          caption: ""
        }
      }, [i("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("确认率")]), t._v(t._s(t.record.confirm_total) + "/" + t._s(t.record.total) + " \n              "), i("span", {
        class: t.record.confirm_ratio >= 85 ? "text-positive" : t.record.confirm_ratio >= 60 ? "text-warning" : "text-red"
      }, [t._v(t._s(t.record.confirm_ratio) + "%")])]) : t._e(), i("q-item-label", {
        attrs: {
          caption: ""
        }
      }, [i("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("反馈截止时间")]), t._v(t._s(t.record.feedback_deadline) + "\n            ")]), null !== t.record.dep_name ? i("q-item-label", {
        attrs: {
          caption: ""
        }
      }, [i("span", {
      ...
      }, [t._v("预览正文")])], 1), 0 == t.record.status && t.record.is_author ? i("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }],
      ...
      }, [t._v("重新开启")])], 1) : t._e(), 1 == t.record.status && t.record.is_author ? i("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }],
        ...
        on: {
          click: t.terminateNotice
        }
      }, [t._v("提前结束")])], 1) : t._e(), 1 == t.record.status && t.record.is_author ? i("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }],
      ...
      }, [t._v("延期")])], 1) : t._e(), 1 == t.record.status && t.record.is_author ? i("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }],
        ...
        on: {
          click: t.withdrawNotice
        }
      }, [t._v("撤回")])], 1) : t._e(), t.record.is_author || "A" == t.roleId ? i("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }],
        ...
        on: {
          click: t.deleteNotice
        }
      }, [t._v("删除")])], 1) : t._e(), i("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }, {
        ...
        on: {
          click: t.unnoticeAlert
        }
      }, [t._v("未阅读提醒(APP推送)")])], 1), i("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }, {
      ...
      }, [t._v("未阅读提醒(短信提醒)")])], 1)], 1)], 1)], 1), i("q-page-container", [i("q-page", {
        staticClass: "bg-grey-3"
      }, [i("q-card", {
        attrs: {
          flat: ""
        }
      }, ["statistics" == t.tab ? i("q-item", [i("q-item-section", [i("q-item-label", [i("div", {
      ...
      })], 1)], 1)], 1) : t._e()], 1), i("q-pull-to-refresh", {
        directives: [{
          name: "show",
          rawName: "v-show",
          value: "progress" == t.tab,
        ...
        return i("q-card", {
          ...
          style: "未阅读" == e.feedback_status_name ? "border-left:0.25rem solid #c10015;" : "已阅读" == e.feedback_status_name && "未确认" == e.confirm_status_name ? "border-left:0.25rem solid #b5b3b3;" : "border-left:0.25rem solid #027be3;",
          attrs: {
            flat: ""
          }
        ...
        }, [t._v("阅读时间：" + t._s(e.feedback_time))])], 1), i("q-item-section", {
          attrs: {
            side: "",
            top: ""
          }
        }, [i("q-item-label", [i("span", {
          class: "未阅读" == e.feedback_status_name ? "text-red" : "已阅读" == e.feedback_status_name ? "text-primary" : "text-positive"
        }, [t._v(t._s(e.feedback_status_name))])]), 1 == t.record.confirm_flag ? i("q-item-label", [i("span", {
          staticClass: "q-ml-md",
          class: "未确认" == e.confirm_status_name ? "text-red" : "已确认" == e.confirm_status_name ? "text-primary" : "text-positive"
        }, [t._v(t._s(e.confirm_status_name))])]) : t._e(), "已确认" == e.confirm_status_name && null !== e.signature ? i("q-item-label", {
          on: {
            click: function(a) {
          ...
          staticClass: "q-ml-md text-primary"
        }, [t._v("显示签名")])]) : t._e()], 1)], 1)], 1)
      })), i("div", {
        directives: [{
          name: "show",
          rawName: "v-show",
      ...
      })], 1), i("q-separator"), i("q-card-section", [i("div", [i("q-chip", {
        attrs: {
          square: "",
          "text-color": "white",
        ...
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("附件")]), t._l(t.record.attachment, (function(e) {
        return i("div", {
          key: e.servername,
      ...
      }))], 2) : t._e()]), i("q-separator"), i("q-card-section", [i("div", [i("span", {
        staticClass: "text-grey neu-css-after-colon"
        ...
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("通知对象")])]), i("neu-view-assigned-student", {
        attrs: {
      ...
      }, [i("span", [t._v("阅读状态")])]), i("q-item-section", [i("div", {
        ...
        return i("q-btn", {
          ...
          attrs: {
            outline: "",
            color: e.value == t.queryModel.feedback_status ? "primary" : "grey"
          },
          on: {
            click: function(a) {
          ...
          directives: [{
            name: "show",
            rawName: "v-show",
            value: t.queryModel.feedback_status == e.value,
            expression: "queryModel.feedback_status == item.value"
          }],
          attrs: {
            color: "orange",
            floating: ""
      ...
      }, [i("span", [t._v("确认状态")])]), i("q-item-section", [i("div", {
        staticClass: "row justify-evenly"
      }, t._l([{
        label: "未确认",
        value: "1"
        ...
        return i("q-btn", {
          ...
          attrs: {
            outline: "",
            color: e.value == t.queryModel.confirm_status ? "primary" : "grey"
          },
          on: {
            click: function(a) {
          ...
          directives: [{
            name: "show",
            rawName: "v-show",
            value: t.queryModel.confirm_status == e.value,
            expression: "queryModel.confirm_status == item.value"
          }],
          attrs: {
            color: "orange",
            floating: ""
      ...
      }, [t._v("可以查询学号、姓名、性别、手机号、年级、院系、专业、班级信息")])], 1)], 1)], 1)], 1)], 1), i("q-dialog", {
        attrs: {
          persistent: ""
        },
        model: {
        ...
        attrs: {
          ...
          rules: [function(e) {
            ...
            return t > e.record.feedback_deadline || "请填写原截止时间之后的时间"
          }],
    ...
    h = {
      ...
      mounted() {
        window.localStorage.getItem("menu") && (this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((e => "notice" === e.id))), this.$axiosAction("/api/teacher/notice/notice.api", {
          action: "queryNotice",
          id: this.noticeId
        }).then((e => {
          0 === e.data.code && (this.record = e.data.result, this.noticeConfirmFlag = this.record.confirm_flag), this.record && this.record.id || (this.$showErrorNotify("该条信息不存在或您权限不足！"), this.$router.push("/teacher/notice/index"))
        })).catch((e => {
          this.record = {}
        })), this.allowSmsRemind = "true" === localStorage.getItem("remind"), window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.loadList((() => {}))
      },
      methods: {
        goBack() {
          null !== this.cId && void 0 !== this.cId ? this.$router.push("/teacher/composite/detail?id=" + this.$route.query.compositeId) : this.$router.push("/teacher/notice/index")
        },
        loadList(e) {
          this.noticeId ? (e && (this.paging.pageNum = 0, this.list = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/notice/notice.api", r()(r()({
            action: "queryFeedbackList",
        ...
        exportList() {
          this.noticeId && (this.exportCompConfig = ["/api/teacher/notice/notice.api", "exportFeedbackList", r()({
            notice_id: this.noticeId
          }, this.queryModel), {
            [this.record.title]: "result"
          }, this.record.title, null, null, 1e3, 5e3])
        },
        refresh(e) {
          this.loadList(e)
        },
        deleteNotice() {
          this.$q.dialog({
            ...
            this.$q.loading.show(), this.$axiosAction("/api/teacher/notice/notice.api", {
              action: "deleteNotice",
              id: this.noticeId
            }).then((e => {
              0 === e.data.code && this.$router.push("/teacher/notice/index"), this.$q.loading.hide()
            })).catch((e => {
              this.$q.loading.hide()
            }))
          }))
        ...
        extendNotice() {
          this.$q.loading.show(), this.$axiosAction("/api/teacher/notice/notice.api", {
            ...
            0 === e.data.code && (1 === this.record.status ? (this.record.feedback_deadline = this.feedbackDeadline, this.extendDialog = !1) : this.$router.push("/teacher/notice/index")), this.$q.loading.hide()
          })).catch((e => {
            this.$q.loading.hide()
          }))
        },
        withdrawNotice() {
          this.$q.dialog({
            title: "确认撤回",
            message: '您可再次编辑并发布该通知。<br>原通知及其产生的<span class="text-red">数据将被清空。</span>',
            html: !0,
            persistent: !0,
            cancel: {
              label: "取消",
            ...
            this.$axiosAction("/api/teacher/notice/notice.api", {
              ...
              0 === e.data.code && this.$axiosAction("/api/teacher/notice/notice.api", {
                action: "deleteNotice",
                id: this.noticeId
              }).then((t => {
        ...
        getFeedValue(e) {
          this.queryModel.feedback_status === e ? this.queryModel.feedback_status = "" : this.queryModel.feedback_status = e
        },
        getConValue(e) {
          this.queryModel.confirm_status === e ? this.queryModel.confirm_status = "" : this.queryModel.confirm_status = e
        },
        getCondition() {
        ...
        exportLists() {
          this.exportCompConfig = ["/api/teacher/notice/notice.api", "getNoticeNumList", {
            notice_id: this.id,
            noticeStatistics: this.model.noticeStatistics
          }, {
            [`${this.record.title}的统计`]: "feedbackResult"
          }, `${this.record.title}的统计`, null, e => ({
            [`${this.record.title}的统计`]: e[`${this.record.title}的统计`].reduce(((e, t) => "1" === this.model.noticeStatistics && 1 === this.record.confirm_flag ? e.concat({
              "班级名称": t.class_name,
            ...
            }) : "1" === this.model.noticeStatistics && 0 === this.record.confirm_flag ? e.concat({
              "班级名称": t.class_name,
              "应阅读人数": t.feedback_total,
              "已阅读人数": t.feedback_count,
              "未阅读人数": t.no_feedback_total
            }) : "2" === this.model.noticeStatistics && 1 === this.record.confirm_flag ? e.concat({
              "专业名称": t.major_name,
              "应阅读人数": t.feedback_total,
              "已阅读人数": t.feedback_count,
              "未阅读人数": t.no_feedback_total,
              ...
              "已确认人数": t.confirm_count,
              "未确认人数": t.no_confirm_total
            }) : "2" === this.model.noticeStatistics && 0 === this.record.confirm_flag ? e.concat({
              "专业名称": t.major_name,
              "应阅读人数": t.feedback_total,
              "已阅读人数": t.feedback_count,
              "未阅读人数": t.no_feedback_total
            }) : "3" === this.model.noticeStatistics && 1 === this.record.confirm_flag ? e.concat({
              "院系名称": t.dep_name,
              "应阅读人数": t.feedback_total,
              "已阅读人数": t.feedback_count,
              "未阅读人数": t.no_feedback_total,
              ...
              "已确认人数": t.confirm_count,
              "未确认人数": t.no_confirm_total
            }) : "3" === this.model.noticeStatistics && 0 === this.record.confirm_flag ? e.concat({
              "院系名称": t.dep_name,
              "应阅读人数": t.feedback_total,
              "已阅读人数": t.feedback_count,
              "未阅读人数": t.no_feedback_total
            }) : "4" === this.model.noticeStatistics && 0 === this.record.confirm_flag ? e.concat({
              [this.counsellorlabel + "姓名"]: t.name + "(" + t.tea_no + ")",
              "应阅读人数": t.feedback_total,
              "已阅读人数": t.feedback_count,
              "未阅读人数": t.no_feedback_total
            }) : "4" === this.model.noticeStatistics && 1 === this.record.confirm_flag ? e.concat({
              [this.counsellorlabel + "姓名"]: t.name + "(" + t.tea_no + ")",
              "应阅读人数": t.feedback_total,
              "已阅读人数": t.feedback_count,
              "未阅读人数": t.no_feedback_total,
