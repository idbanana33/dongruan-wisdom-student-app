<!--
  Source: assets/www/js/65.js -> webpack module "fdfc"
  ...
  <q-page-container>
    <q-page class="bg-grey-3 q-pb-sm">
      <q-pull-to-refresh ref=""pageRefresh"" @refresh='refresh'>
        <q-card v-for="t in list" :key='t.id' class="bg-white q-mb-sm q-mx-sm" :style='0 == t.status ? "border-left:0.25rem solid #f2c037;" : 1 == t.status ? "border-left:0.25rem solid #027be3;" : "border-left:0.25rem solid #b5b3b3;"' flat @click='goDetail(t.id)'>
          <q-item>
            <q-item-section>
      ...
      <q-page-sticky position="bottom-right" :offset='fabPos'>
        <q-btn v-show="menuInfo.edit_permit != null" v-touch-pan.prevent.mouse.prevent.mouse="moveFab" round color="primary" icon="add" @click='addApply' />
      </q-page-sticky>
    </q-page>
  </q-page-container>
</q-layout>
