 ...
 * Source: assets/www/js/56.js -> module "69c3"
 * Route: /teacher/index
 * Component guess: TeacherIndex
...
"69c3": function(t, e, s) {
  ...
  var a = function() {
      ...
      return s("q-layout", {
      ...
      }), s("q-toolbar-title", [t._v("智慧学工")]), t.achieveMenuInfo && t.achieveMenuInfo.view_permit ? s("q-btn", {
        attrs: {
          flat: "",
          round: "",
          dense: "",
      ...
      }, [t._v("您好，" + t._s(t.user.name) + "老师")])]), s("q-card", {
        staticClass: "q-ma-sm",
        attrs: {
          flat: ""
        }
        ...
        on: {
          click: function(e) {
            return t.moveTo("/teacher/achievement/index?stuNo=" + t.user.login_name)
          }
        }
      ...
      }), t.scanMenuInfo && t.scanMenuInfo.view_permit ? s("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }],
      ...
      }, [s("q-item-section", [t._v("信息核验")]), s("q-item-section", {
        attrs: {
          side: ""
        }
      }, [s("q-icon", {
        ...
        return s("div", {
          ...
          staticClass: "row items-start q-gutter-sm"
        }, t._l(Math.min((t.normalApps ? t.normalApps.length : 0) - 4 * (e - 1), 4), (function(a) {
          return s("q-responsive", {
            ...
            staticClass: "rounded-borders q-pa-sm",
            class: ["bg-" + (t.normalApps[4 * (e - 1) + a - 1].color.background, t.normalApps[4 * (e - 1) + a - 1].color.background), "text-" + t.normalApps[4 * (e - 1) + a - 1].color.text]
      ...
      })], 1), s("q-separator"), s("q-item", {
        attrs: {
          clickable: ""
        }
      }, [s("q-item-section", [s("q-item-label", t._l(t.messageList, (function(e, a) {
        return s("q-radio", {
          key: a,
          staticClass: "q-mr-sm",
          attrs: {
            "keep-color": "",
            val: e.login_name,
            label: e.name + "(" + e.role_name + "/" + e.login_name + ")"
          },
          on: {
            input: function(s) {
    ...
    r = {
      ...
      computed: {
        apps() {
          return (this.menus || []).reduce(((t, e) => "S" === e.domain && "repair" !== e.id ? t.concat(e) : t), [])
        },
        topApps() {
      ...
      methods: {
        ...
        getMessage() {
          this.stuNo && this.$axiosAction("/api/teacher/experience/experience.api", {
            action: "getCheckMessageCount",
            stuNo: this.stuNo
          }).then((t => {
            if (0 === t.data.code)
              if (t.data.result.length > 1) this.messageList = t.data.result, this.message = !0;
              else {
                if (0 === t.data.result.length) return this.$showErrorNotify("无该学生/老师");
                this.stuNo = t.data.result[0].login_name, this.goExperience(t.data.result[0].role_type)
              }
          }))
        },
        goExperience(t) {
          "S" === t ? this.$router.push({
        ...
        toNews(t, e) {
          "" !== e && null !== e ? (this.$axiosAction("/api/teacher/news/news.api", {
            ...
            0 === t.data.code || "2001" === t.data.code && (this.$showErrorNotify("该新闻被删除或不存在"), this.$router.push("teacher/news/index"))
          })).catch((t => {
            this.$showErrorNotify("系统错误")
          })), cordova.InAppBrowser.open(e, "_system")) : this.$router.push(`/teacher/news/detail?id=${t}`)
        },
        setCarousel() {
