...
d79d: function(e, t, a) {
  ...
  var i = function() {
      ...
      return i("q-layout", {
      ...
      }), i("q-toolbar-title", [t._v("日志详情")]), i("q-btn", {
        attrs: {
          flat: "",
          round: "",
          dense: "",
        ...
        scopedSlots: t._u([{
          ...
          fn: function() {
            ...
            }, [t._v(t._s(t.record.title))])], 1), i("q-item-section", {
              attrs: {
                side: ""
              }
            }, [i("q-btn", {
        ...
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("填写有效时间")]), t._v(t._s(t.record.begin_date) + " ~ " + t._s(t.record.end_date) + "\n              ")])])])], 1)], 1)], 1), i("q-dialog", {
        attrs: {
          persistent: ""
        },
        model: {
        ...
        attrs: {
          ...
          rules: [function(e) {
            ...
            return t >= e.record.end_date || "请填写原截止日期之后的日期"
          }],
          value: t.endDate
        },
        scopedSlots: t._u([{
        ...
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("填写有效期间")]), t._v(t._s(t.record.begin_date) + " ~ " + t._s(t.record.end_date) + "\n          ")]), i("div", {
        staticClass: "q-mt-sm",
        domProps: {
        ...
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("允许填报人自己删除记录")]), t._v(t._s(1 === t.record.allow_delete ? "是" : "否") + "\n            "), i("div", {
        staticStyle: {
          float: "right",
          "margin-top": "-7px"
        }
        ...
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("填报日志系统管理员是否可见")]), t._v(t._s(1 === t.record.allow_look ? "否" : "是") + "\n            "), i("div", {
        staticStyle: {
          float: "right",
          "margin-top": "-7px"
        }
        ...
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("填写对象")]), t.record.is_author && null !== t.menuInfo.edit_permit ? i("div", {
        staticStyle: {
          float: "right"
        }
      }, [i("span", {
        ...
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("共享")]), t.record.is_author && null !== t.menuInfo.edit_permit ? i("div", {
        staticStyle: {
          float: "right"
        }
      }, [i("span", {
        ...
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("工作日志表单")])]), t._l(t.record.info_config, (function(e, a) {
        return i("div", {
          key: a,
        ...
        on: {
          submit: t.submitJoblogResult
        }
      }, [i("q-card-section", {
        staticClass: "row items-center justify-between"
      }, [i("div", {
        staticClass: "text-h6"
      }, [t._v("工作日志")])]), i("q-separator"), i("q-card-section", t._l(t.infoConfig, (function(e, a) {
        return i("div", {
          key: a,
          staticClass: "bg-grey-2 q-pa-sm q-mt-sm"
        }, [i("neu-widget", {
      ...
      }, [t._v("可以查询教工号、姓名、性别、部门")])], 1)], 1)], 1)], 1)], 1), i("q-dialog", {
        attrs: {
          persistent: "",
          fullWidth: "",
          maximized: !0
        ...
        return i("q-card", {
          ...
          style: 0 == e.status ? "border-left:0.25rem solid #b5b3b3;" : "border-left:0.25rem solid #027be3;",
          attrs: {
            flat: ""
          },
          on: {
            click: function(a) {
              return t.goDetail(e.id, !e.allow_edit, e.teacher_no, e.allow_look)
            }
          }
        }, [i("q-item", {
          attrs: {
        ...
        }, [i("q-item-section", [i("q-item-label", [i("q-icon", {
          directives: [{
            name: "show",
            rawName: "v-show",
            value: "男" == e.sex_name,
        ...
        }), t._v("\n                      " + t._s(e.teacher_name) + " "), i("span", {
          staticClass: "text-grey"
        }, [t._v("(" + t._s(e.teacher_no) + ")")])], 1), i("q-item-label", {
          attrs: {
            lines: "1",
            caption: ""
          }
        }, [t._v(" " + t._s(e.dep_name) + " ")]), i("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
        ...
        }, [t._v("提交时间")]), t._v(t._s(e.submit_time) + "\n                    ")])], 1), i("q-item-section", {
          staticClass: "q-mt-sm",
          attrs: {
            side: ""
          }
      ...
      }, [t._v("预览模板")])], 1), 1 == t.record.status && t.record.is_author ? i("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }],
      ...
      }, [t._v("延期")])], 1) : t._e(), 0 == t.record.status && t.record.is_author ? i("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }],
      ...
      }, [t._v("重新开启")])], 1) : t._e(), t.record.is_author ? i("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }],
      ...
      }, [t._v("删除")])], 1) : t._e(), 0 == t.record.allow_look || "A" != t.roleId ? i("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }],
      ...
      }, [t._v("导出")])], 1) : t._e()], 1)], 1)], 1), t.aCreate ? i("q-page-sticky", {
        attrs: {
    ...
    h = {
      ...
      mounted() {
        this.id = this.$route.query.id, window.localStorage.getItem("menu") && (this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((e => "joblog" === e.id))), this.getDetail(), window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.loadList((() => {}))
      },
      methods: {
        loadList(e) {
          e && (this.paging.pageNum = 0, this.list = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/joblog/joblog.api", r()(r()({
            action: "queryJoblogResultList",
            joblog_id: this.id
          }, this.queryModel), {}, {
        ...
        terminateJoblog() {
          this.$q.dialog({
            ...
            this.$q.loading.show(), this.$axiosAction("/api/teacher/joblog/joblog.api", {
              action: "terminateJoblog",
              id: this.id
            }).then((e => {
              0 === e.data.code && this.$router.push("/teacher/joblog/index"), this.$q.loading.hide()
            })).catch((e => {
              this.$q.loading.hide()
            }))
          }))
        ...
        copyApply() {
          this.$q.dialog({
            ...
            this.$axiosAction("/api/teacher/joblog/joblog.api", {
              ...
              0 === e.data.code && this.$router.push({
        ...
        extendJoblog() {
          this.$axiosAction("/api/teacher/joblog/joblog.api", {
            ...
            0 === e.data.code && (1 === this.record.status ? (this.record.end_date = this.endDate, this.extendDialog = !1) : this.$router.push("/teacher/joblog/index"))
          })).catch((e => {
            this.$q.loading.hide()
          }))
        },
        ...
        submitJoblogResult() {
          ...
          e.info_result = JSON.stringify(e.info_result), this.$axiosAction("/api/teacher/joblog/joblog.api", r()({
            action: e.id ? "updateJoblogResult" : "insertJoblogResult"
          }, e)).then((e => {
        ...
        exportList() {
          ...
          e.joblog_id = this.id, this.exportCompConfig = ["/api/teacher/joblog/joblog.api", "queryJoblogResultList", e, {
            ...
            if (this.infoConfig)
              for (let i = 0; i < this.infoConfig.length; i++) a[(i + 1).toString() + "." + this.infoConfig[i].label] = t.info_result ? Object(g["c"])(this.infoConfig[i], t.info_result[i]) : null;
            return e.concat(a)
          }), []), 1e3, 5e3]
        },
        openShareDialog() {
        ...
        goDetail(e, t, a, i) {
          if (1 === i && "A" === this.roleId) this.$q.dialog({
            title: "无法查看",
            ...
            this.viewMode = t, window.localStorage.setItem("joblog_result_detail", JSON.stringify(this.result)), window.localStorage.setItem("joblog_infoConfig", JSON.stringify(this.infoConfig)), this.$router.push("/teacher/joblog/detailResult?type=" + i + "&jobId=" + this.id + "&joblogRstId=" + e + "&viewMode=" + this.viewMode + "&teacher_no=" + a + "&getAllowDelete=" + s)
          }
        },
        moveFab(e) {
        ...
        getDetail() {
          this.$axiosAction("/api/teacher/joblog/joblog.api", {
            ...
            0 === e.data.code && ("" === e.data.result && (this.$showErrorNotify("该条信息不存在或您权限不足"), this.goBack()), this.infoConfig = e.data.result.info_config, this.record = e.data.result, this.aCreate = this.record.allow_create)
          })).catch((e => {
            this.record = {}
          }))
        }
