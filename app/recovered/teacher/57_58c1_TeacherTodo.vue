<!--
  Source: assets/www/js/57.js -> webpack module "58c1"
  Route: /teacher/todo
  ...
  <q-page-container>
    <q-page class="bg-grey-3 q-pb-sm">
      <q-pull-to-refresh @refresh='refresh'>
        <q-card v-for="(t, a) in list" :key='a' class="bg-white q-mb-sm q-mx-sm" :style='"border-left:0.25rem solid #" + getMenuColor(t.menu_id)' flat>
          <q-item v-ripple clickable @click='goDetail(t.id, t.link)'>
            <q-item-section>
            ...
            <q-item-section side top>
              <q-item-label caption>
                {{ "\n                " + t.days > 1 ? t.push_date : 1 == t.days ? t.days + "天前" : 0 != t.hours ? t.hours + "小时前" : 0 != t.mins ? t.mins + "分钟前" : "刚刚" + "\n              " }}
              </q-item-label>
            </q-item-section>
          </q-item>
        </q-card>
