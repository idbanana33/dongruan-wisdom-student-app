...
2727: function(e, t, a) {
  ...
  var i = function() {
      ...
      return a("q-layout", {
      ...
      }), a("q-toolbar-title", [e._v(e._s(this.$route.query.teacher_name) + " 的请假历史")])], 1)], 1), a("q-page-container", [a("q-page", {
        ...
        }, [e._v(e._s(1 === t.province_out ? "需要离省" : "不需要离省"))])]), a("q-item-label", {
          attrs: {
            lines: "2"
          }
        }, [e._v("\n                " + e._s(t.leave_period) + "\n              ")])], 1)], 1)], 1)
