<!--
  Source: assets/www/js/92.js -> webpack module "0df3"
    ...
    <q-page class="bg-grey-3 q-pb-sm">
          ...
          <q-item>
            <q-item-section>
              ...
              <q-item-label class="row" style="min-width:250px" caption lines="1">
                <div class="col-6">
                  <span class="neu-css-after-colon">
                    {{ menuInfo.title + "已收集人数" }}
                  </span>
                  {{ e.messaged }}
                </div>
                <div class="col-6">
                  <span class="neu-css-after-colon">
                    {{ menuInfo.title + "未收集人数" }}
                  </span>
                  {{ e.nomessage }}
                </div>
              </q-item-label>
        ...
        <q-card class="full-width" flat>
          ...
          <q-card-section>
            ...
            <div v-if="'A' == record.frequency" class="row">
              ...
              <div>
                <div v-for="(e, s) in record.appointed_date" :key='s'>
          ...
          <q-card-section>
            ...
            <neu-view-assigned-teacher :value='record.task_target_excluding' />
          </q-card-section>
          ...
          <q-card-section v-if="record.info_config">
            ...
            <div v-for="(e, s) in record.info_config" :key='s' class="bg-grey-2 q-pa-sm q-mt-sm">
      ...
      <q-dialog v-model="taskTargetExcludDialog" persistent :maximized='true'>
        <q-card class="full-width" flat>
          ...
          <q-card-section>
            <neu-assign-teacher v-model="noActionTarget" />
          </q-card-section>
        </q-card>
      </q-dialog>
          ...
          <q-form @submit='resetTime'>
            ...
            <q-card-section>
              ...
              <div class="row items-center">
                ...
                <q-field style="width:200px" outlined dense stack-label hide-bottom-space lazy-rules :rules='[function (e) { return !!e || "请填写该项"; }, function (t) { return t > e.record.end_time || "请填写原截止时间之后的时间"; }]' :value='message_end_time'>
                  ...
                  <template v-slot:append>
                    <q-icon class="cursor-pointer" name="event">
                      <q-popup-proxy transition-show="scale" transition-hide="scale">
                        <div>
                          <q-date v-model="message_end_time" flat minimal mask="YYYY-MM-DD HH:mm">
                    ...
                    <q-icon class="cursor-pointer" name="access_time">
                      <q-popup-proxy transition-show="scale" transition-hide="scale">
                        <div class="row items-start">
                          <q-time v-model="message_end_time" flat mask="YYYY-MM-DD HH:mm" format24h>
                            <div class="row items-center justify-end">
                              <q-btn v-close-popup dense label="关闭" flat />
                            </div>
                          </q-time>
