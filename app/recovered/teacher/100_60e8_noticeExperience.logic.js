 ...
 * Component guess: noticeExperience
...
"60e8": function(t, e, a) {
  ...
  var s = function() {
      ...
      return a("q-layout", {
      ...
      }), a("q-toolbar-title", [t._v(t._s(t.stuName) + "的通知记录")]), a("q-btn", {
        attrs: {
          flat: "",
          round: "",
          dense: "",
        ...
        return a("q-card", {
          ...
          style: null == e.feedback_time ? "border-left:0.25rem solid #c10015;" : null != e.feedback_time && 1 == e.confirm_flag && null == e.confirm_time ? "border-left:0.25rem solid #027be3;" : "border-left:0.25rem solid #21ba45;",
          attrs: {
            flat: ""
          }
        }, [a("q-item", [a("q-item-section", [a("q-item-label", {
          staticClass: "text-subtitle1 row items-center"
        }, [t._v(t._s(e.title)), a("q-badge", {
          staticClass: "q-ml-xs",
          attrs: {
            color: e.notice_priority_color,
            "text-color": "white"
          }
        }, [t._v(t._s(e.notice_priority_name))])], 1), a("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
          ...
          staticClass: "neu-css-after-colon"
        }, [t._v("发起时间")]), t._v(t._s(e.push_time) + "\n              ")]), a("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
          ...
          staticClass: "neu-css-after-colon"
        }, [t._v("阅读时间")]), t._v(t._s(e.feedback_time) + "\n              ")]), a("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
          ...
          staticClass: "neu-css-after-colon"
        }, [t._v("反馈截止时间")]), t._v(t._s(e.feedback_deadline) + "\n              ")])], 1), a("q-item-section", {
          attrs: {
            side: "",
            top: ""
          }
        ...
        }, [t._v(t._s(e.feedback_status_name))])]), 1 == e.confirm_flag ? a("q-item-label", [a("span", {
          staticClass: "q-ml-md",
          class: "未确认" == e.confirm_status_name ? "text-red" : "已确认" == e.confirm_status_name ? "text-primary" : "text-positive"
        }, [t._v(t._s(e.confirm_status_name))])]) : t._e()], 1)], 1)], 1)
      })), a("div", {
        directives: [{
          name: "show",
          rawName: "v-show",
    ...
    l = {
      ...
      methods: {
        ...
        loadList(t) {
          t && (this.paging.pageNum = 0, this.list = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/notice/notice.api", {
        ...
        exportList() {
          this.stuNo && (this.exportCompConfig = ["/api/teacher/notice/notice.api", "exportgetPersonDetails", {
            login_name: this.stuNo
          }, {
