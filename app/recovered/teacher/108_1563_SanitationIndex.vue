<!--
  Source: assets/www/js/108.js -> webpack module "1563"
...
<q-layout view="lHh lpr lFf">
  ...
  <q-pull-to-refresh ref=""pageRefresh"" @refresh='refresh'>
    <q-page-container>
      <q-page class="bg-grey-3 q-pb-sm">
        <q-card v-for="t in list" :key='t.id' class="bg-white q-mb-sm q-mx-sm" :style='"0" == t.status_color ? "border-left:0.25rem solid #f2c037;" : "1" == t.status_color ? "border-left:0.25rem solid #027be3;" : "border-left:0.25rem solid #b5b3b3;"' flat @click='goDetail(t.id)'>
          <q-item>
            <q-item-section>
  ...
  <q-page-sticky v-if="'A' == menuInfo.edit_permit" position="bottom-right" :offset='fabPos'>
    <q-btn v-touch-pan.prevent.mouse.prevent.mouse="moveFab" round color="primary" icon="add" @click='addSanitation' />
  </q-page-sticky>
</q-layout>
</template>
