...
"7f35": function(e, t, a) {
  ...
  var s = function() {
      ...
      return a("q-layout", {
        ...
        return a("q-card", {
        ...
        }, [e._v(e._s(t.title)), a("q-badge", {
          staticClass: "q-ml-xs",
          attrs: {
            color: t.notice_priority_color,
            "text-color": "white"
          }
        }, [e._v(e._s(t.notice_priority_name))])], 1), a("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
        ...
        }, [e._v("阅读率")]), e._v(e._s(t.feedback_total) + "/" + e._s(t.total) + "\n                "), a("span", {
          class: t.feedback_ratio >= 85 ? "text-positive" : t.feedback_ratio >= 60 ? "text-warning" : "text-red"
        }, [e._v("(" + e._s(t.feedback_ratio) + "%)")]), a("span", {
          directives: [{
            name: "show",
            rawName: "v-show",
          ...
          staticClass: "q-ml-lg"
        }, [e._v("确认率：" + e._s(t.confirm_total) + "/" + e._s(t.total))]), a("span", {
          directives: [{
            name: "show",
            rawName: "v-show",
            value: 1 == t.confirm_flag,
          ...
          class: t.confirm_ratio >= 85 ? "text-positive" : t.confirm_ratio >= 60 ? "text-warning" : "text-red"
        }, [e._v("(" + e._s(t.confirm_ratio) + "%)")])]), a("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
          ...
          staticClass: "neu-css-after-colon"
        }, [e._v("执行时间")]), e._v(e._s(t.push_time) + " 至 " + e._s(t.feedback_deadline) + "\n              ")])], 1), a("q-item-section", {
          attrs: {
            side: ""
          }
      ...
      }, [e._v("可以查询标题信息")])], 1)], 1)], 1)], 1)], 1), a("q-page-sticky", {
        attrs: {
    ...
    r = {
      ...
      computed: {
        menuInfo() {
          return window.localStorage.getItem("menu") ? JSON.parse(window.localStorage.getItem("menu")).find((e => "notice" === e.id)) : {}
        }
      },
      destroyed() {
      ...
      methods: {
        ...
        loadList(e) {
          e && (this.paging.pageNum = 0, this.list = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/notice/notice.api", n()(n()({
            action: "queryList"
          }, this.queryModel), {}, {
