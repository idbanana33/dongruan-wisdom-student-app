...
8087: function(e, t, s) {
  ...
  var a = function() {
      ...
      }), s("q-toolbar-title", [e._v("新建" + e._s(e.menuInfo.title))])], 1), s("q-separator")], 1), s("q-page-container", [s("q-page", {
      ...
      }, [s("q-list", [s("q-item", [s("q-item-section", [s("q-item-label", {
        staticClass: "text-bold"
      }, [e._v("新闻内容")])], 1)], 1), s("q-separator"), s("q-item", [s("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [s("div", {
      ...
      }, [s("div", [e._v("\n                添加链接新闻\n              ")])]), s("q-item-section"), s("q-item-section", {
        attrs: {
          side: ""
        }
      }, [s("q-toggle", {
      ...
      })], 1)], 1), s("q-separator"), "0" == e.news.external_flag ? s("q-item", [s("q-item-section", [s("q-item-label", {
      ...
      })], 1)], 1) : e._e(), "0" == e.news.external_flag ? s("q-separator") : e._e(), "1" == e.news.external_flag ? s("q-item", [s("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [s("div", {
      ...
      })], 1)], 1) : e._e(), "1" == e.news.external_flag ? s("q-separator") : e._e(), s("q-item", [s("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [s("div", [e._v("\n                推送至在籍学生\n              ")])]), s("q-item-section"), s("q-item-section", {
          ...
          fn: function() {
            return [s("q-icon", {
              ...
              model: {
                value: e.news.banner_end_date,
                callback: function(t) {
                  e.$set(e.news, "banner_end_date", t)
                },
                expression: "news.banner_end_date"
              }
            }, [s("div", {
      ...
      })], 1)], 1), s("q-item", [s("q-item-label", [s("span", {
        staticClass: "text-grey text-caption"
      }, [e._v("设置该新闻在app主页中轮播的结束时间，不设置则不在app轮播中显示")])])], 1)], 1)], 1) : e._e(), s("q-footer", {
    ...
    r = {
      ...
      mounted() {
        window.localStorage.getItem("menu") && (this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((e => "news" === e.id))), this.getDepList()
      },
      methods: {
        goBack() {
        ...
        saveNews() {
          this.news.link && !1 === this.checkLink() || (this.news.title.length > 50 ? this.$showErrorNotify("标题长度不能超过50") : "0" !== this.news.external_flag || "" !== this.news.detail ? ("1" === this.news.external_flag ? this.news.detail = "" : this.news.link = "", "1" === this.news.push_to_student && "1" === this.news.push_to_teacher ? this.pushType = 3 : "0" === this.news.push_to_student && "1" === this.news.push_to_teacher ? this.pushType = 1 : "1" === this.news.push_to_student && "0" === this.news.push_to_teacher && (this.pushType = 2), "" !== this.news.dep_no && void 0 !== this.news.dep_no || (this.news.dep_no = null), this.$q.loading.show(), this.$axiosAction("/api/teacher/news/news.api", o()(o()({
            action: "insertNews"
          }, this.news), {}, {
            roleId: this.roleId,
        ...
        checkLink() {
          ...
          return "http://" === e.slice(0, 7) || "https://" === e.slice(0, 8) || (this.$showErrorNotify("链接开头必须包含http://或者https://"), !1)
        },
        getDepList() {
          this.$axiosAction("/api/public.api", {
            ...
            0 === e.data.code && (this.depoptions = e.data.list, this.news.dep_no = this.depoptions.find((e => e.value === this.dep_no)).value)
          })).catch((e => {
            this.options = []
          }))
        }
