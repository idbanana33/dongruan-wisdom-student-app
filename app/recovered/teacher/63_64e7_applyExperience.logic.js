 ...
 * Component guess: applyExperience
...
"64e7": function(t, e, a) {
  ...
  var i = function() {
      ...
      return a("q-layout", {
      ...
      }), t.menuInfo ? a("q-toolbar-title", [t._v(t._s(t.stuName) + "的" + t._s(t.menuInfo.title) + "记录")]) : t._e(), a("q-btn", {
        attrs: {
          flat: "",
          round: "",
          dense: "",
        ...
        return a("q-card", {
        ...
        }, [t._v("发起人")]), t._v(t._s(e.teacher_name) + "\n              ")]), a("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
          ...
          staticClass: "neu-css-after-colon"
        }, [t._v(t._s(t.applyShortTitle) + "时间")]), t._v(t._s(e.apply_time) + "\n              ")]), a("q-item-label", {
          staticStyle: {
            "min-width": "250px"
          },
          attrs: {
        ...
        }, [t._v(t._s(e.begin_time) + " 至 " + t._s(e.end_time))])])], 1)], 1), a("div", {
          directives: [{
            name: "show",
            rawName: "v-show",
            value: null == e.apply_time,
        ...
        staticClass: "text-h6"
      }, [t._v(t._s(t.record.title))]), a("span", {
        class: 0 == t.record.writeStatus ? "text-red" : "text-blue"
      }, [t._v(t._s(0 == t.record.writeStatus ? "未" + t.applyShortTitle : "已" + t.applyShortTitle))]), a("q-btn", {
        directives: [{
          name: "close-popup",
      ...
      }, [a("span", [t._v(t._s(t.record.timeSlot))])]), t._l(t.record.info_config, (function(e, i) {
        return a("div", {
          key: i,
    ...
    p = {
      ...
      computed: {
        ...
        undoImage() {
          return "A" === this.applyType ? `${cordova.file.applicationDirectory}www/img/noapply.png` : "S" === this.applyType ? `${cordova.file.applicationDirectory}www/img/nosignup.png` : "C" === this.applyType ? `${cordova.file.applicationDirectory}www/img/nocollect.png` : ""
        },
        menuInfo() {
      ...
      methods: {
        loadList(t) {
          t && (this.paging.pageNum = 0, this.list = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/apply/apply.api", {
        ...
        exportList() {
          this.stuNo && (this.exportCompConfig = ["/api/teacher/apply/apply.api", "getPersonDetails", {
            login_name: this.stuNo,
            applyType: this.applyType
          }, {
            [`${this.stuName}的历史${this.menuInfo.title}记录`]: "result"
          }, `${this.stuName}的历史${this.menuInfo.title}记录`, null, t => t.reduce(((t, e) => {
            const a = {
              [this.applyShortTitle + "名称"]: e.title,
              "发起人": e.teacher_name,
              "创建时间": e.create_time,
              "有效时间": e.begin_time + "至" + e.end_time,
              "状态": 1 === e.apply_status ? `已${this.applyShortTitle}` : `未${this.applyShortTitle}`,
        ...
        getDetail(t, e) {
          ...
          if (0 !== e) this.record.batchNoDetail = this.record.batchNoDetail + e;
            ...
            this.record.batchNumber = e.length, this.record.batchNoDetail = t.batch_no, this.record.apply_id = t.apply_id, this.record.info_config = t.info_config, this.record.timeSlot = t.begin_time + "至" + t.end_time, this.record.title = t.title
          }
          this.$q.loading.show(), this.$axiosAction("/api/teacher/apply/apply.api", {
            ...
            0 === t.data.code && (null === t.data.result.info_result ? (this.record.infoResult = [], null === t.data.result.apply_time ? this.record.writeStatus = 0 : this.record.writeStatus = t.data.result.apply_status) : (this.record.infoResult = t.data.result.info_result, this.record.writeStatus = t.data.result.apply_status), this.infoResultDialog = !0), this.$q.loading.hide()
          }))
        }
      }
    },
