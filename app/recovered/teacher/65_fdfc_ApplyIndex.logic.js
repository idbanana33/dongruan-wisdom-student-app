 ...
 * Source: assets/www/js/65.js -> module "fdfc"
 * Route: /teacher/apply/index
 * Component guess: ApplyIndex
...
fdfc: function(e, t, a) {
  ...
  var s = function() {
    ...
    l = {
      ...
      computed: {
        menuInfo() {
          return "A" === this.applyType ? JSON.parse(window.localStorage.getItem("menu")).find((e => "apply" === e.id)) : "S" === this.applyType ? JSON.parse(window.localStorage.getItem("menu")).find((e => "signup" === e.id)) : "C" === this.applyType ? JSON.parse(window.localStorage.getItem("menu")).find((e => "collect" === e.id)) : {}
        }
      },
      methods: {
        goBack() {
        ...
        loadList(e) {
          e && (this.paging.pageNum = 0, this.list = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/apply/apply.api", o()(o()({
            action: "queryList",
        ...
        addApply() {
          this.$router.push(`/teacher/apply/new?apply_type=${this.applyType}`)
        },
        moveFab(e) {
          this.draggingFab = !0 !== e.isFirst && !0 !== e.isFinal, this.fabPos = [this.fabPos[0] - e.delta.x, this.fabPos[1] - e.delta.y]
        },
        goDetail(e) {
          this.$router.push(`/teacher/apply/statistics?id=${e}&apply_type=${this.applyType}`)
        },
        open() {
    ...
    P = a("eebe"),
    $ = a.n(P),
    F = Object(d["a"])(r, s, i, !1, null, null, null);
  t["default"] = F.exports;
  $()(F, "components", {
    QLayout: p["a"],
    QHeader: c["a"],
