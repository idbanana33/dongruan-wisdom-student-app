 ...
 * Component guess: newsTeacherIndex
  ...
  var s = function() {
      ...
      return a("q-layout", {
        ...
        return a("q-card", {
          ...
          style: null == t.link || "" == t.link ? "border-left:0.25rem solid #40E0D0;" : "border-left:0.25rem solid #027be3;",
          attrs: {
            flat: ""
          },
          on: {
          ...
          staticClass: "neu-css-after-colon "
        }, [e._v("发布时间")]), e._v(e._s(t.create_time) + "\n                  ")]), t.teacher_no == e.login_name || "A" == e.roleId ? a("q-item-label", {
          staticStyle: {
            "min-width": "250px"
          },
          attrs: {
          ...
          staticClass: "neu-css-after-colon "
        }, [e._v("结束时间")]), e._v(e._s(null == t.banner_end_date ? "无" : t.banner_end_date) + "\n                  ")]) : e._e(), t.teacher_no == e.login_name || "A" == e.roleId ? a("q-item-label", {
          staticStyle: {
            "min-width": "250px"
          },
          attrs: {
          ...
          staticClass: "neu-css-after-colon "
        }, [e._v("链接新闻")]), e._v(e._s(null == t.link || "" == t.link ? "否" : "是") + "\n                  ")]) : e._e()], 1), a("q-item-section", {
          attrs: {
            side: ""
          }
      ...
      }, [a("span", [e._v("新闻状态")])]), a("q-item-section", [a("div", {
      ...
      }, [e._v("可以查询新闻标题和新闻发布者")])], 1)], 1)], 1)], 1)], 1)], 1)
    },
    i = [],
    n = (a("13d5"), a("ded3")),
    o = a.n(n),
    r = {
      ...
      mounted() {
        window.localStorage.getItem("menu") && (this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((e => "news" === e.id))), window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.loadList((() => {}))
      },
      destroyed() {
      ...
      methods: {
        ...
        loadList(e) {
          e && (this.paging.pageNum = 0, this.list = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/news/news.api", o()(o()({
            action: "getNewsList"
          }, this.queryModel), {}, {
        ...
        goDetail(e, t, a) {
          this.login_name === a || "A" === this.roleId ? this.$router.push(`/teacher/news/detail?id=${e}`) : t ? this.$axiosAction("/api/teacher/news/news.api", {
            action: "insertNewsLog",
            id: e,
            roleId: this.roleId,
            role_type: this.role_type
          }).then((e => {
            0 === e.data.code ? cordova.InAppBrowser.open(t, "_system") : 2001 === e.data.code && this.refresh((() => {}))
          })).catch((e => {
