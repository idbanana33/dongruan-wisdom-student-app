...
"18bf": function(e, t, a) {
  ...
  var i = function() {
      ...
      return a("q-layout", {
      ...
      }), a("q-toolbar-title", [e._v("新建模板")])], 1)], 1), a("q-page-container", [a("q-page", {
      ...
      }, [a("q-list", [a("q-item", [a("q-item-section", [a("q-item-label", {
        staticClass: "text-bold"
      }, [e._v("模板说明")])], 1)], 1), a("q-separator"), a("q-item", [a("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [a("div", {
        ...
        staticClass: "text-bold"
      }, [e._v("填写有效期间")])], 1)], 1), a("q-separator"), a("q-item", [a("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [a("div", {
          ...
          fn: function() {
            return [a("q-icon", {
              ...
              model: {
                value: e.record.begin_date,
                callback: function(t) {
                  e.$set(e.record, "begin_date", t)
                },
                expression: "record.begin_date"
              }
            }, [a("div", {
        ...
        attrs: {
          ...
          rules: [function(e) {
            ...
            return t > e.record.begin_date || "截止日期应在开始日期之后"
          }],
        ...
        class: 0 === e.record.task_target.length ? "text-grey" : "text-primary",
        attrs: {
          size: "md"
        },
        on: {
      ...
      }, [e._v(e._s(0 === e.record.task_target.length ? "请选择" : "已选择 (" + e.record.task_target.length + ")"))]), a("q-icon", {
        class: 0 === e.record.task_target.length ? "text-grey" : "text-primary",
        attrs: {
      ...
      }, [e._v("将该日志统计数据共享给他老师")])], 1), a("q-item-section"), a("q-item-section", {
        attrs: {
          side: ""
        }
      }, [a("q-item-label", {
        ...
        class: 0 === e.record.info_config.length ? "text-grey" : "text-primary",
        attrs: {
          size: "md"
        },
        on: {
        ...
        staticClass: "q-my-sm"
      }, [e._v("工作日志表单项目")]), e._l(e.record.info_config, (function(t, i) {
        return a("div", {
          key: i,
        ...
        staticClass: "text-bold"
      }, [e._v("设置工作日志表单")])]), a("q-card-section", [a("neu-define-widget", {
        on: {
          save: function(t) {
    ...
    f = {
      ...
      mounted() {
        window.localStorage.getItem("menu") && (this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((e => "joblog" === e.id))), this.$route.params && this.$route.params.record && (this.record = this.$route.params.record, null == this.record.share_target && (this.record.share_target = []))
      },
      methods: {
        goBack() {
        ...
        saveRecord() {
          ...
          if (!this.record.task_target || 0 === this.record.task_target.length) return void this.$showErrorNotify("请设置填写对象");
          if (!this.record.info_config || 0 === this.record.info_config.length) return void this.$showErrorNotify("请设置工作日志表单项目");
          this.$q.loading.show();
          const e = r()({}, this.record);
          e.task_target = JSON.stringify(e.task_target), e.share_target = e.share_target && e.share_target.length > 0 ? JSON.stringify(e.share_target) : null, e.info_config = JSON.stringify(e.info_config), this.$axiosAction("/api/teacher/joblog/joblog.api", r()({
            action: "insert"
          }, e)).then((e => {
