...
ebc5: function(t, e, a) {
  ...
  var i = function() {
      ...
      return a("q-layout", {
      ...
      }), a("q-toolbar-title", [t._v("组合任务详情")]), a("q-btn", {
        attrs: {
          flat: "",
          round: "",
          dense: "",
      ...
      }, [t._v(t._s(t.condCount))])], 1)], 1), a("q-expansion-item", {
        ...
        scopedSlots: t._u([{
          ...
          fn: function() {
            ...
            }, [t._v(t._s(t.record.title))])], 1), a("q-item-section", {
              attrs: {
                side: ""
              }
            }, [a("q-btn", {
      ...
      }, [t._v("发起人")]), t._v(t._s(t.record.name) + "\n            ")]), a("div", {
        staticClass: "q-ml-xl"
      }, [a("span", {
        staticClass: "text-grey"
      }, [t._v(" ")])]), a("div", [a("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("创建时间")]), t._v(t._s(t.record.create_time) + "\n            ")])])])], 1)], 1), a("q-separator")], 1), a("q-pull-to-refresh", {
        ref: "pageRefresh",
        on: {
          refresh: t.refresh
        }
        ...
        return a("q-card", {
        ...
        }, [t._v(" " + t._s(e.dep_name) + " ")]), a("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
          ...
          staticClass: "neu-css-after-colon "
        }, [t._v("创建时间")]), t._v(t._s(e.create_time) + "\n                  ")])], 1), a("q-item-section", {
          attrs: {
            side: ""
          }
          ...
          on: {
            click: function(a) {
              return t.openEditDialog(e.id, e.allow_edit, e.typename)
            }
          }
        }, [t._v("查看"), a("q-icon", {
          attrs: {
        ...
        })], 1)]), t.record.teacher_no == t.userInfo.login_name ? a("q-item-label", [a("span", {
          staticClass: "text-primary",
          on: {
            click: function(a) {
              return t.newTaskOpenDialog(e.id, e.typename, e.frequency)
            }
          }
        }, [t._v("发布新任务"), a("q-icon", {
          attrs: {
      ...
      }, [t._v("预览任务")])], 1), t.cCreate ? a("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }],
      ...
      }, [t._v("删除")])], 1) : t._e(), t.cCreate ? a("q-item", {
        directives: [{
          name: "ripple",
          rawName: "v-ripple"
        }],
      ...
      }, [t._v("导出")])], 1) : t._e()], 1)], 1)], 1), a("q-dialog", {
        attrs: {
          position: "bottom"
        },
        model: {
      ...
      }, [t._v("可以查询任务名称和类型")])], 1)], 1)], 1)], 1)], 1), a("q-dialog", {
        model: {
          value: t.newDialog,
          callback: function(e) {
            t.newDialog = e
        ...
        }, [a("q-item-section", [t._v(t._s(e.title)), a("q-tooltip", [t._v("点击去发布")])], 1)], 1)
      })), 1)], 1)], 1)], 1), a("q-dialog", {
        model: {
        ...
        staticClass: "text-red"
      }, [t._v("组合任务包含")]), t._l(t.typeListCount, (function(e, i) {
        return a("span", {
          key: e.type,
          staticClass: "text-red"
        }, [t._v(t._s(e.typetitle) + t._s(e.count) + "个"), a("span", [t._v(t._s(i !== t.typeListCount.length - 1 ? "," : "。"))])])
      })), a("span", {
        staticClass: "text-red"
      }, [t._v("任务及其下面的数据也会被删除！")])], 2), a("q-card-actions", {
        attrs: {
          align: "right"
        }
      }, [a("q-btn", {
      ...
      })], 1), a("q-separator"), a("q-card-section", [a("div", {
        staticClass: "q-mt-sm text-bold"
      }, [t._v(t._s(t.record.title))]), a("div", {
        staticClass: "q-mt-sm"
      }, [a("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("创建人")]), t._v(t._s(t.record.name) + "\n        ")]), a("div", [a("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("创建时间")]), t._v(t._s(t.record.create_time) + "\n        ")]), a("div", {
        staticClass: "q-mt-sm",
        domProps: {
      ...
      }), t.record.attachment && 0 != t.record.attachment.length ? a("div", {
        staticClass: "q-mt-sm",
        class: t.record.attachment && 1 == t.record.attachment.length ? "row" : ""
      }, [a("div", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("附件")]), a("div", t._l(t.record.attachment, (function(e) {
        return a("div", {
          key: e.servername,
      ...
      })), 0)]) : t._e()]), a("q-separator"), a("q-card-section", [a("div", [a("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("共享")]), t.record.teacher_no == t.userInfo.login_name ? a("div", {
        staticStyle: {
          float: "right"
        }
      }, [a("span", {
      ...
      })], 1) : t._e()]), a("neu-view-assigned-teacher", {
        attrs: {
      ...
      })], 1)]), t.record.teacher_no == t.userInfo.login_name ? a("q-page-sticky", {
        attrs: {
    ...
    p = {
      ...
      data() {
        return {
          ...
          linkDetailList: [{
            ...
            type: "signin",
            link: "/teacher/signin/statistics?id="
          }],
          linkListParam: [{
            type: "notice",
            link: "/teacher/notice/new",
            query: {}
          }, {
            type: "apply",
            ...
            query: {
              apply_type: "S",
              apply_type_name: "活动报名"
            }
          }, {
            type: "signin",
            link: "/teacher/signin/new",
            query: {}
          }],
          newTaskDialog: !1,
      ...
      mounted() {
        this.id = this.$route.query.id, this.id, window.localStorage.getItem("menu") && (this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((t => "composite" === t.id))), this.showDetailInfo(), window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.loadList((() => {}))
      },
      methods: {
        showDetailInfo() {
          this.$q.loading.show(), this.$axiosAction("/api/teacher/composite/composite.api", {
            action: "queryListDetail",
            id: this.id
          }).then((t => {
            0 === t.data.code && (this.record = t.data.result, this.record.teacher_no !== this.userInfo.login_name && "A" !== this.userInfo.role_id || (this.cCreate = !0), "" === t.data.result && (this.$showErrorNotify("该内容为空，或无权限"), this.goBack())), this.$q.loading.hide()
          })).catch((t => {
            this.record = [], this.$q.loading.hide()
          }))
        },
        loadList(t) {
          t && (this.paging.pageNum = 0, this.list = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/composite/composite.api", r()(r()({
            action: "queryChildrenList"
          }, this.queryModel), {}, {
        ...
        openNewDialog(t) {
          ...
          this.resNewList.length < 1 ? this.$showErrorNotify("您没有新建相关任务权限，请联系管理员") : (this.toNewType = t, this.newDialog = !0)
        },
        exportList() {
          this.exportCompConfig = ["/api/teacher/composite/composite.api", "queryChildrenList", r()(r()({}, this.queryModel), {}, {
            composite_id: this.id
          }), {
        ...
        goNewLink(t) {
          if (1 === this.toNewType) {
            ...
            e.query.compositeId = this.id, e.query.compositeTitle = this.record.title, this.$router.push({
              name: e.link,
              query: e.query,
              params: {
        ...
        newTaskOpenDialog(t, e, a) {
          "S" === a ? (this.rowInfo.id = t, this.rowInfo.type = e, this.openNewDialog(2)) : (this.$q.loading.show(), this.$axiosAction("/api/teacher/composite/composite.api", {
            action: "getBatchNo",
            id: t,
            type: e
          }).then((a => {
            0 === a.data.code && (this.batchNoList = a.data.result, this.rowInfo.batch_no = this.batchNoList.length, this.rowInfo.id = t, this.rowInfo.type = e, this.batchNoDialog = !0), this.$q.loading.hide()
          })).catch((t => {
            this.$q.loading.hide()
          })))
        },
        newTask(t) {
          this.$q.loading.show(), this.rowInfo.typeId = t, this.$axiosAction("/api/teacher/composite/composite.api", r()({
            action: "getTaskTarget"
          }, this.rowInfo)).then((e => {
            if (0 === e.data.code) {
              const a = this.linkListParam.find((t => t.type === this.toNewTypeMenu));
              a.query.compositeId = this.id, a.query.compositeTitle = this.record.title, ("1" === t || "2" === t && "A" !== this.userInfo.role_id) && "1" === t ? this.$router.push({
                name: a.link,
                query: a.query,
                params: {
        ...
        deleteComposite() {
          this.$q.loading.show(), this.$axiosAction("/api/teacher/composite/composite.api", {
            ...
            0 === t.data.code && (this.typeListCount = t.data.result, this.deleteDialog = !0), this.$q.loading.hide()
          })).catch((t => {
            this.$q.loading.hide()
          }))
        },
