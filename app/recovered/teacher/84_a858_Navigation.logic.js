...
a858: function(t, e, a) {
  ...
  var i = function() {
    ...
    n = {
      ...
      mounted() {
        this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((t => "leave" === t.id)), this.getCount(), window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1))
      },
      methods: {
        getCount() {
