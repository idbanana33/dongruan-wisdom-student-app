  ...
  var i = function() {
      ...
      return a("q-layout", {
        ...
        return a("q-card", {
          ...
          on: {
            click: function(a) {
              return e.goDetail(t.id, t.status)
            }
          }
        ...
        }, [e._v(e._s(t.signin_type_name))])], 1), a("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
        ...
        }, [e._v("签到频率")]), e._v(e._s(t.frequency_name) + "\n                  "), a("span", {
          staticClass: "neu-css-after-colon q-ml-lg"
        }, [e._v("签到方式")]), e._v(e._s(t.sigme_name) + "\n                ")]), a("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
          ...
          staticClass: "neu-css-after-colon"
        }, [e._v("发起人")]), e._v(e._s(t.creator) + "\n                  "), a("span", {
          staticClass: "neu-css-after-colon q-ml-lg"
        }, [e._v("已/总执行次数")]), e._v(e._s(t.done_count) + "/" + e._s(t.total) + "\n                ")]), a("q-item-label", {
          staticStyle: {
            "min-width": "250px"
          },
          attrs: {
      ...
      }, [e._v("可以查询任务名称")])], 1)], 1)], 1)], 1)], 1)], 2), a("q-page-sticky", {
        directives: [{
          name: "show",
          rawName: "v-show",
          value: e.menuInfo.edit_permit,
          expression: "menuInfo.edit_permit"
        }],
        attrs: {
    ...
    r = {
      ...
      mounted() {
        window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((e => "signin" === e.id)), this.getSigninList((() => {}))
      },
      methods: {
        getSigninList(e) {
          e && (this.paging.pageNum = 0, this.list = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/signin/signin.api", o()(o()({
            action: "querySigninList"
          }, this.queryModel), {}, {
    ...
    F = a("eebe"),
    D = a.n(F),
    $ = Object(c["a"])(l, i, s, !1, null, null, null);
  t["default"] = $.exports;
  D()($, "components", {
    QLayout: d["a"],
    QHeader: u["a"],
