...
"66de": function(e, t, a) {
  ...
  var r = function() {
      ...
      return a("q-layout", {
      ...
      }, [e._v("通知内容")])], 1)], 1), a("q-separator"), a("q-item", [a("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [a("q-item-label", {
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("通知类型")])], 1), a("q-item-section", [a("q-select", {
        attrs: {
          dense: "",
          outlined: "",
          "emit-value": "",
        ...
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("通知标题")])], 1), a("q-item-section", [a("q-input", {
        attrs: {
          outlined: "",
          dense: "",
          "hide-bottom-space": "",
          ...
          fn: function(t) {
            return [a("q-list", {
              ...
              return a("q-item", {
                ...
                on: {
                  click: function(t) {
                    return e.downloadUploaderFile(r)
                  }
                }
              }, [e._v("\n                            " + e._s(r.name) + "\n                          ")])], 1), a("q-item-section", {
                attrs: {
      ...
      }) : e._e()], 1)], 1)], 1)], 1) : e._e(), e.menuInfo ? a("q-card", {
        ...
        staticClass: "text-bold"
      }, [e._v("通知参数")])], 1)], 1), a("q-separator"), a("q-item", [a("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [a("q-item-label", {
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("反馈截止时间")])], 1), a("q-item-section", [a("q-field", {
        staticClass: "full-width",
        staticStyle: {
          width: "200px"
        },
        ...
        scopedSlots: e._u([{
          key: "control",
          fn: function() {
            return [e._v(e._s(e.record.feedback_deadline))]
          },
          proxy: !0
        }, {
          key: "append",
          fn: function() {
            return [a("q-icon", {
              ...
              model: {
                value: e.record.feedback_deadline,
                callback: function(t) {
                  e.$set(e.record, "feedback_deadline", t)
                },
                expression: "record.feedback_deadline"
              }
            }, [a("div", {
        ...
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("手动确认已读")])], 1), a("q-item-section", {
        attrs: {
          side: ""
        }
      }, [a("q-toggle", {
      ...
      }, [e._v("开启后学生需要点击确认按钮对内容进行确认")])], 1)], 1), a("q-separator"), a("q-item", [a("q-item-section", [a("q-item-label", {
        staticClass: "neu-css-before-red-asterisk"
        ...
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("定时发送时间")])], 1), a("q-item-section", [a("q-field", {
        staticClass: "full-width",
        staticStyle: {
          width: "200px"
        },
        attrs: {
          ...
          "lazy-rules": "",
          rules: [function(t) {
            return !!t || 0 == e.record.fixed_time_flag || "请填写该项"
          }],
          ...
          fn: function() {
            return [a("q-icon", {
              ...
              model: {
                value: e.record.fixed_time,
                callback: function(t) {
                  e.$set(e.record, "fixed_time", t)
                },
                expression: "record.fixed_time"
              }
            }, [a("div", {
              staticClass: "row items-center justify-end"
            }, [a("q-btn", {
      ...
      })], 1)], 1)], 1)], 1) : e._e(), e.menuInfo ? a("q-card", {
        staticClass: "full-width row q-mt-sm",
        attrs: {
          flat: ""
        }
        ...
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("通知对象")])], 1), a("q-item-section"), a("q-item-section", {
        attrs: {
          side: ""
        }
      }, [a("q-item-label", {
      ...
      })], 1)], 1)], 1)], 1)], 1) : e._e(), e.menuInfo ? a("q-card", {
        staticClass: "full-width row q-mt-sm",
        attrs: {
          flat: ""
        }
      ...
      })], 1)], 1)], 1)], 1)], 1), e.menuInfo ? a("q-footer", {
    ...
    m = {
      ...
      mounted() {
        window.localStorage.getItem("menu") && (this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((e => "notice" === e.id))), this.$axiosAction("/api/public.api", {
        ...
        })), this.$route.params && this.$route.params.record ? (this.getDepList(2), this.record = this.$route.params.record, this.record.attachment = this.record.attachment ? this.record.attachment : [], this.record.task_target = this.record.task_target ? this.record.task_target : [], this.record.share_target = this.record.share_target ? this.record.share_target : []) : this.getDepList(1), window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.$route.params && this.$route.params.taskTarget && (this.record.task_target = this.$route.params.taskTarget), null !== this.cId && void 0 !== this.cId && (this.record.title = this.$route.query.compositeTitle + "-" + this.menuInfo.title, this.record.share_target = this.$route.params.share_target ? this.$route.params.share_target : [], this.shareDisable = !0), this.detectOperatingSystem()
      },
      methods: {
        ...
        saveRecord() {
          ...
          if (!this.record.task_target || 0 === this.record.task_target.length) return void this.$showErrorNotify("请设置通知对象");
          "" !== this.record.dep_no && void 0 !== this.record.dep_no || (this.record.dep_no = null), this.$q.loading.show();
          const e = o()({}, this.record);
          e.attachment = e.attachment && e.attachment.length > 0 ? JSON.stringify(e.attachment) : null, e.task_target = JSON.stringify(e.task_target), e.share_target = e.share_target && e.share_target.length > 0 ? JSON.stringify(e.share_target) : null, null !== this.cId && void 0 !== this.cId ? e.composite_id = this.$route.query.compositeId : e.composite_id = this.record.composite_id, this.$axiosAction("/api/teacher/notice/notice.api", o()({
            action: "insert"
          }, e)).then((e => {
