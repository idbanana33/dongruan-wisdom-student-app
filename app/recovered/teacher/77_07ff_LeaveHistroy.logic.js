...
"07ff": function(e, t, a) {
  ...
  var s = function() {
      ...
      return a("q-layout", {
      ...
      }), a("q-toolbar-title", [e._v(e._s(this.$route.query.student_name) + " 的请假历史")])], 1)], 1), a("q-page-container", [a("q-page", {
        ...
        }, [a("q-item", [a("q-item-section", [a("q-item-label", [e._v("\n                " + e._s(t.create_time) + "\n              ")]), a("q-item-label", {
          attrs: {
            lines: "1",
            caption: ""
          }
        }, [e._v(e._s(t.class_name) + " " + e._s(t.major_name) + " " + e._s(t.dep_name))]), a("q-item-label", {
          attrs: {
            lines: "2"
          }
        }, [e._v("\n                " + e._s(t.leave_type) + " "), a("span", {
          directives: [{
            name: "show",
            rawName: "v-show",
            value: 1 === t.walk_out,
        ...
        }, [e._v(e._s("是" == t.walk_outs ? "需要离校 " : "不需要离校 "))]), a("span", {
          directives: [{
            name: "show",
            rawName: "v-show",
            value: 1 === t.city_out,
        ...
        }, [e._v(e._s(1 === t.city_out ? "需要离市 " : "不需要离市 "))]), a("span", {
          directives: [{
            name: "show",
            rawName: "v-show",
        ...
        }, [e._v(e._s(1 === t.province_out ? "需要离省 " : "不需要离省 "))]), e._v(e._s(t.report_status_name) + "\n              ")]), a("q-item-label", {
          attrs: {
            lines: "2"
          }
        }, [e._v("\n                " + e._s(t.leave_period) + "\n              ")])], 1)], 1)], 1)
        ...
        directives: [{
          name: "show",
          rawName: "v-show",
          value: !e.isLoading && e.paging.pageCount == e.paging.pageNum && 0 != e.history.length,
          expression: "!isLoading && paging.pageCount == paging.pageNum && history.length != 0"
        }],
        staticClass: "text-center text-grey q-pt-sm q-pb-md"
      }, [e._v("\n          没有更多了\n        ")]), a("div", {
        directives: [{
    ...
    r = {
      ...
      computed: {
        menuInfo() {
          return window.localStorage.getItem("menu") ? JSON.parse(window.localStorage.getItem("menu")).find((e => "leave" === e.id)) : {}
        }
      },
      destroyed() {
      ...
      methods: {
        getLeaveByStudent(e) {
          e && (this.paging.pageNum = 0, this.history = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/leave/leave.api", {
        ...
        goBack() {
          this.$router.push(`/teacher/leave/detail?id=${this.$route.query.id}&tab=${this.$route.query.tab}`)
        }
      }
    },
    g = r,
    ...
    L = a("eebe"),
    x = a.n(L),
    C = Object(u["a"])(g, s, i, !1, null, null, null);
  t["default"] = C.exports;
  x()(C, "components", {
    QLayout: l["a"],
    QHeader: d["a"],
