...
"92f0": function(t, e, s) {
  ...
  var a = function() {
      ...
      return s("q-layout", {
      ...
      }), s("q-toolbar-title", [t._v(t._s(t.stuName) + "的签到记录")]), s("q-btn", {
        attrs: {
          flat: "",
          round: "",
          dense: "",
        ...
        return s("q-card", {
          ...
          style: 1 == e.status ? "border-left:0.25rem solid #c10015;" : 2 == e.status ? "border-left:0.25rem solid #21ba45;" : "border-left:0.25rem solid #027be3;",
          attrs: {
            flat: ""
          }
        ...
        }, [t._v(t._s(e.signin_type_name))])], 1), s("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
        ...
        }, [t._v("签到频率")]), t._v(t._s(e.label) + "\n                  "), s("span", {
          staticClass: "neu-css-after-colon q-ml-lg"
        }, [t._v("签到方式")]), t._v(t._s(e.signin_method_name) + "\n                ")]), s("q-item-label", {
          staticClass: "q-mb-xs",
          attrs: {
            caption: ""
          }
        ...
        }, [t._v(t._s(e.signin_time))]), s("span", {
          directives: [{
            name: "show",
            rawName: "v-show",
            value: "1" == e.status,
          ...
          staticClass: "neu-css-after-colon"
        }, [t._v("签到时间段")]), t._v(t._s(e.begin_time) + " 至 " + t._s(e.end_time) + "\n                ")])], 1)], 1), s("div", {
          directives: [{
            name: "show",
            rawName: "v-show",
            value: 1 == e.status,
    ...
    l = {
      ...
      methods: {
        ...
        exportList() {
          this.stuNo && (this.exportCompConfig = ["/api/teacher/signin/signin.api", "exportStuSigninDetail", {
            stuNo: this.stuNo
          }, {
            [`${this.stuName}的签到记录`]: "result"
          }, `${this.stuName}的签到记录`, null, null, 1e3, 5e3])
        }
      }
    },
    g = l,
