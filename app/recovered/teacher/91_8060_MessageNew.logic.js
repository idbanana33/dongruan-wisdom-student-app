...
8060: function(e, t, i) {
  ...
  var s = function() {
      ...
      return i("q-layout", {
      ...
      }), e.menuInfo ? i("q-toolbar-title", [e._v("新建" + e._s(e.menuInfo.title))]) : e._e()], 1)], 1), i("q-page-container", [i("q-page", {
        staticClass: "bg-grey-3"
      }, [e.menuInfo ? e._e() : i("div", {
      ...
      }, [e._v(e._s((e.menuInfo || {}).title) + "通知内容")])], 1)], 1), i("q-separator"), i("q-item", [i("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [i("q-item-label", {
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("名称")])], 1), i("q-item-section", [i("q-input", {
        attrs: {
          outlined: "",
          dense: "",
          "hide-bottom-space": "",
      ...
      })], 1)], 1), i("q-separator"), i("q-item", [i("q-item-section", [i("q-item-label", {
        ...
        staticClass: "q-my-sm"
      }, [e._v("附件")]), i("q-item-label", {
        staticClass: "q-mb-sm",
        attrs: {
          caption: ""
        }
      }, [e._v("附件格式支持：Word、Excel、PowerPoint、PDF")]), 0 == e.isHarmonyOS ? i("q-uploader", {
        staticClass: "full-width",
        attrs: {
          flat: "",
          color: "grey",
        ...
        scopedSlots: e._u([{
          ...
          fn: function(t) {
            return [i("div", {
              ...
              staticClass: "col"
            }, [e._v("附件上传(10M以内)")]), t.canAddFiles ? i("q-btn", {
              attrs: {
                type: "a",
                icon: "add_box",
                round: "",
            ...
            }, [i("q-uploader-add-trigger"), i("q-tooltip", [e._v("选择文件并上传")])], 1) : e._e()], 1)]
          }
        }, {
          key: "list",
          fn: function(t) {
            return [i("q-list", {
              ...
              return i("q-item", {
                ...
                on: {
                  click: function(t) {
                    return e.downloadUploaderFile(s)
                  }
                }
              }, [e._v("\n                            " + e._s(s.name) + "\n                          ")])], 1), i("q-item-section", {
                attrs: {
      ...
      }) : e._e(), 1 == e.isHarmonyOS ? i("q-uploader", {
        staticClass: "full-width",
        attrs: {
          flat: "",
          color: "grey",
        ...
        staticClass: "text-bold"
      }, [e._v("执行频率")])], 1)], 1), i("q-separator"), i("q-item", [i("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [i("q-item-label", {
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v(e._s((e.menuInfo || {}).title) + "频率")])], 1), i("q-item-section", [i("q-item-label", [i("q-select", {
        attrs: {
          dense: "",
          outlined: "",
          "emit-value": "",
      ...
      })], 1)], 1)], 1), i("q-separator"), "S" == e.record.frequency ? i("q-item", [i("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [i("q-item-label", {
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("开始时间")])], 1), i("q-item-section", [i("q-field", {
        staticClass: "full-width",
        staticStyle: {
          width: "200px"
        },
      ...
      })], 1)], 1) : e._e(), "S" == e.record.frequency ? i("q-separator") : e._e(), "S" == e.record.frequency ? i("q-item", [i("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [i("q-item-label", {
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("截止时间")])], 1), i("q-item-section", [i("q-field", {
        staticClass: "full-width",
        staticStyle: {
          width: "200px"
        },
      ...
      })], 1)], 1) : e._e(), "L" == e.record.frequency ? i("q-item", [i("q-item-section", [i("q-item-label", {
        staticClass: "neu-css-before-red-asterisk q-my-sm"
      }, [e._v("循环" + e._s((e.menuInfo || {}).title) + "频率")]), i("q-item-label", e._l([{
        value: "1",
        label: "周一"
      }, {
        value: "2",
      ...
      })), 1)], 1)], 1) : e._e(), "L" == e.record.frequency ? i("q-separator") : e._e(), "L" == e.record.frequency ? i("q-item", [i("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [i("q-item-label", {
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("开始日期")])], 1), i("q-item-section", [i("q-field", {
        staticClass: "full-width",
        attrs: {
          outlined: "",
          dense: "",
      ...
      })], 1)], 1) : e._e(), "L" == e.record.frequency ? i("q-separator") : e._e(), "L" == e.record.frequency ? i("q-item", [i("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [i("q-item-label", {
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("截止日期")])], 1), i("q-item-section", [i("q-field", {
        staticClass: "full-width",
        attrs: {
          outlined: "",
          dense: "",
        ...
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("结束时间")])], 1), i("q-item-section", [i("q-field", {
        staticClass: "full-width",
        attrs: {
          outlined: "",
          dense: "",
      ...
      })], 1)], 1) : e._e(), "A" == e.record.frequency ? i("q-item", [i("q-item-section", {
        attrs: {
          avatar: ""
        }
      }, [i("q-item-label", {
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("开始截止时间")])], 1), i("q-item-section"), i("q-item-section", {
        attrs: {
          side: ""
        }
      }, [i("q-item-label", {
      ...
      }, [e._v("添加")])], 1)], 1) : e._e(), e._l("A" == e.record.frequency ? e.record.appointed_date : [], (function(t, s) {
        return i("q-item", {
          key: t.begin_time
        }, [i("q-item-section", {
          attrs: {
        ...
        }, [i("q-item-label", [e._v("时间段" + e._s(s + 1))])], 1), i("q-item-section", [i("q-item-label", [i("q-field", {
          staticClass: "full-width",
          attrs: {
            outlined: "",
            dense: "",
        ...
        }, [e._v("\n                  删除"), i("q-tooltip", [e._v("删除该时间段")])], 1)], 1)], 1)
      }))], 2)], 1), i("q-card", {
        staticClass: "full-width row q-mt-sm",
        attrs: {
          flat: ""
        ...
        staticClass: "text-bold"
      }, [e._v("通知设定")])], 1)], 1), i("q-separator"), i("q-item", [i("q-item-section", {
        staticClass: "full-width"
      }, [i("q-item-label", {
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v("通知提前推送时间(分)")]), i("div", {
        ...
        staticClass: "neu-css-before-red-asterisk"
      }, [e._v(e._s((e.menuInfo || {}).title) + "对象")])], 1), i("q-item-section"), i("q-item-section", {
        attrs: {
          side: ""
        }
      }, [i("q-item-label", {
      ...
      }, [e._v("已选择 (" + e._s(e.record.task_target.length) + ")")]), i("q-icon", {
        directives: [{
          name: "show",
          rawName: "v-show",
          value: e.record.task_target && 0 != e.record.task_target.length,
      ...
      }, [i("q-item-label", [e._v("无需" + e._s((e.menuInfo || {}).title) + "对象")])], 1), i("q-item-section"), i("q-item-section", {
        attrs: {
          side: ""
        }
      }, [i("q-item-label", {
      ...
      }, [e._v("已选择 (" + e._s(e.record.task_target_excluding.length) + ")")]), i("q-icon", {
        directives: [{
          name: "show",
          rawName: "v-show",
          value: e.record.task_target_excluding && 0 != e.record.task_target_excluding.length,
      ...
      }, [i("q-item-label", [e._v("信息收集")])], 1), i("q-item-section"), i("q-item-section", {
        attrs: {
          side: ""
        }
      }, [i("q-item-label", {
      ...
      })], 1)], 1)], 1), 0 !== e.record.info_config.length ? i("q-item", [i("q-item-section", [i("div", {
        staticClass: "row items-center"
      }, [i("div", {
        staticClass: "col-12 col-md-2 col-sm-3 neu-css-after-colon neu-css-before-red-asterisk",
        class: {
        ...
        return i("div", {
          ...
          directives: [{
            name: "show",
            rawName: "v-show",
            value: s + 1 != e.record.info_config.length,
      ...
      })], 1)])], 1), i("q-page-container", [i("q-page", [i("neu-assign-teacher", {
        model: {
        ...
        staticClass: "text-bold"
      }, [e._v("设置信息收集项目")])]), i("q-card-section", [i("neu-define-widget", {
        on: {
          save: function(t) {
        ...
        staticClass: "text-bold"
      }, [e._v("设置审批人员")])]), i("q-card-section", [e.record.reviewer && e.record.reviewer.length > 0 ? i("neu-assign-teacher", {
        model: {
    ...
    u = {
      ...
      computed: {},
      mounted() {
        window.localStorage.getItem("menu") && (this.menuInfo = JSON.parse(window.localStorage.getItem("menu")).find((e => "message" === e.id))), this.$axiosAction("/api/public.api", {
          ...
          begin_time: "",
          end_time: ""
        }], this.record.attachment = this.record.attachment ? this.record.attachment : [], this.record.loop_frequency = this.record.loop_frequency ? this.record.loop_frequency : [], this.record.task_target = this.record.task_target ? this.record.task_target : [], this.record.task_target_excluding = this.record.task_target_excluding ? this.record.task_target_excluding : [], this.record.info_config = this.record.info_config ? this.record.info_config : [], this.record.reviewer = this.record.reviewer ? this.record.reviewer : [], this.record.composite_id = this.record.composite_id ? this.record.composite_id : null, this.shareDisable = null !== this.record.composite_id) : this.getDepList(1), window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.$route.params && this.$route.params.taskTarget && (this.record.task_target = this.$route.params.taskTarget ? this.$route.params.taskTarget : []), null !== this.cId && void 0 !== this.cId && (void 0 !== this.$route.query.compositeTitle && (this.record.title = this.$route.query.compositeTitle + "-" + this.menuInfo.title), this.shareDisable = !0), this.detectOperatingSystem()
      },
      methods: {
        ...
        checkFile(e) {
          return e.filter((e => {
            ...
            if (!(t > 0)) return this.$showErrorNotify("不支持该类型文件上传"), !1;
            {
              ...
              if (-1 === this.$appConf.fileExts.indexOf(i)) return this.$showErrorNotify("不支持该类型文件上传"), !1
            }
            return !0
          }))
        },
        ...
        deleteReviewer(e) {
          this.reviewerIndex = 0, this.record.reviewer = this.record.reviewer.reduce(((t, i, s) => e === s ? t : t.concat({
            review_level: s + 1,
            teacher: i.teacher
          })), [])
        },
        moveReviewer(e, t) {
          this.reviewerIndex = 0, this.record.reviewer.splice(e + t, 0, this.record.reviewer.splice(e, 1)[0]), this.record.reviewer = this.record.reviewer.reduce(((e, t, i) => e.concat({
            review_level: i + 1,
            teacher: t.teacher
          })), [])
        },
        saveRecord() {
          ...
          if (!this.record.info_config || 0 === this.record.info_config.length) return void this.$showErrorNotify("请设置信息收集项目");
          ...
          e.attachment = e.attachment && e.attachment.length > 0 ? JSON.stringify(e.attachment) : null, e.task_target = JSON.stringify(e.task_target), e.task_target_excluding = e.task_target_excluding && e.task_target_excluding.length > 0 ? JSON.stringify(e.task_target_excluding) : null, e.info_config = e.info_config && e.info_config.length > 0 ? JSON.stringify(e.info_config) : null, e.reviewer = e.reviewer && e.reviewer.length > 0 ? JSON.stringify(e.reviewer) : null, "S" === e.frequency ? (e.loop_frequency = null, e.loop_begin_date = null, e.loop_end_date = null, e.loop_begin_time = null, e.loop_end_time = null, e.appointed_date = null) : "L" === e.frequency ? (e.single_begin_time = null, e.single_end_time = null, e.appointed_date = null, e.loop_frequency = JSON.stringify(e.loop_frequency)) : "A" === e.frequency && (e.single_begin_time = null, e.single_end_time = null, e.loop_frequency = null, e.loop_begin_date = null, e.loop_end_date = null, e.loop_begin_time = null, e.loop_end_time = null, e.appointed_date = JSON.stringify(e.appointed_date)), null !== this.cId && void 0 !== this.cId ? e.composite_id = this.$route.query.compositeId : e.composite_id = this.record.composite_id, this.$axiosAction("/api/teacher/message/message.api", o()({
            action: "insert"
          }, e)).then((e => {
