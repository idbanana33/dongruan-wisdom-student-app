 ...
 * Source: assets/www/js/16.js -> module "b6c5"
 * Route: /maintainer/todo
 * Component guess: StudentTodo
...
b6c5: function(t, e, i) {
  ...
  var a = function() {
      ...
      return i("q-layout", {
      ...
      }), i("q-toolbar-title", [t._v("未读消息")]), i("q-item-label", {
        directives: [{
          name: "show",
          rawName: "v-show",
      ...
      }, [t._v("清除")])], 1)], 1), i("q-page-container", [i("q-page", {
        ...
        }, [t._v("\n                " + t._s(e.days > 1 ? e.push_date : 1 == e.days ? e.days + "天前" : 0 != e.hours ? e.hours + "小时前" : 0 != e.mins ? e.mins + "分钟前" : "刚刚") + "\n              ")])], 1)], 1)], 1)
      })), i("div", {
        directives: [{
          name: "show",
          rawName: "v-show",
    ...
    d = {
      ...
      methods: {
        ...
        loadList(t) {
          t && (this.paging.pageNum = 0, this.list = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/basic/mainInfo.api", {
            action: "getHomeList",
        ...
        goDetail(t, e) {
          e && (this.$axiosAction("/api/push/push.api", {
            action: "updateStatus",
            id: t
          }, "post", !1).then((t => {
            if (0 === t.data.code) {
