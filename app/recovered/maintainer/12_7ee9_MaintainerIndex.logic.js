 ...
 * Component guess: MaintainerIndex
...
"7ee9": function(t, e, a) {
  ...
  var s = function() {
      ...
      return a("q-layout", {
      ...
      }), a("q-toolbar-title", [t._v("智慧学工")]), a("q-btn", {
        attrs: {
          flat: "",
          round: "",
          dense: "",
      ...
      }, [t._v(t._s(t.badgeCount > 99 ? "···" : t.badgeCount))])], 1)], 1)], 1), a("q-drawer", {
        attrs: {
          width: 250,
          overlay: "",
          bordered: "",
      ...
      }, [t._v("您好，" + t._s(t.user.name) + " 维修师")])]), a("q-card", {
        staticClass: "q-ma-sm",
        attrs: {
          flat: ""
        }
      ...
      }, [a("q-item-section", [t._v("账号安全")]), a("q-item-section", {
        attrs: {
          side: ""
        }
      }, [a("q-icon", {
      ...
      }, [t._v("隐私政策")])]), a("div", [t._v(t._s(t.title) + " v" + t._s(t.appVer))])])], 1), a("q-page-container", [a("q-page", {
        staticClass: "bg-grey-3"
      }, [a("q-card", {
        ...
        staticClass: "col-9 q-mt-md"
      }, [a("span", {
        staticClass: "text-weight-bold",
        staticStyle: {
          "font-size": "2em"
        }
      }, [t._v(t._s(t.record.name))])]), a("div", {
        staticClass: "col-3 q-mt-sm row",
        on: {
          click: t.repairList
        }
      }, [a("q-icon", {
      ...
      }, [t._v("报修单")])], 1)]), a("q-card-section", {
        staticClass: "full-width row",
        attrs: {
          avatar: ""
        }
      }, [a("div", {
        staticClass: "col-12 q-mb-sm"
      }, [a("span", {
      ...
      }, [t._v(t._s(t.record.dep_name))])]), a("div", {
      ...
      }, [t._v(t._s(t.record.mob))])])]), a("q-card-section", {
        staticClass: "q-mb-sm"
      })], 1), a("div", {
      ...
      }, [t._v(t._s(t.record.today_order_num) + "单")])]), a("span", {
        staticClass: "text-grey"
      }, [t._v("今日接单")])]), a("div", {
        staticClass: "col-4 text-center"
      }, [a("div", {
      ...
      }, [t._v(t._s(t.record.all_order_num) + "单")])]), a("span", {
        staticClass: "text-grey"
      }, [t._v("完成报修单")])]), a("div", {
        staticClass: "col-4 text-center"
      }, [a("div", {
      ...
      }, [t._v(t._s(t.record.mark_mean_num) + "星")])]), a("span", {
        staticClass: "text-grey"
      }, [t._v("评价星级")])])])], 1)], 1)], 1)], 1)], 1)
    },
    i = [],
    ...
    r = {
      ...
      mounted() {
        window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.loadMaintainerUserInfo(), this.refreshTodoBadge()
      },
      methods: {
        ...
        logout() {
          this.$q.dialog({
            ...
            this.$axiosAction("/api/user/user.api", {
              ...
              this.$addStorageEvent(1, "userinfo", null, !0), JPush.deleteAlias({
                sequence: 1
              }, null, null);
