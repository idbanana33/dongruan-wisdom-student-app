...
"2c02": function(t, a, s) {
  ...
  var e = function() {
      ...
      }), s("q-toolbar-title", [t._v("接单")])], 1)], 1), s("q-page-container", [s("q-page", {
      ...
      }, [t._v("姓名")]), s("span", [t._v(t._s(t.details.name))])]), s("div", {
        staticClass: "full-width q-mt-sm"
      }, [s("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("学号")]), s("span", [t._v(t._s(t.details.student_no))])]), s("div", {
        staticClass: "full-width q-mt-sm"
      }, [s("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("学院")]), s("span", [t._v(t._s(t.details.dep_name))])]), s("div", {
        staticClass: "full-width q-mt-sm"
      }, [s("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("联系电话")]), s("span", [t._v(t._s(t.details.mob))])]), s("div", {
        staticClass: "full-width q-mt-sm"
      }, [s("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("报修时间")]), s("span", [t._v(t._s(t.details.repair_time))])]), s("div", {
        staticClass: "full-width q-mt-sm"
      }, [s("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("报修类型")]), s("span", [t._v(t._s(t.details.repair_type_name))])]), s("div", {
        staticClass: "full-width q-mt-sm"
      }, [s("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("报修区域")]), s("span", [t._v(t._s(t.details.repair_range_name))])]), s("div", {
        staticClass: "full-width q-mt-sm"
      }, [s("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("详细地点")]), s("span", [t._v(t._s(t.details.address))])]), s("div", {
        staticClass: "full-width q-mt-sm"
      }, [s("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("故障类型")]), s("span", [t._v(t._s(t.details.fault_type_name))])]), s("div", {
        staticClass: "full-width q-mt-sm"
      }, [s("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("故障描述")]), s("span", [t._v(t._s(t.details.description))])]), s("div", {
        staticClass: "full-width q-mt-sm"
      }, [s("span", {
        staticClass: "text-grey neu-css-after-colon"
      }, [t._v("期望上门时间")]), s("span", [t._v(t._s(t.details.visit_time))])]), t.details.attachment && 0 != t.details.attachment.length ? s("div", {
      ...
      }, [t._v("接单确认")])]), s("q-separator"), s("q-card-section", [s("span", [t._v("确定要接受当前订单么?")])]), s("q-card-section", [s("div", {
      ...
      methods: {
        ...
        acceptOrder() {
          this.$axiosAction("/api/teacher/basic/maintainer.api", {
            ...
            0 === t.data.code ? (this.$q.loading.hide(), this.acceptOrderDialog = !1, this.$router.push("/maintainer/repairList")) : this.$q.loading.hide()
          }))
        },
        cancel() {
