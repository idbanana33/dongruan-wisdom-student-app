...
"589c": function(e, t, r) {
  ...
  var a = function() {
      ...
      }), r("q-toolbar-title", [e._v("维修")])], 1)], 1), r("q-page-container", [r("q-page", {
      ...
      }, [r("q-card-section", [r("span", {
        staticClass: "neu-css-after-colon text-bold neu-css-before-white-space"
      }, [e._v("报修单号")]), e._v(e._s(e.record.order) + "\n          ")]), r("q-card-section", [r("span", {
        staticClass: "neu-css-after-colon text-bold neu-css-before-red-asterisk"
      }, [e._v("故障类型")]), r("q-select", {
        attrs: {
          "emit-value": "",
          "map-options": "",
          outlined: "",
      ...
      })], 1), r("q-card-section", [r("div", {
        staticClass: "text-bold neu-css-after-colon neu-css-before-red-asterisk q-mb-sm"
      }, [e._v("维修描述")]), r("q-input", {
        attrs: {
          dense: "",
          outlined: "",
            ...
            return [0 == e.isHarmonyOS ? r("q-uploader", {
              ...
              scopedSlots: e._u([{
                ...
                fn: function(t) {
                  ...
                  })), e._l(e.matchingUploadedFiles(e.record.repair_attachments, t.files), (function(t) {
                    return r("q-item", {
                      key: t.servername
                    }, [r("q-item-section", [r("q-item-label", {
                      staticClass: "full-width ellipsis cursor-pointer"
    ...
    o = {
      ...
      mounted() {
        this.user = JSON.parse(localStorage.getItem("userinfo")), window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.getInfo(), this.getSelectList(), this.detectOperatingSystem()
      },
      methods: {
        ...
        afterUploaded(e) {
          ...
          t.error ? this.$showErrorNotify(t.error) : this.record.repair_attachments ? this.record.repair_attachments.push(t) : this.record.repair_attachments = [t]
        },
        afterRemoved(e) {
          for (const t of e) {
        ...
        matchingUploadedFiles(e, t) {
          return (e || []).reduce(((e, r) => t && t.length > 0 ? 0 === t.reduce(((e, t) => {
            if (t.xhr.response) {
        ...
        onSubmit() {
          null !== this.record.repair_attachments && this.record.repair_attachments.length > 3 ? this.$showErrorNotify("最多可上传3个文件") : (null !== this.record.repair_attachments && 0 !== this.record.repair_attachments.length ? this.record.repair_attachments = JSON.stringify(this.record.repair_attachments) : this.record.repair_attachments = null, this.$axiosAction("/api/teacher/basic/maintainer.api", n()({
            action: "updateMaintainerRepairOrderInfo"
          }, this.record)).then((e => {
            0 === e.data.code ? (this.$q.loading.hide(), this.$router.push("/maintainer/repairList")) : this.$q.loading.hide()
          })))
        },
        goBack() {
