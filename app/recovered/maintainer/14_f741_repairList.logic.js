...
f741: function(t, e, a) {
  ...
  var s = function() {
      ...
      return a("q-layout", {
      ...
      }, [t._v("报修单列表")])], 1)], 1), a("q-page-container", [a("q-page", {
        staticClass: "bg-grey-3"
      }, [a("q-card-section", [a("q-tabs", {
        attrs: {
          dense: "",
          align: "justify",
        ...
        return a("q-card", {
          ...
          staticClass: "text-bold"
        }, [t._v(t._s(e.repair_time))]), a("q-chip", {
          staticStyle: {
            "max-width": "40%"
          },
          attrs: {
        ...
        }, [t._v(t._s(e.repair_type_name))])]), a("q-chip", {
          attrs: {
            square: "",
            color: "grey-4",
            "text-color": "black",
        ...
        }, [t._v("\n                  " + t._s(e.statusinfo) + "\n                ")])], 1), a("q-item-label", [a("span", {
          staticClass: "neu-css-after-colon text-bold"
        }, [t._v("报修单号")]), t._v(t._s(e.order) + "\n              ")]), a("q-item-label", [a("span", {
          staticClass: "neu-css-after-colon text-bold"
        }, [t._v("期望上门时间")]), t._v(t._s(e.visit_time) + "\n              ")]), a("q-item-label", [a("span", {
          staticClass: "neu-css-after-colon text-bold"
        }, [t._v("已分配")]), t._v(t._s(e.maintainer_name) + "\n              ")]), "3" == e.status ? a("q-item-label", [a("span", {
          staticClass: "neu-css-after-colon text-bold"
        }, [t._v("改派人员")]), t._v(t._s(e.reassignment_maintainer_name) + "\n              ")]) : t._e(), "3" == e.status ? a("q-item-label", [a("span", {
          staticClass: "neu-css-after-colon text-bold"
        }, [t._v("改派原因")]), t._v(t._s(e.reason) + "\n              ")]) : t._e(), "2" == e.status || "4" == e.status || "5" == e.status ? a("q-item-label", [a("span", {
          staticClass: "neu-css-after-colon text-bold"
        }, [t._v("接单时间")]), t._v(t._s(e.order_receiving_time) + "\n              ")]) : t._e(), "4" == e.status || "5" == e.status ? a("q-item-label", [a("span", {
          staticClass: "neu-css-after-colon text-bold"
        }, [t._v("维修完成时间")]), t._v(t._s(e.completion_time) + "\n              ")]) : t._e(), a("q-item-label", [a("q-btn", {
        ...
        directives: [{
          name: "show",
          rawName: "v-show",
          value: !t.isLoading && t.paging.pageCount == t.paging.pageNum && 0 != t.repair.length,
          expression: "!isLoading && paging.pageCount == paging.pageNum && repair.length != 0"
        }],
        staticClass: "text-center text-grey q-pt-sm q-pb-md"
      }, [t._v("\n          没有更多了\n        ")]), a("div", {
        directives: [{
    ...
    o = {
      ...
      mounted() {
        this.getRepairStatusList(), this.loadRepairList((() => {})), window.history && window.history.pushState && (history.pushState(null, null, document.URL), window.addEventListener("popstate", this.goBack, !1)), this.getSelectList()
      },
      methods: {
        getRepairStatusList() {
        ...
        loadRepairList(t) {
          t && (this.paging.pageNum = 0, this.repair = []), this.paging.pageNum += 1, this.isLoading = !0, this.$axiosAction("/api/teacher/basic/maintainer.api", {
        ...
        submitReassignment() {
          "" !== this.record.maintainer_no ? "" !== this.record.reason ? this.$axiosAction("/api/teacher/basic/maintainer.api", r()({
            action: "applyForReassignment",
            id: this.repairId
          }, this.record)).then((t => {
            0 === t.data.code ? (this.$q.loading.hide(), this.loadRepairList((() => {})), this.applyForReassignmentDialog = !1) : this.$q.loading.hide()
          })) : this.$showErrorNotify("请填写改派原因") : this.$showErrorNotify("请选择改派人员")
        },
        cancel() {
          this.applyForReassignmentDialog = !1, this.record.reason = "", this.record.maintainer_no = ""
        },
        setDefaultList() {
          this.repair = [], this.paging = {
            pageSize: 30,
            pageNum: 0,
            pageCount: 0
          }
