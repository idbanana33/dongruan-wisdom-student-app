  ...
  mounted() {
    ((window.localStorage.editorToolBar = JSON.stringify([
      ...
      [
        ...
        { label: "标题", list: "no-icons", options: ["p", "h1", "h2", "h3", "h4", "h5", "h6"] },
      ],
      [
        { label: "对齐方式", options: ["left", "center", "right", "justify"] },
        { label: "排版", options: ["quote", "unordered", "ordered", "outdent", "indent"] },
      ],
      [{ label: "操作", options: ["removeFormat", "undo", "redo"] }, "fullscreen"],
    ])),
