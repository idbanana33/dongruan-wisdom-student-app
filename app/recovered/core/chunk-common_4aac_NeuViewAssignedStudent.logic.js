 ...
 * Route: (shared/core)
 * Component guess: NeuViewAssignedStudent
...
"4aac": function(e, t, i) {
  ...
  var a = function() {
      ...
      return i("q-list", {
        ...
        }, [i("q-item-section", [i("q-item-label", [e._v(e._s(t.target_name)), "class" != t.target_level ? i("span", [e._v(" - " + e._s(t.grade_name))]) : e._e()]), i("q-item-label", {
          attrs: {
            caption: ""
          }
        }, [i("span", {
        ...
        }, [e._v(" " + e._s(t.education_level_name))])])], 1)], 1)
        ...
        return i("q-item", {
          key: t.target_level + t.target_no
        }, [i("q-item-section", [i("q-item-label", [e._v(e._s(t.target_name))])], 1)], 1)
      })), i("q-item", {
        directives: [{
          name: "show",
          rawName: "v-show",
  ...
  var n = {
      ...
      computed: {
        ...
        groupData() {
          return this.hideFlag ? [] : this.assignedData.reduce(((e, t) => "group" === t.target_level ? e.concat(t) : e), [])
        }
      },
      methods: {}
    },
