...
"92db": function(e, t, i) {
  ...
  var a = function() {
      var e = this,
        t = e.$createElement,
        i = e._self._c || t;
      return i("div", e._l(e.list, (function(t, a) {
        return i("q-card", {
          key: a,
        ...
        }, [e._v(e._s(t.class_name))]), i("q-item-label", {
          directives: [{
            name: "show",
            rawName: "v-show",
        ...
        }, [e._v(e._s(t.major_name))]), i("q-item-label", {
          directives: [{
            name: "show",
            rawName: "v-show",
        ...
        }, [e._v(e._s(t.name) + "(" + e._s(t.tea_no) + ")")]), i("q-item-label", {
          staticClass: "row justify-between",
          attrs: {
            lines: "1",
            caption: ""
          }
        }, [e._v("\n          应阅读人数：" + e._s(t.feedback_total) + "\n          "), i("span", [e._v("已阅读人数：" + e._s(t.feedback_count))]), i("span", [e._v(" 未阅读人数：" + e._s(t.no_feedback_total))])]), i("q-item-label", {
          directives: [{
            name: "show",
            rawName: "v-show",
        ...
        }, [e._v("\n          应确认人数：" + e._s(t.confirm_total) + "\n          "), i("span", [e._v("已确认人数：" + e._s(t.confirm_count))]), i("span", [e._v(" 未确认人数：" + e._s(t.no_confirm_total))])])], 1)], 1)], 1)
      })), 1)
    },
    s = [],
    l = {
      ...
      methods: {
        loadList() {
          this.id && this.title && this.$axiosAction("/api/teacher/notice/notice.api", {
