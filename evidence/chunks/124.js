                          ...
                          a(
                            ...
                            [
                              a(
                                "q-item",
                                [
                                  a("q-item-section", { attrs: { avatar: "" } }, [s._v("原密码")]),
                                  a(
                                    "q-item-section",
                                    [
                                      a("q-input", {
                              ...
                              a(
                                "q-item",
                                [
                                  a("q-item-section", { attrs: { avatar: "" } }, [s._v("新密码")]),
                                  a(
                                    "q-item-section",
                                    [
                                      a("q-input", {
        ...
        i = {
          ...
          methods: {
            checkPwd(t) {
              ...
              return (
                !!s.test(t) ||
                "密码中必须包含大小写字母、数字、特殊字符，至少8个字符，最多30个字符。"
              );
            },
            validConfirmPwd() {
