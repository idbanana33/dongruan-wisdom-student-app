                ...
                [
                  a(
                    ...
                    [
                      ...
                      t.menuInfo ? a("q-toolbar-title", [t._v(t._s(t.menuInfo.title))]) : t._e(),
                      a(
                        "span",
                        {
                          directives: [
              ...
              a(
                ...
                [
                  a(
                    ...
                    [
                      "doing" == t.tab ? a("neu-apply-form") : t._e(),
                      "history" == t.tab ? a("neu-apply-history") : t._e(),
                    ],
                    1,
                  ),
                ],
                ...
                ? a(
                    ...
                    [
                      a(
                        ...
                        [
                          a("q-tab", { attrs: { name: "doing", label: "正在进行" } }),
                          a("q-separator", { attrs: { vertical: "" } }),
                          a("q-tab", { attrs: { name: "history", label: "历史" } }),
                        ],
                        1,
                      ),
                    ],
                        ...
                        a(
                          ...
                          [
                            a(
                              ...
                              { staticClass: "q-mb-xs" },
                              [
                                a("span", { staticClass: "text-bold" }, [t._v(t._s(e.title))]),
                                a("q-icon", {
                                  directives: [
                                    {
                                      name: "show",
                            ...
                            a("q-item-label", { staticClass: "q-mb-xs" }, [
                              a(
                                "span",
                                {
          ...
          methods: {
            ...
            goDetail(t, e) {
              this.$router.push({
                ...
                query: { id: t, apply_type: this.apply_type, batch_no: e, tab: "history" },
              });
            },
          },
        },
        ...
        L = {
          ...
          methods: {
            ...
            goDetail(t, e) {
              this.$router.push({
                name: "/student/apply/applyDetail",
                query: { id: t, apply_type: this.apply_type, batch_no: e },
              });
            },
          },
        },
