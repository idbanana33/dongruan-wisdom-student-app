    ...
    a0ab: function (t, e, i) {
      ...
      var a = function () {
                ...
                [
                  i(
                    ...
                    [
                      ...
                      "progress" == t.tab && 1 == t.checkBatchNo
                        ? i(
                            "q-btn",
                            {
                      ...
                      i(
                        ...
                        [
                            ...
                            ? i(
                                ...
                                [
                                  i(
                                    "q-item-section",
                                    { attrs: { avatar: "" } },
                                    [i("q-icon", { attrs: { name: "bubble_chart", size: "sm" } })],
                                    1,
                                  ),
                                  i(
                                    "q-item-section",
                          ...
                          "L" == t.record.signin_method
                            ? i(
                                ...
                                [
                                  ...
                                  i(
                                    ...
                                    {
                                      staticStyle: { "font-size": "1.1rem" },
                                      on: { click: t.exportStatisticsData },
                                    },
                                    [t._v("导出位置分布数据")],
                                  ),
                                ],
                            ...
                            : t._e(),
                          "statistics" == t.tab && 1 == t.checkBatchNo
                            ? i(
                                "q-item",
                                {
                                  directives: [{ name: "ripple", rawName: "v-ripple" }],
                            ...
                            "q-item",
                            {
                              directives: [
                                { name: "ripple", rawName: "v-ripple" },
                                {
                                  ...
                                  expression:
                                    "tab == 'progress' && time != '0' && record.is_author",
                                },
                              ],
                              attrs: { clickable: "" },
                            },
                            ...
                            [
                              ...
                              i(
                                "q-item-section",
                                {
                                  staticClass: "text-primary",
                                  staticStyle: { "font-size": "1.1rem" },
                                  on: { click: t.sendSigninSmsRemind },
                                },
                                [t._v("未签到提醒(短信提醒)")],
                              ),
                            ],
                          ...
                          i(
                            "q-item",
                            {
                              directives: [
                                { name: "ripple", rawName: "v-ripple" },
                                {
                                  ...
                                  value:
                                    (t.record.tea_show &&
                                      "定位" != t.record.signin_method_name &&
                                      "progress" == t.tab) ||
                                    (t.record.teacher_no == t.loginName &&
                                      "定位" != t.record.signin_method_name &&
                                      "progress" == t.tab),
                                  expression:
                                    "(record.tea_show && record.signin_method_name != '定位' && tab == 'progress') || (record.teacher_no == loginName && record.signin_method_name != '定位' && tab == 'progress')",
                                },
                              ],
                              attrs: { clickable: "" },
                            },
                            [
                              i(
                                "q-item-section",
                                { attrs: { avatar: "" } },
                                [i("q-icon", { attrs: { name: "mdi-qrcode", size: "sm" } })],
                                1,
                              ),
                              i(
                                "q-item-section",
              ...
              i(
                ...
                [
                  i(
                    ...
                    [
                      "progress" == t.tab || "statistics" == t.tab
                        ? i(
                            "q-card",
                            { attrs: { flat: "" } },
                            [
                              t.batchNoList && 0 != t.batchNoList.length
                                ? i(
                                    "q-item",
                                    { attrs: { clickable: "" }, on: { click: t.changeSigninTime } },
                                    [
                                      i(
                                        "q-item-section",
                                        [
                                          i("q-item-label", [
                                            i("div", { staticClass: "text-grey" }, [
                                              t._v("\n                签到时间段\n              "),
                                            ]),
                                          ]),
                                          i("q-item-label", { staticClass: "q-mb-sm" }, [
                                            t._v(
                                              "\n              " +
                                                t._s(t.batchLabel) +
                                                "\n            ",
                                          ...
                                          t.initDetail.total && "progress" == t.tab
                                            ? i("q-item-label", [
                                                i("div", { staticClass: "text-grey" }, [
                                                  t._v("\n                本次签到率 "),
                                                  i("span", { staticClass: "text-black" }, [
                                                    t._v(
                                                      t._s(t.initDetail.signined_ratio) +
                                                        "% (" +
                                                        t._s(t.initDetail.signin_total) +
                                                        "/" +
                                                        t._s(
                                                          t.initDetail.total -
                                                            t.initDetail.leave_total,
                                                        ) +
                                                        ")",
                                                    ),
                                                  ]),
                                                ]),
                                                i("div", { staticClass: "text-grey q-mt-sm" }, [
                                                  t._v("\n                本次请假率 "),
                                                  i("span", { staticClass: "text-black" }, [
                                                    t._v(
                                                      t._s(t.initDetail.leaved_ratio) +
                                                        "% (" +
                                                        t._s(t.initDetail.leave_total) +
                                                        "/" +
                                                        t._s(t.initDetail.total) +
                                                        ")",
                                                    ),
                                                  ]),
                                                ]),
                                      ...
                                      "单次" != t.record.frequency_name
                                        ? i(
                                            "q-item-section",
                                            { attrs: { side: "", top: "" } },
                                            [i("q-icon", { attrs: { name: "arrow_drop_down" } })],
                                            1,
                                          )
                                        : t._e(),
                                    ],
                                  ...
                                  [
                                        ...
                                        i(
                                          ...
                                          [
                                            i(
                                              ...
                                              [t._v("签到" + t._s(e.location_status))],
                                            ),
                                          ],
                                        ),
                                        i(
                                    ...
                                    i(
                                      "q-item-section",
                                      {
                                        ...
                                        on: {
                                          click: function (i) {
                                            (t.record.is_author || t.record.tea_show) &&
                                              t.changeStatus(e.id, e.signin_status);
                                          },
                                        },
                                      },
                                      [
                              ...
                              directives: [
                                {
                                  ...
                                  value:
                                    ...
                                    0 != t.initList.length,
                                  expression:
                                    "!isLoading && paging.pageCount == paging.pageNum && initList.length != 0",
                                },
                              ],
                              staticClass: "text-center text-grey q-pt-sm q-pb-md",
                            },
                                                  ...
                                                  return i(
                                                    "q-btn",
                                                    {
                                                      ...
                                                      attrs: {
                                                        outline: "",
                                                        color:
                                                          e.value == t.queryModel.signin_status
                                                            ? "primary"
                                                            : "grey",
                                                      },
                                                      on: {
                                                  ...
                                                  return i(
                                                    "q-btn",
                                                    {
                                                      ...
                                                      attrs: {
                                                        outline: "",
                                                        color:
                                                          e.value == t.queryModel.location_status
                                                            ? "primary"
                                                            : "grey",
                                                      },
                                                      on: {
                  ...
                  i(
                    ...
                    [
                      i(
                        ...
                        { staticClass: "row items-center justify-between" },
                        [
                          i("div", { staticClass: "text-bold" }, [t._v("签到时间段选择")]),
                          i("q-btn", {
                      ...
                      i("q-separator"),
                      t._l(t.batchNoList, function (e, a) {
                        return i(
                          "q-list",
                          { key: e.value },
                          [
                  ...
                  i(
                    ...
                    [
                      i(
                        ...
                        { staticClass: "row items-center justify-between" },
                        [
                          i("div", { staticClass: "text-bold" }, [t._v("二维码展示")]),
                          i("q-btn", {
                            directives: [{ name: "close-popup", rawName: "v-close-popup" }],
                            attrs: { icon: "close", flat: "", round: "", dense: "", size: "sm" },
                          }),
                  ...
                  i(
                    ...
                    [
                      i("q-card-section", { staticClass: "flex flex-center" }, [
                        i("div", { staticClass: "text-weight-bold" }, [t._v("变更状态")]),
                      ]),
                      i("q-card-section", [
                        i("div", { staticClass: "neu-css-after-colon" }, [
                          t._v("\n          变更为\n        "),
                        ]),
                        i(
                          "div",
                      ...
                      i(
                        "q-card-section",
                        [
                          i("div", { staticClass: "neu-css-after-colon full-width" }, [
                            t._v("\n          变更说明\n        "),
                          ]),
                          i("q-input", {
                            staticStyle: { "min-width": "250px" },
                            attrs: { outlined: "", type: "textarea", placeholder: "变更说明选填" },
                            model: {
                              value: t.texterea,
                              callback: function (e) {
                                t.texterea = e;
                  ...
                  i(
                    ...
                    [
                      i(
                        ...
                        { staticClass: "row items-center justify-between" },
                        [
                          i("div", { staticClass: "text-bold" }, [t._v("变更记录详情")]),
                          i("q-btn", {
                            directives: [{ name: "close-popup", rawName: "v-close-popup" }],
                            attrs: { icon: "close", flat: "", round: "", dense: "", size: "sm" },
                          }),
                      ...
                      i(
                        "q-card-section",
                        t._l(t.modList, function (e) {
                          return i(
                            "q-list",
                            { key: e.id, staticClass: "q-mt-sm", attrs: { bordered: "" } },
                            [
                              i(
                                "q-item",
                                [
                                  i("q-item-section", [
                                    i("div", { staticClass: "row q-mt-xs" }, [
                                      i(
                                        "span",
                                        {
                                      ...
                                      i(
                                        ...
                                        {
                                          class:
                                            "未签到" == e.status ? "text-red" : "text-positive",
                                        },
                                        [t._v(t._s(e.status))],
                                      ),
                                    ]),
                  ...
                  i(
                    ...
                    [
                      i(
                        ...
                        { staticClass: "row items-center justify-between" },
                        [
                          i("div", { staticClass: "text-bold" }, [t._v("上传的照片")]),
                          i("q-btn", {
                            directives: [{ name: "close-popup", rawName: "v-close-popup" }],
                            attrs: { icon: "close", flat: "", round: "", dense: "", size: "sm" },
                          }),
                      ...
                      i(
                        "q-card-section",
                        { staticClass: "text-center" },
                        [i("q-img", { attrs: { src: t.baseUrl + t.link, ratio: 1 } })],
                        1,
                      ),
                    ],
                    1,
                    ...
                    [
                      ...
                      i(
                        ...
                        [
                          i(
                            "q-item-section",
                            [i("q-item-label", [t._v("请至少选择一个时间段!")])],
                            1,
                          ),
                        ],
                        1,
              ...
              i(
                ...
                [
                  i("neu-location-analysis-map", {
                    attrs: { statisticsData: t.statisticsData, clusterData: t.clusterData },
                  }),
                ],
                1,
              ),
              i(
                ...
                [
                  i(
                    ...
                    [
                      i("q-tab", { attrs: { name: "progress", label: "签到进度" } }),
                      i("q-separator", { attrs: { vertical: "" } }),
                      i("q-tab", { attrs: { name: "statistics", label: "签到统计" } }),
                      i("q-separator", { attrs: { vertical: "" } }),
                      ...
                      i(
                        ...
                        [
                          ...
                          i(
                            ...
                            [t._v(t._s(e.name) + "(" + t._s(e.tea_no) + ")")],
                          ),
                          i(
                            "q-item-label",
                            {
                            ...
                            [
                              ...
                              i("span", [t._v("已请假人数：" + t._s(e.leaved_total))]),
                            ],
                          ),
                          i(
                            "q-item-label",
                            ...
                            [
                              t._v(
                                "\n          已签到人数：" +
                                  t._s(e.signined_total) +
                                  "\n          ",
                              ),
                              i("span", [t._v("未签到人数：" + t._s(e.unsignin_total))]),
                            ],
                          ),
                        ],
                        1,
        ...
        g = {
          ...
          mounted() {
            ((this.signinId = this.id),
              (this.signinTitle = this.title),
              (this.batchNo = this.batch_no),
              (this.signinStatistics = this.signin_statistics),
              this.loadSigninList());
          },
          watch: {
            id(t) {
          ...
          methods: {
            loadSigninList() {
              if (!this.signinId || !this.signinTitle || !this.batchNo || !this.signinStatistics)
                return;
              let t = "";
              ((t = !0 === this.tea_show ? 1 : 0),
          ...
          methods: {
            ...
            getData() {
              this.$axiosAction("/api/teacher/signin/signin.api", {
                ...
                .then((t) => {
                  0 === t.data.code
                    ? ((this.record = t.data.result), this.changeBatchNo())
                    : this.goBack();
                })
                .catch((t) => {
                  this.record = {};
            ...
            goBack() {
              null !== this.cId && void 0 !== this.cId
                ? this.$router.push(
                    `/teacher/signin/statistics?id=${this.id}&compositeId=${this.cId}`,
                  )
            ...
            sendSigninSmsRemind() {
              this.$q.loading.show();
              const t = JSON.parse(window.localStorage.getItem("menu")).find(
                (t) => "signin" === t.id,
              );
              this.$axiosAction("/api/teacher/signin/signin.api", {
            ...
            showPic(t, e) {
              ((this.bigPicUrl = t[0].link),
                (this.bigPicName = t[0].srcname),
                (this.showBigPic = !0));
            },
          },
        },
      ...
      (w()(st, "components", {
        ...
        w()(st, "directives", { Ripple: it["a"], ClosePopup: at["a"] }));
    },
  },
]);
