                      ...
                      i(
                        ...
                        [
                          i(
                            ...
                            [
                              i("q-card-section", { staticClass: "text-center" }, [
                                i("h5", [e._v(e._s(e.news.title))]),
                              ]),
                              i("q-card-section", { staticClass: "text-right text-grey" }, [
                                i("div", [e._v("发布者：" + e._s(e.news.name))]),
                                i("div", [e._v("发布时间：" + e._s(e.news.create_time))]),
                                null !== e.news.dep_name
                                  ? i("div", [e._v("发布单位：" + e._s(e.news.dep_name))])
                                  : e._e(),
                              ]),
                              i(
                                "q-card-section",
                                [
                                  "" !== e.news.detail && null !== e.news.detail
                                    ? i("q-editor", {
                                        attrs: {
                                          flat: "",
                                          "min-height": "10em",
                              ...
                              i("q-card-section", { staticClass: "text-right" }, [
                                i("span", { staticClass: "text-grey" }, [
                                  e._v("阅读量：" + e._s(e.count)),
                                ]),
                              ]),
                            ],
                            1,
          ...
          mounted() {
            ((this.id = this.$route.query.id),
              ...
              this.$axiosAction("/api/teacher/news/news.api", {
                ...
                .then((e) => {
                  0 === e.data.code ||
                    (2001 === e.data.code && this.$router.push("/student/news/index"));
                })
                .catch((e) => {
            ...
            getDetailInfo() {
              (this.$q.loading.show(),
                this.$axiosAction("/api/teacher/news/news.api", {
                  ...
                  .then((e) => {
                    (0 === e.data.code &&
                      ((this.news = e.data.result.list[0]), (this.count = e.data.count.count)),
                      this.$q.loading.hide());
                  })
                  .catch((e) => {
