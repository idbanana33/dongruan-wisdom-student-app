  ...
  [106],
  {
    "3b5c": function (t, e, a) {
                          ...
                          i("q-card-section", [
                            i("div", { staticClass: "row" }, [
                              i("div", [
                                ...
                                e._v(e._s(e.sanitation.teacher_name) + "\n              "),
                              ]),
                              ...
                              i("div", [
                                ...
                                e._v(e._s(e.sanitation.create_time) + "\n              "),
                              ]),
                              i("div", [
                                i("span", { staticClass: "text-grey neu-css-after-colon" }, [
                                  e._v("填写有效时间"),
                                ...
                                e._v(
                                  e._s(e.sanitation.begin_date) +
                                    " ~ " +
                                    e._s(e.sanitation.end_date) +
                                    "\n              ",
                                ),
                              ]),
                            ]),
                          ...
                          i("q-card-section", [
                            i(
                              ...
                              [
                                e._v(
                                  "\n                " +
                                    e._s(1 == e.sanitation.status ? "延期" : "重新开启") +
                                    "截止日期至：\n                ",
                                ),
                                i("q-field", {
                                  ...
                                  attrs: {
                                    ...
                                    rules: [
                                      ...
                                      function (e) {
                                        return (
                                          e >= t.sanitation.end_date || "请填写原截止日期之后的日期"
                                        );
                                      },
                                    ],
                                    value: e.endDate,
                  ...
                  i(
                    ...
                    [
                      i(
                        ...
                        [
                          i("div", { staticClass: "text-h6" }, [e._v("预览")]),
                          i("q-btn", {
                            directives: [{ name: "close-popup", rawName: "v-close-popup" }],
                      ...
                      i("q-card-section", [
                        ...
                        i("div", {
                          staticClass: "q-mt-sm",
                          domProps: { innerHTML: e._s(e.sanitation.detail) },
                        }),
                      ]),
                      i("q-separator"),
                      i("q-card-section", [
                        i("div", [
                          ...
                          e._v(
                            e._s(1 === e.sanitation.allow_delete ? "是" : "否") + "\n            ",
                          ),
                          i(
                            "div",
                            { staticStyle: { float: "right", "margin-top": "-7px" } },
                            [
                              e.sanitation.is_author
                                ? i("q-toggle", {
                                    staticClass: "q-pa-sm",
                                    attrs: {
                                      size: "lg",
                      ...
                      i(
                        ...
                        [
                          i("div", [
                            ...
                            e.sanitation.is_author && null !== e.menuInfo.edit_permit
                              ? i(
                                  "div",
                                  ...
                                  [
                                    i(
                                      "span",
                                      {
                                        ...
                                        on: { click: e.taskTargetDialogOpen },
                                      },
                                      [e._v("选择")],
                                    ),
                                    i("q-icon", {
                          ...
                          i("neu-view-assigned-teacher", {
                            attrs: { value: e.sanitation.task_target },
                          }),
                        ],
                        1,
                      ),
                      ...
                      i(
                        ...
                        [
                          ...
                          i("neu-view-assigned-teacher", {
                            attrs: { value: e.sanitation.share_target },
                          }),
                        ],
                        1,
                      ),
                      ...
                      i(
                        ...
                        [
                          ...
                          e._l(e.sanitation.info_config, function (t, a) {
                            return i(
                              "div",
                      ...
                      i(
                        ...
                        [
                          ...
                          e._l(e.sanitation.stu_info_config, function (t, a) {
                            return i(
                              "div",
                              { key: a, staticClass: "bg-grey-2 q-pa-sm q-mt-sm" },
                              [
                  ...
                  i(
                    ...
                    [
                      i(
                        ...
                        [
                          i("div", { staticClass: "text-bold" }, [e._v("修改共享对象")]),
                          i("q-btn", {
                            attrs: { unelevated: "", color: "primary", label: "完成" },
                            on: { click: e.updateShareTarget },
                          }),
                        ],
                        1,
                      ),
                    ...
                    [
                      i(
                        ...
                        [
                          ...
                          1 == e.sanitation.status && e.sanitation.is_author
                            ? i(
                                "q-item",
                                {
                                  directives: [{ name: "ripple", rawName: "v-ripple" }],
                                  attrs: { clickable: "" },
                                  on: { click: e.terminateSanitation },
                                },
                                [
                                  i(
                                    "q-item-section",
                          ...
                          e.sanitation.is_author
                            ...
                            : e._e(),
                          0 == e.sanitation.status && e.sanitation.is_author
                            ? i(
                                "q-item",
                                {
                                  directives: [{ name: "ripple", rawName: "v-ripple" }],
                            ...
                            : e._e(),
                          e.sanitation.is_author || "A" == e.roleId
                            ? i(
                                "q-item",
                                {
                                  directives: [{ name: "ripple", rawName: "v-ripple" }],
                                  attrs: { clickable: "" },
                                  on: { click: e.deleteSanitation },
                                },
                                [
                                  i(
                                    "q-item-section",
                    ...
                    t.reduce((t, e) => {
                      ...
                      if (this.sanitation.info_config !== [])
                        for (let i = 0; i < this.sanitation.info_config.length; i++)
                          a[(i + 1).toString() + "." + this.sanitation.info_config[i].label] =
                            e.info_result
            ...
            updateActionTarget() {
              (this.$q.loading.show(),
                this.$axiosAction("/api/teacher/sanitation/sanitation.api", {
                  ...
                  .then((t) => {
                    (0 === t.data.code &&
                      ((this.sanitation.task_target = this.actionTarget),
                      (this.taskTargetDialog = !1)),
                      this.$q.loading.hide());
                  })
                  .catch((t) => {
                    this.$q.loading.hide();
      ...
      (U()(G, "components", {
        ...
        U()(G, "directives", { ClosePopup: Y["a"], Ripple: H["a"], TouchPan: V["a"] }));
    },
  },
]);
