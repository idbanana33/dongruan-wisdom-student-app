      ...
      var a = function () {
                              ...
                              s(
                                ...
                                [
                                  ...
                                  s(
                                    "q-item",
                                    [
                                      s("q-item-section", { staticClass: "text-grey" }, [
                                        t._v(
                                          "\n              若未绑定手机号或长时间接收不到验证码，请联系管理员（教师用户）或" +
        ...
        n = {
          ...
          methods: {
            ...
            nextStep(t) {
              if (2 === t && !this.login_name)
                return (this.$showErrorNotify("请输入学号/教工号"), !1);
              this.step = t;
            },
            handleNextStep(t) {
            ...
            validConfirmPwd() {
              return (
                this.newpassword === this.password2 ||
                (this.$showErrorNotify("两次密码输入不一致"), !1)
              );
            },
            resetPwd() {
              this.checkPwd() &&
