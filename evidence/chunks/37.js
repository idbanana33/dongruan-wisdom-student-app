                    ...
                    [
                      s(
                        ...
                        [
                          ...
                          s("q-card-section", { staticClass: "full-width row" }, [
                            s("div", { staticClass: "text-left" }, [
                            ...
                            s(
                              ...
                              [
                                s("span", { staticClass: "text-grey" }, [e._v("申请学生：")]),
                                s("span", [
                                  e._v(
                              ...
                              s(
                                ...
                                [
                                  ...
                                  1 == e.record.out_campus
                                    ...
                                    : e._e(),
                                  e._l(e.record.info_config, function (t, o) {
                                    return s(
                                      "div",
                                      { key: o, staticClass: "col-12" },
                                      [
                                        s("neu-widget", {
                                  ...
                                  s(
                                      ...
                                      directives: [
                                        {
                                          ...
                                          expression:
                                            "!deleteShow && !(record.contact == '' || record.contact == null)",
                                        },
                                      ],
                                      staticClass: "col-12",
                                      staticStyle: { "margin-top": "4px" },
                                    ...
                                    [
                                      ...
                                      s("span", [
                                        e._v(
                                          e._s(
                                            "" == e.record.contact ? "未填写" : e.record.contact,
                                          ),
                                        ),
                                      ]),
                                    ],
                                      ...
                                      directives: [
                                        {
                                          ...
                                          expression:
                                            "record.process_need_locate == 1 && deleteShow",
                                        },
                                      ],
                                      staticClass: "col-12",
                                      staticStyle: { "margin-top": "4px" },
                          ...
                          s(
                            ...
                            [
                              s("q-btn", {
                                ...
                                attrs: { color: "primary", label: "保存", type: "submit" },
                              }),
                            ],
                            1,
                          ),
                                  ...
                                  [
                                    s(
                                      ...
                                      [
                                        ...
                                        "W" == e.record.review_status && e.nextTeacher.length > 0
                                          ? s(
                                              "q-timeline-entry",
                                              {
                                                attrs: {
              ...
              this.$axiosAction("/api/teacher/process/process.api", {
                ...
                .then((e) => {
                  (0 === e.data.code && (this.record = e.data.result.list[0]),
                    ...
                    void 0 === this.review_list[0] &&
                      ((this.deleteShow = !0), (this.viewMode = !1)));
                })
                .catch((e) => {
                  this.record = {};
                });
