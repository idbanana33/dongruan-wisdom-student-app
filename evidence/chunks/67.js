  ...
  [67],
  {
    d03a: function (e, t, a) {
                ...
                [
                  s(
                    ...
                    [
                      ...
                      s("q-toolbar-title", [t._v(t._s(this.taskTitle))]),
                      s("q-btn", {
                              ...
                              s(
                                ...
                                [
                                  ...
                                  s("q-item-label", { attrs: { caption: "" } }, [
                                    t._v(t._s(t.record.notice_priority_name)),
                                  ]),
                                ],
                                1,
                              ),
                              ...
                              s(
                                ...
                                [
                                  s("q-item-label", { attrs: { caption: "" } }, [
                                    ...
                                    s("span", { staticClass: "neu-css-after-colon q-ml-lg" }, [
                                      t._v("已/总执行次数"),
                                    ]),
                                    t._v(
                                      t._s(t.record.done_total) +
                                        "/" +
                                        t._s(t.record.total) +
                                        "\n            ",
                                    ),
                                  ...
                                  0 != t.record.apply_max && t.menuInfo
                                    ? s("q-item-label", { attrs: { caption: "" } }, [
                                        s(
                                          "span",
                                          { staticClass: "text-grey neu-css-after-colon" },
                                          [t._v(t._s(t.applyShortTitle) + "人数限制")],
                                        ),
                                        t._v(t._s(t.record.apply_max) + "\n            "),
                                      ])
                                    : t._e(),
                                  0 == t.record.apply_max && t.menuInfo
                                    ? s("q-item-label", { attrs: { caption: "" } }, [
                              ...
                              s(
                                ...
                                [
                                  s(
                                    ...
                                    [
                                      s("q-icon", {
                                        attrs: { name: "remove_red_eye", size: "sm" },
                                      }),
                                    ],
                                    1,
                                  ),
                                ...
                                ? s(
                                    ...
                                    [
                                      s(
                                        ...
                                        [
                                          s("q-icon", {
                                            attrs: {
                                              name:
                                                2 == t.record.status ? "refresh" : "access_time",
                                              size: "sm",
                                              color: "primary",
                                            },
                                          }),
                                      ...
                                      s(
                                        ...
                                        [t._v(t._s(2 == t.record.status ? "重新开启" : "延期"))],
                                      ),
                                    ],
                                    1,
                                  )
                                    ...
                                    s(
                                      ...
                                      [
                                        s(
                                          ...
                                          [
                                            s("span", { staticClass: "neu-css-after-colon" }, [
                                              t._v(t._s(t.menuInfo.title) + "时间段"),
                                            ]),
                                        ...
                                        s(
                                          ...
                                          [
                                            s("div", { staticClass: "col-6" }, [
                                              s("span", { staticClass: "neu-css-after-colon" }, [
                                                t._v(t._s(t.menuInfo.title) + "率"),
                                              ]),
                                              t._v(t._s(e.applyedrate) + " %"),
                                            ]),
                                            s("div", { staticClass: "col-6" }, [
                                              s("span", { staticClass: "neu-css-after-colon" }, [
                          ...
                          s(
                            ...
                            [
                              s(
                                ...
                                [
                                  s("div", { staticClass: "text-h6" }, [t._v("预览")]),
                                  s("q-btn", {
                              ...
                              s("q-separator"),
                              s("q-card-section", [
                                s("div", { staticClass: "q-mt-sm text-bold" }, [
                                  t._v(t._s(t.record.title)),
                                ]),
                                s("div", { staticClass: "q-mt-sm" }, [
                                ...
                                t.record.attachment && 0 != t.record.attachment.length
                                  ? s(
                                      ...
                                      [
                                        s("div", { staticClass: "text-grey neu-css-after-colon" }, [
                                          t._v("附件"),
                                        ]),
                                        s(
                                          "div",
                              ...
                              s("q-card-section", [
                                ...
                                s("div", [
                                  ...
                                  t._v(
                                    t._s(t.record.apply_max > 0 ? t.record.apply_max : "无") +
                                      "\n              ",
                                  ),
                                ]),
                                s("div", [
                                  ...
                                  t._v(
                                    t._s(1 === t.record.need_location ? "是" : "否") +
                                      "\n              ",
                                  ),
                                ]),
                                s("div", [
                                  s("span", { staticClass: "text-grey neu-css-after-colon" }, [
                                    t._v("允许" + t._s(t.counsellorlabel) + "撤回学生数据"),
                                  ]),
                                  t._v(
                                    t._s(1 === t.record.allow_counsellor ? "是" : "否") +
                                      "\n                ",
                                  ),
                                  s(
                                    "div",
                                    ...
                                    [
                                      t.record.is_author
                                        ? s("q-toggle", {
                                            ...
                                            on: { input: t.changeAllowCounsellor },
                                            model: {
                                  ...
                                  s("div", [
                                    ...
                                    t.record.is_author && "S" != t.record.frequency
                                      ? s("span", { staticClass: "text-grey text-caption" }, [
                                          t._v("周循环，指定日期频率修改任务对象后下次执行生效"),
                                        ])
                                      : t._e(),
                                  ]),
                                  s("neu-view-assigned-student", {
                              ...
                              t.record.info_config ? s("q-separator") : t._e(),
                              t.record.info_config
                                ...
                                : t._e(),
                              t.record.reviewer ? s("q-separator") : t._e(),
                              t.record.reviewer
                                ? s(
                                    "q-card-section",
                                    [
                                      ...
                                      t._l(t.record.reviewer, function (e, a) {
                                        return s(
                                          "div",
                                          { key: a, staticClass: "bg-grey-2 q-pa-sm q-mt-sm" },
                                          [
                                            s("div", [
                                              s("span", { staticClass: "neu-css-after-colon" }, [
                                                t._v(t._s(e.review_level) + "级审批人员"),
                                              ]),
                                            ]),
                                            s("neu-view-assigned-teacher", {
                          ...
                          s(
                            ...
                            [
                              s(
                                ...
                                [
                                  s("div", { staticClass: "text-bold" }, [t._v("修改共享对象")]),
                                  s("q-btn", {
                                    attrs: { unelevated: "", color: "primary", label: "完成" },
                        ...
                        [
                          s(
                            ...
                            [
                              s(
                                "q-form",
                                { on: { submit: t.resetTime } },
                                [
                                  s("q-card-section", { staticClass: "text-h6" }, [
                                    t._v(
                                      "\n                " +
                ...
                .onOk(() => {
                  (this.$q.loading.show(),
                    this.$axiosAction("/api/teacher/apply/apply.api", {
                      ...
                      .then((e) => {
                        (0 === e.data.code &&
                          (this.resetDetail(), this.getStatisticsList(() => {})),
                          this.$q.loading.hide());
                      })
                      .catch((e) => {
                        this.$q.loading.hide();
                  ...
                  0 === e.data.code
                    ? ((this.record = e.data.result),
                      this.record.begin_time_befor === this.record.end_time_befor
                        ? (this.timeSlot =
                            this.record.begin_time + " ~ " + this.record.end_time_after)
      ...
      (V()(W, "components", {
        ...
        V()(W, "directives", { Ripple: B["a"], ClosePopup: H["a"] }));
    },
  },
]);
