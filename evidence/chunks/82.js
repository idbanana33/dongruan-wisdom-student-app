                              ...
                              a(
                                ...
                                [
                                  ...
                                  a("div", { staticClass: "col-6" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("姓名：")]),
                                    a("span", { staticClass: "text-bold" }, [
                                      e._v(e._s(e.record.name)),
                                    ]),
                                  ]),
                                  a("div", { staticClass: "col-6" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("性别：")]),
                                    a("span", { staticClass: "text-bold" }, [
                                      e._v(e._s(e.record.sex_name)),
                                    ]),
                                  ]),
                                  a("div", { staticClass: "col-6 q-mt-sm" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("教工号：")]),
                                    a("span", [e._v(e._s(e.record.teacher_no))]),
                                  ]),
                                  a("div", { staticClass: "col-6 q-mt-sm" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("请假次数：")]),
                                    a("span", [e._v(e._s(e.record.leave_history_count))]),
                                  ]),
                                ],
                              ),
                            ],
                              ...
                              a(
                                ...
                                [
                                  ...
                                  a("div", { staticClass: "col-12" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("请假时间：")]),
                                    a("span", [e._v(e._s(e.record.leave_period))]),
                                  ]),
                                  a("div", { staticClass: "col-12 q-mt-sm" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("发起时间：")]),
                                    a("span", [e._v(e._s(e.record.create_time))]),
                                  ]),
                                  a("div", { staticClass: "col-12 q-mt-sm" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("请假类型：")]),
                                    a("span", [e._v(e._s(e.record.leave_type_name))]),
                                  ]),
                                  a("div", { staticClass: "col-12 q-mt-sm" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("是否离校：")]),
                                    a("span", [e._v(e._s(e.record.walk_outs))]),
                                  ]),
                                  a("div", { staticClass: "col-12 q-mt-sm" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("是否出市：")]),
                                    a("span", [e._v(e._s(1 == e.record.city_out ? "是" : "否"))]),
                                  ]),
                                  a("div", { staticClass: "col-12 q-mt-sm" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("是否出省：")]),
                                    a("span", [
                                  ...
                                  a(
                                    ...
                                    [
                                      a("span", { staticClass: "text-grey" }, [e._v("审批状态：")]),
                                      a(
                                        "q-chip",
                                        {
                                          directives: [
                                  ...
                                  a("div", { staticClass: "col-12 q-mt-sm" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("请假原因：")]),
                                    a("span", [e._v(e._s(e.record.reason))]),
                                  ]),
                                  a("div", { staticClass: "col-12 q-mt-sm" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("学生数量：")]),
                                    a(
                                      "span",
                                      {
                                        staticClass: "text-primary cursor-pointer",
                                      ...
                                      [e._v(e._s(e.record.student_num))],
                                    ),
                                  ]),
                                  a("div", { staticClass: "col-12 q-mt-sm" }, [
                                    a("span", { staticClass: "text-grey" }, [e._v("发起位置：")]),
                                    a("span", [e._v(e._s(e.record.location))]),
                                  ]),
                                  a(
                                    "div",
                                    {
                                    ...
                                    [
                                      a("span", { staticClass: "text-grey" }, [e._v("附件：")]),
                                      e._l(e.record.attachment, function (t) {
                                        return a(
                                          "div",
                                          { key: t, staticClass: "q-mt-sm" },
                                          [
                                            a("q-img", {
                                              staticStyle: {
                                                height: "200px",
                        ...
                        ? a(
                            ...
                            [
                              a(
                                ...
                                [
                                  a("div", { staticClass: "row q-ml-md q-mt-md" }, [
                                    a("div", { staticClass: "col-12 text-left text-weight-bold" }, [
                                      e._v("审批流程"),
                                    ]),
                                  ]),
                                  a("q-item", [
                                      ...
                                      [
                                        a(
                                          ...
                                          [
                                                ...
                                                "q-timeline-entry",
                                                {
                                                  ...
                                                  attrs: {
                                                    ...
                                                    color:
                                                      ...
                                                      s == e.record.review_list.length - 1
                                                        ? "A" == t.review_status
                                                          ? "positive"
                                                          : "red"
                                                        : "grey",
                                            ...
                                            "W" != e.r_status && e.nextTeacher.length > 0
                                              ? a(
                                                  "q-timeline-entry",
                                                  {
                                                    attrs: {
                                                  ...
                                                  [
                                                    e._l(
                                                      ...
                                                      function (t, s) {
                                                        return a("span", { key: t.teacher_no }, [
                                                          e._v(e._s(t.name)),
                                                          s != e.nextTeacher.length - 1 &&
                                                          2 != s &&
