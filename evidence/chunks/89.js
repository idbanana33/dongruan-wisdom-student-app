      ...
      var a = function () {
                  ...
                  s(
                    ...
                    [
                      s("q-btn", {
                        ...
                        on: { click: e.goCollect },
                      }),
                      e.menuInfo
                        ? s("q-toolbar-title", [e._v(e._s(e.menuInfo.title) + "详情")])
                        : e._e(),
                    ],
                    1,
                  ),
                        ...
                        [
                          null != e.record.message_time
                            ? s(
                                ...
                                [
                                  s("q-icon", { attrs: { name: "done", size: "2rem" } }),
                                  e._v(e._s(e.menuInfo.title) + "成功\n        "),
                                ],
                                1,
                              )
                            : e._e(),
                          null == e.record.message_time && 0 == e.record.judgeend
                            ? s(
                                "q-card-section",
                                {
                                ...
                                [
                                  s("q-icon", { attrs: { name: "clear", size: "2rem" } }),
                                  e._v("未进行" + e._s(e.menuInfo.title) + "\n        "),
                                ],
                                1,
                              )
                            : e._e(),
                          null == e.record.message_time && 0 == e.record.judgebegin
                            ? s(
                                "q-card-section",
                                {
                                  staticClass:
                                ...
                                [
                                  s("q-icon", { attrs: { name: "warning", size: "2rem" } }),
                        ...
                        [
                          s(
                            ...
                            [
                              ...
                              s("div", { staticClass: "q-ml-sm row" }, [
                                s("span", {
                                  staticClass: "full-width text-weight-bold",
                                  staticStyle: { "font-size": "15px" },
                                  domProps: { innerHTML: e._s(e.record.title) },
                                }),
                              ]),
                              s("div", { staticClass: "q-ml-sm row" }, [
                                e.menuInfo
                                  ? s(
                                      ...
                                      [e._v(e._s(e.applyTypeTitle) + "时间段")],
                                    )
                                  : e._e(),
                                s(
                                  "span",
                                  { staticClass: "q-mt-xs", staticStyle: { "font-size": "12px" } },
                              ...
                              null != e.record.message_time
                                ? s("div", { staticClass: "q-ml-sm row" }, [
                                    ...
                                    s(
                                      ...
                                      [e._v(e._s(e.record.message_time))],
                                    ),
                                  ])
                                : e._e(),
                              s(
                                ...
                                [
                                  ...
                                  s(
                                    ...
                                    [e._v(e._s(e.record.address))],
                                  ),
                                ],
                              ),
                              s("q-separator", { staticClass: "q-mt-sm" }),
                              s("div", { staticClass: "q-ml-sm row" }, [
                                s("span", {
                              ...
                              s(
                                "q-form",
                                { on: { submit: e.updateResult } },
                                [
                                  s("q-separator", { staticClass: "q-mt-md" }),
                                  e._l(e.record.info_config, function (t, a) {
                                    return s("neu-widget-vue", {
                                      ...
                                      attrs: {
                                        config: t,
                                        viewMode:
                                          null !== e.record.message_time && 1 != e.record.judgeend,
                                      },
                                      model: {
                                  ...
                                  e.record.info_config.length > 0
                                    ...
                                    : e._e(),
                                  null == e.record.message_time && 1 == e.record.judetime
                                    ? s(
                                        "div",
                                        [
                                          s("q-btn", {
                          ...
                          s("q-btn", {
                            directives: [
                              ...
                              },
                              {
                                ...
                                expression:
                                  "record.message_time == null && record.judetime == true",
                              },
                            ],
        ...
        l = {
          ...
          methods: {
            ...
            locationCompleted(e) {
              ((this.location = e),
                this.locationStatus && ((this.locationStatus = !1), this.saveSubmit()));
            },
            locationError(e) {
              if (this.locationStatus)
                return (
                  (this.locationStatus = !1),
                  this.$showErrorNotify("该任务需要定位信息，定位失败")
                );
            },
            saveSubmit(e) {
              this.$q.loading.show();
