    ...
    "49de": function (t, e, i) {
                ...
                [
                  i(
                    ...
                    [
                      ...
                      i("q-toolbar-title", [t._v(t._s(this.taskTitle))]),
                      i("q-btn", {
                              ...
                              i(
                                ...
                                [
                                  ...
                                  i("q-item-label", [
                                    ...
                                    i("span", { staticClass: "q-ml-md q-mr-sm" }, [
                                      t._v(
                                        t._s(t.record.signin_total) +
                                          "/" +
                                          t._s(t.record.signin_count - t.record.leave_total),
                                      ),
                                    ]),
                                    i(
                                      "span",
                                      {
                                        class:
                                          t.record.signin_ratio >= 85
                                            ? "text-positive"
                                            : t.record.signin_ratio >= 60
                                              ? "text-warning"
                                              : "text-red",
                                      },
                                      [t._v(t._s(t.record.signin_ratio) + "%")],
                                    ),
                                  ]),
                                  i("q-item-label", [
                                    i("span", { staticClass: "text-grey neu-css-after-colon" }, [
                                    ...
                                    i("span", { staticClass: "q-ml-md" }, [
                                      t._v(
                                        t._s(t.record.leave_total) +
                                          "/" +
                                          t._s(t.record.signin_count),
                                      ),
                                    ]),
                                    i("span", { staticClass: "q-ml-sm" }, [
                                      t._v(t._s(t.record.leave_ratio) + "%"),
                                    ]),
                                  ]),
                                  i(
                                    "q-item-label",
                                    ...
                                    [
                                      ...
                                      t._v(t._s(t.record.signin_method_name) + " + 拍照"),
                                      "L" == t.record.signin_method
                                        ? i("span", [
                                            t._v(
                                              "(" +
                                                t._s(
                                                  1 == t.record.allow_outside
                                                    ? "允许范围外签到"
                                                    : "不允许范围外签到",
                                                ) +
                                                ")",
                                  ...
                                  i(
                                    ...
                                    [
                                      ...
                                      t._v(t._s(t.record.signin_method_name)),
                                      "L" == t.record.signin_method
                                        ? i("span", [
                                            t._v(
                                              "(" +
                                  ...
                                  i("q-item-label", [
                                    ...
                                    t._v(t._s(t.record.frequency_name) + "\n              "),
                                    i(
                                      "span",
                                    ...
                                    i(
                                      ...
                                      [
                                        ...
                                        i(
                                          ...
                                          [
                                            i("div", { staticClass: "col-6" }, [
                                              i("span", { staticClass: "neu-css-after-colon" }, [
                                                t._v("签到率"),
                                              ]),
                                              t._v(t._s(e.signinedrate) + " %"),
                                            ]),
                                            i("div", { staticClass: "col-6" }, [
                                              i("span", { staticClass: "neu-css-after-colon" }, [
                                                t._v("请假率"),
                                              ]),
                                              t._v(t._s(e.leaverate) + " %"),
                                            ]),
                                          ],
                                        ),
                                        i(
                                          ...
                                          [
                                            i("div", { staticClass: "col-6" }, [
                                              ...
                                              t._v(t._s(e.signintotal)),
                                            ]),
                                            i("div", { staticClass: "col-6" }, [
                                              i("span", { staticClass: "neu-css-after-colon" }, [
                                                t._v("已签人数"),
                                              ]),
                                              t._v(t._s(e.signined)),
                                            ]),
                                          ],
                                        ),
                                        i(
                          ...
                          i(
                            ...
                            [
                              i(
                                ...
                                [
                                  i("div", { staticClass: "text-bold" }, [t._v("预览")]),
                                  i("q-btn", {
                              ...
                              i("q-card-section", [
                                ...
                                t.record.attachment && 0 != t.record.attachment.length
                                  ? i(
                                      ...
                                      [
                                        i("div", { staticClass: "text-grey neu-css-after-colon" }, [
                                          t._v("附件"),
                                        ]),
                                        i(
                                          "div",
                              ...
                              i("q-card-section", [
                                ...
                                "S" == t.record.frequency
                                  ? i("div", { staticClass: "row" }, [
                                      ...
                                      t._v(
                                        t._s(t.record.single_begin_time) +
                                          " ~ " +
                                          t._s(t.record.single_end_time) +
                                          "\n        ",
                                      ),
                                    ])
                                  : t._e(),
                                "L" == t.record.frequency
                                  ? i("div", [
                                      i("span", { staticClass: "text-grey neu-css-after-colon" }, [
                                        t._v("循环频率"),
                                      ]),
                                      t._v(
                                        t._s(t.getLoopFrequencyName(t.record.loop_frequency)) +
                                          "\n        ",
                                      ),
                                    ])
                                  : t._e(),
                                "L" == t.record.frequency
                                  ? i("div", { staticClass: "row" }, [
                                      ...
                                      t._v(
                                        t._s(t.record.loop_begin_date) +
                                          " ~ " +
                                          t._s(t.record.loop_end_date) +
                                          "\n        ",
                                      ),
                                    ])
                                  : t._e(),
                                "L" == t.record.frequency
                                  ? i("div", { staticClass: "row" }, [
                                      ...
                                      t._v(
                                        t._s(t.record.loop_begin_time) +
                                          " ~ " +
                                          t._s(t.record.loop_end_time) +
                                          "\n        ",
                                      ),
                                    ])
                                  : t._e(),
                                "A" == t.record.frequency
                                  ? i("div", { staticClass: "row" }, [
                                      i("span", { staticClass: "text-grey neu-css-after-colon" }, [
                                        t._v("开始截止时间"),
                                      ]),
                                      i(
                                        "div",
                                        t._l(t.record.appointed_date, function (e, a) {
                                          return i("div", { key: a }, [
                              ...
                              "SQR" == t.record.signin_method || "DQR" == t.record.signin_method
                                ? i("q-separator")
                                : t._e(),
                              "SQR" == t.record.signin_method || "DQR" == t.record.signin_method
                                ? i(
                                    ...
                                    [
                                      ...
                                      i("neu-view-assigned-student", {
                                        attrs: { value: t.record.student_showing },
                                      }),
                                    ],
                                    1,
                                  )
                                ...
                                ? i(
                                    ...
                                    [
                                      ...
                                      i("neu-view-assigned-teacher", {
                                        attrs: { value: t.record.teacher_showing },
                                      }),
                                    ],
                                    1,
                                  )
                              ...
                              i(
                                ...
                                [
                                  i("div", [
                                            ...
                                            directives: [
                                              {
                                                ...
                                                rawName: "v-show",
                                                value:
                                                  t.record.is_author && "S" != t.record.frequency,
                                                expression:
                                                  "record.is_author && record.frequency != 'S'",
                                              },
                                            ],
                                            staticClass: "text-grey",
                                            on: {
                                    ...
                                    i("br"),
                                    t.record.is_author && "S" != t.record.frequency
                                      ? i("span", { staticClass: "text-grey text-caption" }, [
                                          t._v("周循环，指定日期频率修改签到对象后下次执行生效"),
                                        ])
                                      : t._e(),
                                  ]),
                                  i("neu-view-assigned-student", {
                              ...
                              i(
                                ...
                                [
                                  i("div", [
                                    i("span", { staticClass: "text-grey neu-css-after-colon" }, [
                                      t._v("无需" + t._s((t.menuInfo || {}).title) + "对象"),
                                    ]),
                                    i(
                                      "div",
                                      { staticStyle: { float: "right" } },
                                  ...
                                  i("neu-view-assigned-student", {
                                    attrs: { value: t.record.task_target_excluding },
                                  }),
                                ],
                                1,
                              ),
                              ...
                              t.record.info_config ? i("q-separator") : t._e(),
                              t.record.info_config
                                ? i(
                                    "q-card-section",
                                    [
                                      i("div", [
                            ...
                            [
                              i("q-toolbar", [
                                i(
                                  ...
                                  [
                                    i("div", { staticClass: "text-bold text-black" }, [
                                      t._v("设置" + t._s((t.menuInfo || {}).title) + "对象"),
                                    ]),
                                    i("q-btn", {
                                      attrs: { unelevated: "", color: "primary", label: "完成" },
                            ...
                            [
                              i("q-toolbar", [
                                i(
                                  ...
                                  [
                                    i("div", { staticClass: "text-bold text-black" }, [
                                      t._v("设置无需" + t._s((t.menuInfo || {}).title) + "对象"),
                                    ]),
                                    i("q-btn", {
                                      attrs: { unelevated: "", color: "primary", label: "完成" },
                                      on: { click: t.updateNoActionTarget },
                                    }),
                                  ],
                                  1,
                                ),
                            ...
                            [
                              i(
                                ...
                                [
                                  i(
                                    ...
                                    [
                                      i("q-item-label", { staticClass: "text-weight-bold" }, [
                              ...
                              i(
                                ...
                                [
                                  i(
                                    "q-item-section",
                                    [i("q-item-label", [t._v(t._s(t.ruleMessage))])],
                                    1,
                                  ),
                                ],
                                1,
                              ...
                              i(
                                ...
                                [
                                  i(
                                    "q-page",
                                    [
                                      i("neu-signin-range-now", {
                                        attrs: { selectList: t.selectList, id: t.signinId },
                                        model: {
          ...
          return i(
            ...
            [
                  ...
                  i(
                    ...
                    [
                          ...
                          [
                            i(
                              ...
                              [
                                ...
                                i(
                                  "q-item-label",
                                  { staticClass: "row justify-between", attrs: { caption: "" } },
                                  [
                                    i("div", [
                                      i("span", { staticClass: "neu-css-after-colon" }, [
                                        t._v("有效范围"),
                                      ]),
                                      i("span", { staticClass: "text-black" }, [
                                        t._v(
                                          t._s(
                                            "circle" == e.area
                                              ? "半径" + e.radius + "米"
                      ...
                      i(
                        ...
                        [
                          i("q-item-section", { staticClass: "text-center" }, [
                            i("div", { staticClass: "text-grey" }, [t._v("加载更多")]),
                          ]),
                        ],
                        1,
                      ),
                      i(
                        ...
                        [
                          i("q-item-section", { staticClass: "text-center" }, [
                            i("div", { staticClass: "text-grey" }, [t._v("没有更多了")]),
                          ]),
                        ],
                        1,
                      ),
              ...
              i(
                "q-dialog",
                {
                  attrs: { fullWidth: "", maximized: t.maximizedToggle },
                  model: {
                ...
                [
                  i(
                    ...
                    [
                      i(
                        "q-card-section",
                        [i("neu-view-map", { attrs: { value: t.record, "popup-close-btn": !0 } })],
                        1,
                      ),
                    ],
                    1,
      ...
      var L = {
          ...
          mounted() {
            ...
            ((this.color = 0 === t ? "#f2c037;" : 1 === t ? "#027be3;" : "#b5b3b3;"),
          ...
          methods: {
            ...
            getStatisticsList(t) {
              (t && ((this.paging.pageNum = 0), (this.list = [])),
                ...
                this.$axiosAction("/api/teacher/signin/signin.api", {
                  ...
                  .then((e) => {
                    if (0 === e.data.code) {
                      ((this.taskTitle = e.data.title + this.menuInfo.title + "统计"),
                        (this.allowOutside = 1 === e.data.allowOutside),
            ...
            goBack() {
              null !== this.cId && void 0 !== this.cId
                ...
                : this.$router.push("/teacher/signin/index");
            },
            goDetail(t) {
              null !== this.cId && void 0 !== this.cId
                ? this.$router.push(
                    `/teacher/signin/detail?id=${this.signinId}&batch_no=${t}&compositeId=${this.cId}`,
                  )
                : this.$router.push(`/teacher/signin/detail?id=${this.signinId}&batch_no=${t}`);
            },
            exportList() {
              (this.$q.loading.show(),
                (this.exportCompConfig = [
                  "/api/teacher/signin/signin.api",
                  "exportSigninStatisticsDate",
                  { signin_id: this.signinId },
                  ...
                  (t) =>
                    t.reduce((t, e) => {
                      ...
                      return (
                        1 === this.record.allow_outside && (i.范围外签到人数 = e.outsidecount),
                        t.concat(i)
                      );
                    }, []),
                  1e3,
            ...
            copySignin() {
              let t = "";
              (null !== this.record.composite_id && (t = "，该任务为组合任务子任务"),
                this.$q
                  .dialog({
                    title: "确认复制",
                      ...
                      .then((t) => {
                        if (0 === t.data.code) {
                          ...
                          (null !== this.record.composite_id &&
                            (e = { compositeId: this.record.composite_id, befrom: "copy" }),
                            this.$router.push({
            ...
            updateShowOpen(t) {
              if (1 === t)
                return (
                  ...
                  void (this.studentShowing = JSON.parse(
                    JSON.stringify(this.record.student_showing),
                  ))
                );
              2 === t &&
            ...
            taskTargetExcludDialogOpen() {
              ((this.taskTargetExcludDialog = !0),
                (this.noActionTarget = JSON.parse(
                  JSON.stringify(this.record.task_target_excluding),
                )));
            },
            openShareDialog() {
                ...
                1 !== t
                  ? 2 === t &&
                    this.$axiosAction("/api/teacher/signin/signin.api", {
                      ...
                      .then((t) => {
                        (0 === t.data.code &&
                          ((this.record.teacher_showing = this.teacherShowing),
                          (this.showTeaDialog = !1)),
                          this.$q.loading.hide());
                      })
                      .catch((t) => {
                        this.$q.loading.hide();
                  ...
                  : this.$axiosAction("/api/teacher/signin/signin.api", {
                      ...
                      .then((t) => {
                        (0 === t.data.code &&
                          ((this.record.student_showing = this.studentShowing),
                          (this.showStuDialog = !1)),
                          this.$q.loading.hide());
                      })
                      .catch((t) => {
                        this.$q.loading.hide();
                ...
                .onOk(() => {
                  (this.$q.loading.show(),
                    this.$axiosAction("/api/teacher/signin/signin.api", {
                      ...
                      .then((t) => {
                        (0 === t.data.code && (this.getData(), this.getStatisticsList(() => {})),
                          this.$q.loading.hide());
                      })
                      .catch((t) => {
                        this.$q.loading.hide();
            ...
            resetRange() {
              ...
              this.$q
                .dialog({
                  ...
                  persistent: !0,
                  cancel: { label: "取消", outline: !0, color: "grey" },
                  ok: { label: "确认", unelevated: !0, color: "primary" },
                })
                .onOk(() => {
                  let t = [];
                  ((t = (this.record.range || []).reduce((t, e) => t.concat(e.id), [])),
                    this.getSelected(1, t));
                });
            },
            updateRange(t) {
              (this.$q.loading.show(),
      ...
      (D()(Y, "components", {
        ...
        D()(Y, "directives", { Ripple: K["a"], ClosePopup: X["a"] }));
    },
  },
]);
