                                        ...
                                        [
                                          s(
                                            "div",
                                            {
                                              ...
                                              class: [
                                                "bg-" +
                                                  (t.normalApps[4 * (e - 1) + o - 1].color
                                                    .background,
                                                  t.normalApps[4 * (e - 1) + o - 1].color
                                                    .background),
                                                "text-" +
                                                  t.normalApps[4 * (e - 1) + o - 1].color.text,
                                              ],
                                            },
                                            [
                                              t._v(
