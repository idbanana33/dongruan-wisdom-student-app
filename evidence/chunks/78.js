                ...
                [
                  i(
                    ...
                    [
                      ...
                      i("q-toolbar-title", [e._v(e._s(e.title))]),
                      i(
                        "q-btn",
                        {
                                  ...
                                  [
                                    ...
                                    i(
                                      ...
                                      [
                                        ...
                                        i("q-item-label", { attrs: { lines: "1", caption: "" } }, [
                                          e._v(e._s(e.counsellorlabel) + "：" + e._s(t.counsellor)),
                                        ]),
                                        i("q-item-label", { attrs: { lines: "2" } }, [
                                          e._v(
                                            "\n                " +
                                              e._s(t.leave_period) +
                                              "\n              ",
                              ...
                              directives: [
                                {
                                  ...
                                  value:
                                    ...
                                    0 != e.data.length,
                                  expression:
                                    "!isLoading && paging.pageCount == paging.pageNum && data.length != 0",
                                },
                              ],
                              staticClass: "text-center text-grey q-pt-sm q-pb-md",
                            },
                                      ...
                                      return i(
                                        "q-btn",
                                        {
                                          ...
                                          attrs: {
                                            outline: "",
                                            color:
                                              t.value == e.queryModel.status1 ? "primary" : "grey",
                                          },
                                          on: {
                                            click: function (i) {
                                      ...
                                      return i(
                                        "q-btn",
                                        {
                                          ...
                                          attrs: {
                                            outline: "",
                                            color:
                                              t.value == e.queryModel.status2 ? "primary" : "grey",
                                          },
                                          on: {
                                            click: function (i) {
                                      ...
                                      return i(
                                        "q-btn",
                                        {
                                          ...
                                          attrs: {
                                            outline: "",
                                            color:
                                              t.value == e.queryModel.status3 ? "primary" : "grey",
                                          },
                                          on: {
                                            click: function (i) {
                            ...
                            [
                              ...
                              i(
                                ...
                                [
                                  ...
                                  i(
                                    "q-item-label",
                                    { staticClass: "q-mt-xs", attrs: { caption: "", lines: "1" } },
                                    [e._v("可以查询学号、姓名、院系、专业、年级信息")],
                                  ),
                                ],
                                1,
                              ),
              ...
              i(
                ...
                [
                  i(
                    ...
                    [
                      i("q-card-section", [
                        i("div", { staticClass: "text-h6" }, [e._v("审批意见")]),
                      ]),
                      i(
                        "q-card-section",
                ...
                : ((this.queryModel.status2 = e),
                  "1" === e
                    ...
                    : "2" === e
                      ...
                      : "3" === e &&
                        ((this.timeList.minTime = 72), (this.timeList.maxTime = null)));
            },
            chooseLeaveType(e) {
              ...
              (e && ((this.paging.pageNum = 0), (this.data = [])),
                ...
                "reviewing" === this.tab
                  ...
                  : "reviewed" === this.tab
                    ...
                    : "all" === this.tab &&
                      ((this.pageType = null), (this.leaveAction = "getLeaveNotes")));
