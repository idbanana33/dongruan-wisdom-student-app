                ...
                [
                  s(
                    ...
                    [
                      ...
                      s("q-toolbar-title", [
                        e._v("新建" + e._s(e.record.process_type_name) + "流程申请"),
                      ]),
                    ],
                    1,
                  ),
                ...
                [
                  s(
                    ...
                    [
                      s(
                        "q-form",
                        { staticClass: "q-gutter-sm full-width", on: { submit: e.saveProcess } },
                        [
                          e.menuInfo
                            ? s(
                                "q-card",
                                ...
                                [
                                  s(
                                    "q-list",
                                    [
                                      e._l(e.record.process_info_config, function (t, o) {
                                        return s(
                                          "q-item",
                                          { key: o },
                                          [
                                      ...
                                      s("q-separator", {
                                        ...
                                        staticStyle: { width: "92%", "margin-left": "16px" },
                                      }),
                                      s(
                                        "q-item",
                                        {
                          ...
                          s(
                            ...
                            [
                              ...
                              s("q-btn", {
                                ...
                                attrs: { color: "primary", label: "申请", type: "submit" },
                              }),
                            ],
                            1,
                          ),
