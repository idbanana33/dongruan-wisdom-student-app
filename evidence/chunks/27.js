                  ...
                  s(
                    ...
                    [
                      ...
                      s("q-btn", {
                        ...
                        attrs: { flat: "", round: "", dense: "", icon: "delete" },
                        on: { click: e.deleteLeave },
                      }),
                    ],
                    1,
                  ),
                        ...
                        [
                                ...
                                ? s(
                                    ...
                                    [
                                      s("q-icon", {
                                        ...
                                        attrs: {
                                          name:
                                            "审批通过" == e.details.review_name ? "done" : "clear",
                                          size: "0.9rem",
                                        },
                                      }),
                                      s("span", { staticStyle: { "font-size": "0.9rem" } }, [
                                        e._v(e._s(e.details.review_name)),
                                      ]),
                                    ],
                                    1,
                                  )
                              ...
                              0 == e.needReport
                                ? s(
                                    ...
                                    [
                                      ...
                                      s("span", { staticStyle: { "font-size": "1.5rem" } }, [
                                        e._v(e._s(e.details.review_name)),
                                      ]),
                                    ],
                                    1,
                                ...
                                : e._e(),
                              1 == e.needReport
                                ? s("div", { staticClass: "row items-center justify-center" }, [
                                    s("span", { staticStyle: { "font-size": "1.5rem" } }, [
                                      e._v(e._s(e.details.report_status_name)),
                                    ]),
                                    "已销假" == e.details.report_status_name
                                      ? s("span", { staticStyle: { "font-size": "1rem" } }, [
                                          e._v("(" + e._s(e.details.report_time) + ")"),
                                        ])
                                      : e._e(),
                                  ])
                                : e._e(),
                          ...
                          s("q-card-section", { staticClass: "full-width row justify-around" }, [
                            s("div", { staticClass: "col-6" }, [
                              ...
                              s("span", [e._v(e._s(e.details.leave_type_name))]),
                            ]),
                            s("div", { staticClass: "col-6" }, [
                              s("span", { staticClass: "text-grey" }, [e._v("需要离校：")]),
                              s(
                                "span",
                                {
                                  directives: [
                            ...
                            s("div", { staticClass: "col-6" }, [
                              s("span", { staticClass: "text-grey" }, [e._v("需要出市：")]),
                              s("span", { class: 1 == e.details.city_out ? "text-warning" : "" }, [
                                e._v(e._s(1 == e.details.city_out ? "是" : "否")),
                              ]),
                            ]),
                            s("div", { staticClass: "col-6" }, [
                              s("span", { staticClass: "text-grey" }, [e._v("需要出省：")]),
                              s(
                                "span",
                                { class: 1 == e.details.province_out ? "text-warning" : "" },
                                [e._v(e._s(1 == e.details.province_out ? "是" : "否"))],
                              ),
                            ]),
                            s("div", { staticClass: "col-12" }, [
                              s("span", { staticClass: "text-grey" }, [e._v("请假学生：")]),
                              s("span", [
                                e._v(
                                  e._s(e.userInfo.name) + "(" + e._s(e.userInfo.login_name) + ")",
                                ),
                              ]),
                            ]),
                            e.details.leave_multi_id
                              ? s("div", { staticClass: "col-12" }, [
                                  s("span", { staticClass: "text-grey" }, [e._v("批量请假教师：")]),
                          ...
                          s(
                            ...
                            [
                              ...
                              s("div", { staticClass: "col-12" }, [
                                ...
                                s("span", [e._v(e._s(e.details.leave_time))]),
                              ]),
                              s("div", { staticClass: "col-12 q-mt-sm" }, [
                                s("span", { staticClass: "text-grey" }, [e._v("发起时间：")]),
                                s("span", [e._v(e._s(e.details.create_time))]),
                              ]),
                              s("div", { staticClass: "col-12 q-mt-sm" }, [
                                s("span", { staticClass: "text-grey" }, [e._v("请假原因：")]),
                                s("span", [e._v(e._s(e.details.reason))]),
                              ]),
                              e.details.location
                                ? s("div", { staticClass: "col-12 q-mt-sm" }, [
                                    s("span", { staticClass: "text-grey" }, [e._v("发起位置：")]),
                                    s("span", [e._v(e._s(e.details.location.address))]),
                                  ])
                                : e._e(),
                              e.details.attachment && 0 != e.details.attachment.length
                                ? s(
                                    "div",
                                    { staticClass: "col-12 q-mt-sm" },
                                    [
                                      s("span", { staticClass: "text-grey" }, [e._v("附件：")]),
                                      e._l(e.details.attachment, function (t) {
                                        return s(
                                          "div",
                                              ...
                                              return s(
                                                "q-timeline-entry",
                                                {
                                                  ...
                                                  attrs: {
                                                    ...
                                                    color:
                                                      "W" != e.details.review_status &&
                                                      e.details.review_list &&
                                                      a == e.details.review_list.length - 1
                                                        ? "A" == t.review_status
                                                          ? "positive"
                                                          : "red"
                                                        : "grey",
              ...
              s(
                ...
                [
                  s(
                    ...
                    [
                      1 != e.needReport || e.details.report_time
                        ? e._e()
                        : s(
                            "q-btn",
                            {
                              staticStyle: { width: "60%", height: "55px" },
                              on: { click: e.showQrCode },
                            },
                            [
                              s("span", { staticStyle: { "font-size": "16px" } }, [
                                e._v("请假信息二维码"),
                              ]),
                            ],
                          ),
                      0 == e.needReport || e.details.report_time
                        ? s(
                            "q-btn",
                            {
                              staticStyle: { width: "100%", height: "55px" },
                              on: { click: e.showQrCode },
                            },
                            [
                              s("span", { staticStyle: { "font-size": "16px" } }, [
                      ...
                      1 != e.needReport || e.details.report_time
                        ...
                        : s("q-btn", {
                            ...
                            staticStyle: { width: "40%", height: "55px" },
                            attrs: { flat: "", unelevated: "", color: "white", label: "销假" },
                            on: {
                              click: function (t) {
                                return e.goReport();
                              },
            ...
            getEncryptionQrCode() {
              (this.$q.loading.show(),
                this.$axiosAction("/api/student/leave/leave.api", {
                  ...
                  (0 === e.data.code && (this.downloadData.text = e.data.qrcode),
                    this.$q.loading.hide());
                }));
            },
          },
