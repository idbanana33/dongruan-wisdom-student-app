                  ...
                  a(
                    ...
                    [
                      ...
                      "C" == t.apply_type
                        ? a("q-btn", {
                            attrs: { flat: "", round: "", dense: "", icon: "keyboard_arrow_left" },
                            on: { click: t.goCollect },
                          })
                        : t._e(),
                      t.menuInfo
                        ? a("q-toolbar-title", [t._v(t._s(t.menuInfo.title) + "详情")])
                        : t._e(),
                    ],
                    1,
                  ),
                  ...
                  a(
                    ...
                    [
                      a(
                        ...
                        [
                          null != t.record.apply_time && "detail" == t.tab
                            ? a(
                                "q-card-section",
                                {
                                  staticClass:
                                ...
                                [
                                  a("q-icon", { attrs: { name: "done", size: "2rem" } }),
                                  t._v(t._s(t.menuInfo.title) + "成功\n        "),
                                ],
                                1,
                              )
                            : t._e(),
                          null == t.record.apply_time && 0 == t.record.judgeend && "detail" == t.tab
                            ? a(
                                "q-card-section",
                                {
                                ...
                                [
                                  a("q-icon", { attrs: { name: "clear", size: "2rem" } }),
                                  t._v("未进行" + t._s(t.menuInfo.title) + "\n        "),
                                ],
                                1,
                              )
                            : t._e(),
                          null == t.record.apply_time &&
                          0 == t.record.judgebegin &&
                          "detail" == t.tab
                            ? a(
                                "q-card-section",
                                {
                                  staticClass:
                                    "full-width row justify-center bg-warning text-white",
                                  staticStyle: { height: "4rem", "font-size": "1.5rem" },
                                },
                                [
                                  a("q-icon", { attrs: { name: "warning", size: "2rem" } }),
                                ...
                                [
                                  ...
                                  a("div", { staticClass: "q-ml-sm row" }, [
                                    a("span", {
                                      ...
                                      domProps: { innerHTML: t._s(t.record.title) },
                                    }),
                                    a("span", {
                                      directives: [
                                        {
                                  ...
                                  a("div", { staticClass: "q-ml-sm row" }, [
                                    t.menuInfo
                                      ? a(
                                          ...
                                          [t._v(t._s(t.applyTypeTitle) + "时间段")],
                                        )
                                      : t._e(),
                                    a(
                                      "span",
                                      ...
                                      [t._v(t._s(t.timeSlot))],
                                    ),
                                  ]),
                                  0 != t.record.apply_max && t.menuInfo && "C" == t.apply_type
                                    ? a("div", { staticClass: "q-ml-sm row" }, [
                                        a(
                                          "span",
                                          {
                                          ...
                                          [t._v("已提交人数/" + t._s(t.menuInfo.title) + "限额")],
                                        ),
                                        a(
                                          "span",
                                          {
                                    ...
                                    : t._e(),
                                  0 != t.record.apply_max && t.menuInfo && "S" == t.apply_type
                                    ? a("div", { staticClass: "q-ml-sm row" }, [
                                        a(
                                          "span",
                                          {
                                          ...
                                          [t._v("已报名人数/" + t._s(t.menuInfo.title) + "限额")],
                                        ),
                                        a(
                                          "span",
                                          {
                                    ...
                                    : t._e(),
                                  0 != t.record.apply_max && t.menuInfo && "A" == t.apply_type
                                    ? a("div", { staticClass: "q-ml-sm row" }, [
                                        a(
                                          "span",
                                          {
                                          ...
                                          [t._v("已申请人数/" + t._s(t.menuInfo.title) + "限额")],
                                        ),
                                        a(
                                          "span",
                                          {
                                      ...
                                      [
                                        t._v(
                                          t._s(t.userInfo.name) +
                                            "(" +
                                            t._s(t.userInfo.login_name) +
                                            ")",
                                        ),
                                      ],
                                    ),
                                  ]),
                                  null != t.record.apply_time && "A" === t.apply_type
                                    ? a("div", { staticClass: "q-ml-sm row" }, [
                                        a(
                                          "span",
                                          {
                                        ...
                                        a(
                                          ...
                                          [t._v(t._s(t.record.apply_time))],
                                        ),
                                      ])
                                    : t._e(),
                                  null != t.record.apply_time && "S" === t.apply_type
                                    ? a("div", { staticClass: "q-ml-sm row" }, [
                                        a(
                                          "span",
                                          {
                                    ...
                                    : t._e(),
                                  null != t.record.apply_time && "C" === t.apply_type
                                    ? a("div", { staticClass: "q-ml-sm row" }, [
                                        t.menuInfo
                                          ? a(
                                              "span",
                                              {
                                                staticClass:
                                                  "neu-css-after-colon text-grey q-mt-xs",
                                                staticStyle: { "font-size": "12px" },
                                              },
                                              [t._v("填写时间")],
                                            )
                                      ...
                                      directives: [
                                        {
                                          ...
                                          rawName: "v-show",
                                          value:
                                            1 === t.record.need_location &&
                                            null !== t.record.apply_time,
                                          expression:
                                            "record.need_location === 1 && record.apply_time !== null",
                                        },
                                      ],
                                  ...
                                  a("q-separator", { staticClass: "q-mt-sm" }),
                                  a("div", { staticClass: "q-ml-sm row" }, [
                                    a("span", {
                                      directives: [
                                        {
                                          ...
                                          directives: [
                                            {
                                              ...
                                              value:
                                                ...
                                                (1 === t.record.need_location &&
                                                  ...
                                                  1 == t.record.judgeend &&
                                                  "C" == t.record.apply_type &&
                                                  t.record.info_config.length > 0),
                                              expression:
                                                "(record.need_location === 1 && record.apply_time == null && record.judetime == true  && tab == 'detail') || (record.need_location === 1 && record.apply_time !==null && record.judgeend == true && record.apply_type == 'C' && record.info_config.length > 0)",
                                            },
                                          ],
                                        },
                                        [
                          ...
                          a(
                            ...
                            [
                              a(
                                ...
                                [
                                  a("neu-qa-list", {
                                    attrs: { taskMenuId: "apply", taskId: t.id + "" },
                                  }),
                                ],
                                1,
                              ),
                          ...
                          a(
                            ...
                            [
                              a(
                                ...
                                [
                                  a("neu-qa-list", {
                                    attrs: { taskMenuId: "signup", taskId: t.id + "" },
                                  }),
                                ],
                                1,
                              ),
                          ...
                          a(
                            ...
                            [
                              a(
                                ...
                                [
                                  a("neu-qa-list", {
                                    attrs: { taskMenuId: "collect", taskId: t.id + "" },
                                  }),
                                ],
                                1,
                              ),
                            ...
                            directives: [
                              ...
                              },
                              {
                                ...
                                value:
                                  ...
                                  "C" == t.record.apply_type,
                                expression:
                                  "record.apply_time == null && record.judetime == true  && tab == 'detail' && record.apply_type == 'C'",
                              },
                            ],
                            attrs: { round: "", color: "primary", icon: "save" },
                            on: { click: t.stopSave },
                          }),
                        ],
                        1,
              ...
              a(
                ...
                [
                  a(
                    ...
                    [
                      "A" == t.apply_type
                        ? a("q-tab", { attrs: { name: "detail", label: "申请正文" } })
                        : t._e(),
                      "C" == t.apply_type
                        ? a("q-tab", { attrs: { name: "detail", label: "信息收集正文" } })
                        : t._e(),
                      "S" == t.apply_type
                        ? a("q-tab", { attrs: { name: "detail", label: "活动报名正文" } })
                        : t._e(),
                ...
                0 === t.data.code
                  ? ((this.record = t.data.result),
                    this.record.begin_time_befor === this.record.end_time_befor
                      ? (this.timeSlot =
                          this.record.begin_time + " 至 " + this.record.end_time_after)
