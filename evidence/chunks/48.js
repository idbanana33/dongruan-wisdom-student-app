      ...
      var s = function () {
                  ...
                  i(
                    ...
                    [
                      ...
                      i("q-btn", {
                        ...
                        attrs: { flat: "", round: "", dense: "", icon: "mdi-qrcode" },
                        on: { click: t.scannList },
                      }),
                    ],
                    1,
                  ),
              ...
              i(
                ...
                [
                  i(
                    ...
                    [
                      i("q-tab", { attrs: { name: "signin", label: "正在进行" } }),
                      i("q-separator", { attrs: { vertical: "" } }),
                      i("q-tab", { attrs: { name: "history", label: "历史" } }),
                    ],
                    1,
                  ),
                ],
              ...
              t._l(t.list, function (e) {
                return i(
                  "q-card",
                  {
                    ...
                    style:
                      "进行中" == e.status
                        ? "border-left:0.25rem solid #" + t.menuColor + ";"
                      ...
                      [
                        i(
                          ...
                          [
                            ...
                            i("q-item-label", { staticClass: "q-mb-xs", attrs: { caption: "" } }, [
                              i("span", { staticClass: "neu-css-after-colon" }, [t._v("发起人")]),
                              t._v(t._s(e.name) + "\n          "),
                            ]),
                            i(
                              "q-item-label",
                              ...
                              [
                                ...
                                t._v(
                                  t._s(e.begin_time) + " 至 " + t._s(e.end_time) + "\n          ",
                                ),
                              ],
                            ),
                          ],
        ...
        c = {
          ...
          methods: {
            ...
            goDetail(t, e) {
              this.$router.push({ name: "/student/signin/signin", query: { id: t, batch_no: e } });
            },
          },
        },
        d = c,
          ...
          methods: {
            ...
            goDetail(t, e) {
              this.$router.push({
                ...
                query: { id: t, batch_no: e, tab: "history" },
              });
            },
          },
        },
