      ...
      var a = function () {
                    ...
                    [
                      i(
                        ...
                        e._l(e.commonCols, function (t) {
                          return i(
                            "q-item",
                            { key: t.field, attrs: { dense: "" } },
                            [
                              i(
                                "q-item-section",
                                { attrs: { avatar: "" } },
                                [
                                  i("q-item-label", { staticClass: "text-grey" }, [
                                    e._v(e._s(t.label)),
                                  ]),
                                ],
                                1,
                              ...
                              i(
                                "q-item-section",
                                [
                                  i("q-item-label", { staticClass: "text-right" }, [
                                    e._v("\n              " + e._s(e.record[t.field])),
                                    (e.record.role_id = "class_name" === t.field)
                                      ? i("span", [e._v("(" + e._s(e.record.role_name) + ")")])
                                      : e._e(),
                                  ]),
                                ],
                                1,
                      ...
                      e._l(e.record.stu_info_config || [], function (t, a) {
                        return i(
                          "q-card",
                          { key: a, staticClass: "q-mx-md q-mt-sm", attrs: { flat: "" } },
                          [
                            i(
                              "q-item",
                              [
                                ...
                                [
                                  ...
                                  i(
                                    "q-item-section",
                                    {
                                      on: {
                                        click: function (i) {
                                          -1 != t.authority.indexOf("O") &&
                                            e.openEditDialog(t.id, t.config);
                                        },
                                      },
                                    },
                                    [
                                      i(
                                        "q-item-label",
                                        {
                                          ...
                                          class:
                                            e.record.stu_info &&
                                            e.record.stu_info[t.id] &&
                                            1 != e.record.stu_info[t.id].status
                                              ? "text-red"
                                              : "",
                                        },
                                        [
                                          i("neu-view-widget-value", {
                                            attrs: {
                                              config: t.config,
                                              value:
                                                e.record.stu_info && e.record.stu_info[t.id]
                                                  ? e.record.stu_info[t.id].value
                                                  : "",
                                            },
                                          }),
                                          i("q-icon", {
                                    ...
                                    [
                                      i(
                                        ...
                                        [
                                          i(
                                            "q-form",
                                            { ref: "editForm", on: { submit: e.saveStuInfo } },
                                            [
                                              i("neu-widget", {
                                                attrs: { config: e.editModel.config },
                                                model: {
        ...
        n = function () {
          ...
          return i(
            "span",
            [
              "S" == e.conf.type && e.modelValue
                ? i("q-img", { attrs: { src: e.modelValue, width: "100px" } })
                : e._e(),
              e._v(e._s(e.dispValue) + "\n  "),
              "F" == e.conf.type && e.modelValue
                ? i(
                    "div",
                    e._l(e.modelValue || [], function (t) {
                      return i(
                        "div",
                        {
                          key: t.servername,
        ...
        p = _.exports;
      b()(_, "components", { QImg: g["a"] });
      var v = {
          name: "BasicStuInfo",
          components: { NeuWidget: s["a"], NeuViewWidgetValue: p },
          data() {
            return {
              record: {},
              commonCols: [
          ...
          methods: {
            ...
            openEditDialog(e, t) {
              ((this.editDialog = !0),
                (this.editModel = {
                  ...
                  config: t,
                  value:
                    this.record && this.record.stu_info && this.record.stu_info[e]
                      ? JSON.parse(JSON.stringify(this.record.stu_info[e])).value
                      : null,
                }));
            },
            saveEditDialog() {
            ...
            saveStuInfo() {
              Object(l["b"])(
                ...
                this.record.stu_info && this.record.stu_info[this.editModel.id]
                  ? this.record.stu_info[this.editModel.id].value
                  : null,
              )
                ? (this.editDialog = !1)
                : (this.$q.loading.show(),
                  this.$axiosAction("/api/student/basic/stuInfo.api", {
                    ...
                    [this.editModel.id]: JSON.stringify({ value: this.editModel.value }),
                    colsConfig: [this.editModel.id],
                  })
                    .then((e) => {
                      (0 === e.data.code && (this.loadData(), (this.editDialog = !1)),
                        this.$q.loading.hide());
                    })
                    .catch((e) => {
                      this.$q.loading.hide();
