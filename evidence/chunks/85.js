                  ...
                  a(
                    ...
                    [
                      a("q-btn", {
                        ...
                        on: { click: t.goBackLeave },
                      }),
                      a("q-toolbar-title", [t._v("批量请假")]),
                    ],
                    1,
                  ),
                ],
                      ...
                      this.$axiosAction("/api/teacher/leave/leave.api", {
                        ...
                        0 === t.data.code
                          ? ((this.atta = ""),
                            this.$q.loading.hide(),
                            this.$router.push(
                              `/teacher/leave/multilist?tab=${this.$route.query.tab}`,
                            ))
                          : this.$q.loading.hide();
                      }))
                    : this.$q.loading.hide();
