                                    ...
                                    a(
                                      ...
                                      [
                                        ...
                                        a("q-item-label", { attrs: { caption: "" } }, [
                                          e._v(
                                            "\n                " +
                                              e._s(e.counsellorlabel) +
                                              "：" +
                                              e._s(t.counsellor) +
                                              "\n              ",
                                          ),
                                        ]),
                                        a("q-item-label", { attrs: { lines: "2", caption: "" } }, [
                                          e._v(
                                            e._s(t.class_name) +
                                              " " +
                                              e._s(t.major_name) +
                              ...
                              directives: [
                                {
                                  ...
                                  value:
                                    ...
                                    0 != e.student_list.length,
                                  expression:
                                    "!isLoading && paging.pageCount == paging.pageNum && student_list.length != 0",
                                },
                              ],
                              staticClass: "text-center text-grey q-pt-sm q-pb-md",
                            },
